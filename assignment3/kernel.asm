...
8010003a:	c7 44 24 04 24 86 10 	movl   $0x80108624,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
80100049:	e8 b4 4d 00 00       	call   80104e02 <initlock>
...
801000bd:	e8 61 4d 00 00       	call   80104e23 <acquire>
...
80100104:	e8 7c 4d 00 00       	call   80104e85 <release>
        return b;
...
8010011f:	e8 35 4a 00 00       	call   80104b59 <sleep>
      goto loop;
...
8010017c:	e8 04 4d 00 00       	call   80104e85 <release>
      return b;
...
80100198:	c7 04 24 2b 86 10 80 	movl   $0x8010862b,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 3c 86 10 80 	movl   $0x8010863c,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 43 86 10 80 	movl   $0x80108643,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
8010023c:	e8 e2 4b 00 00       	call   80104e23 <acquire>
...
8010029d:	e8 90 49 00 00       	call   80104c32 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
801002a9:	e8 d7 4b 00 00       	call   80104e85 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 63 4a 00 00       	call   80104e23 <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 4a 86 10 80 	movl   $0x8010864a,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec 53 86 10 80 	movl   $0x80108653,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 4d 49 00 00       	call   80104e85 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 5a 86 10 80 	movl   $0x8010865a,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 69 86 10 80 	movl   $0x80108669,(%esp)
...
8010058f:	e8 40 49 00 00       	call   80104ed4 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 6b 86 10 80 	movl   $0x8010866b,(%esp)
...
801006b2:	e8 8f 4a 00 00       	call   80105146 <memmove>
    pos -= 80;
...
801006e1:	e8 91 49 00 00       	call   80105077 <memset>
  }
...
80100776:	e8 90 64 00 00       	call   80106c0b <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 84 64 00 00       	call   80106c0b <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 78 64 00 00       	call   80106c0b <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 6b 64 00 00       	call   80106c0b <uartputc>
  cgaputc(c);
...
801007ba:	e8 64 46 00 00       	call   80104e23 <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 e6 44 00 00       	call   80104cd5 <procdump>
      break;
...
801008f3:	e8 3a 43 00 00       	call   80104c32 <wakeup>
        }
      }
      break;
...
80100914:	e8 6c 45 00 00       	call   80104e85 <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 e5 44 00 00       	call   80104e23 <acquire>
  while(n > 0){
...
80100959:	e8 27 45 00 00       	call   80104e85 <release>
        ilock(ip);
...
80100982:	e8 d2 41 00 00       	call   80104b59 <sleep>
...
801009fe:	e8 82 44 00 00       	call   80104e85 <release>
  ilock(ip);
...
80100a32:	e8 ec 43 00 00       	call   80104e23 <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 14 44 00 00       	call   80104e85 <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 6f 86 10 	movl   $0x8010866f,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100a96:	e8 67 43 00 00       	call   80104e02 <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 77 86 10 	movl   $0x80108677,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 80 07 11 80 	movl   $0x80110780,(%esp)
80100aaa:	e8 53 43 00 00       	call   80104e02 <initlock>
...
80100ad4:	e8 0b 33 00 00       	call   80103de4 <picenable>
...
80100b6e:	e9 69 03 00 00       	jmp    80100edc <exec+0x3ed>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 46 72 00 00       	call   80107dbe <setupkvm>
...
80100c14:	e8 7b 75 00 00       	call   80108194 <allocuvm>
...
80100c52:	e8 52 74 00 00       	call   801080a9 <loaduvm>
...
80100cc0:	e8 cf 74 00 00       	call   80108194 <allocuvm>
...
80100ce5:	e8 da 76 00 00       	call   801083c4 <clearpteu>
  sp = sz;
...
80100d1b:	e8 c1 45 00 00       	call   801052e1 <strlen>
...
80100d44:	e8 98 45 00 00       	call   801052e1 <strlen>
...
80100d74:	e8 02 78 00 00       	call   8010857b <copyout>
...
80100e1b:	e8 5b 77 00 00       	call   8010857b <copyout>
...
80100e73:	e8 1f 44 00 00       	call   80105297 <safestrcpy>
...
80100ec5:	e8 ed 6f 00 00       	call   80107eb7 <switchuvm>
  freevm(oldpgdir);
80100eca:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ecd:	89 04 24             	mov    %eax,(%esp)
80100ed0:	e8 55 74 00 00       	call   8010832a <freevm>
  return 0;
...
80100ee8:	e8 3d 74 00 00       	call   8010832a <freevm>
  if(ip){
...
80100f10:	c7 44 24 04 7d 86 10 	movl   $0x8010867d,0x4(%esp)
80100f17:	80 
80100f18:	c7 04 24 40 08 11 80 	movl   $0x80110840,(%esp)
80100f1f:	e8 de 3e 00 00       	call   80104e02 <initlock>
}
80100f24:	c9                   	leave  
80100f25:	c3                   	ret    
...
80100f33:	e8 eb 3e 00 00       	call   80104e23 <acquire>
...
80100f5c:	e8 24 3f 00 00       	call   80104e85 <release>
      return f;
...
80100f7a:	e8 06 3f 00 00       	call   80104e85 <release>
  return 0;
...
80100f93:	e8 8b 3e 00 00       	call   80104e23 <acquire>
  if(f->ref < 1)
...
80100fa0:	7f 0c                	jg     80100fae <filedup+0x28>
    panic("filedup");
80100fa2:	c7 04 24 84 86 10 80 	movl   $0x80108684,(%esp)
...
80100fc4:	e8 bc 3e 00 00       	call   80104e85 <release>
  return f;
...
80100fdb:	e8 43 3e 00 00       	call   80104e23 <acquire>
  if(f->ref < 1)
...
80100fe8:	7f 0c                	jg     80100ff6 <fileclose+0x28>
    panic("fileclose");
80100fea:	c7 04 24 8c 86 10 80 	movl   $0x8010868c,(%esp)
...
80101016:	e8 6a 3e 00 00       	call   80104e85 <release>
...
80101060:	e8 20 3e 00 00       	call   80104e85 <release>
...
8010107e:	e8 11 30 00 00       	call   80104094 <pipeclose>
...
8010112f:	e8 e1 30 00 00       	call   80104215 <piperead>
...
8010119f:	eb 0c                	jmp    801011ad <fileread+0xba>
  ...
  panic("fileread");
801011a1:	c7 04 24 96 86 10 80 	movl   $0x80108696,(%esp)
...
801011ec:	e8 35 2f 00 00       	call   80104126 <pipewrite>
...
801012ad:	c7 04 24 9f 86 10 80 	movl   $0x8010869f,(%esp)
...
801012dd:	eb 0c                	jmp    801012eb <filewrite+0x13c>
  ...
  panic("filewrite");
801012df:	c7 04 24 af 86 10 80 	movl   $0x801086af,(%esp)
...
80101325:	e8 1c 3e 00 00       	call   80105146 <memmove>
  brelse(bp);
...
8010136b:	e8 07 3d 00 00       	call   80105077 <memset>
  log_write(bp);
...
801014c8:	c7 04 24 b9 86 10 80 	movl   $0x801086b9,(%esp)
...
8010155a:	c7 04 24 cf 86 10 80 	movl   $0x801086cf,(%esp)
...
801015aa:	c7 44 24 04 e2 86 10 	movl   $0x801086e2,0x4(%esp)
801015b1:	80 
801015b2:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
801015b9:	e8 44 38 00 00       	call   80104e02 <initlock>
}
801015be:	c9                   	leave  
801015bf:	c3                   	ret    
...
8010163b:	e8 37 3a 00 00       	call   80105077 <memset>
      dip->type = type;
...
80101691:	c7 04 24 e9 86 10 80 	movl   $0x801086e9,(%esp)
...
8010173a:	e8 07 3a 00 00       	call   80105146 <memmove>
  log_write(bp);
...
80101764:	e8 ba 36 00 00       	call   80104e23 <acquire>
...
801017ae:	e8 d2 36 00 00       	call   80104e85 <release>
      return ip;
...
801017e1:	c7 04 24 fb 86 10 80 	movl   $0x801086fb,(%esp)
...
8010181f:	e8 61 36 00 00       	call   80104e85 <release>
...
80101836:	e8 e8 35 00 00       	call   80104e23 <acquire>
  ip->ref++;
...
80101851:	e8 2f 36 00 00       	call   80104e85 <release>
  return ip;
...
8010186f:	7f 0c                	jg     8010187d <ilock+0x22>
    panic("ilock");
80101871:	c7 04 24 0b 87 10 80 	movl   $0x8010870b,(%esp)
80101878:	e8 bd ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
8010187d:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
80101884:	e8 9a 35 00 00       	call   80104e23 <acquire>
...
80101899:	e8 bb 32 00 00       	call   80104b59 <sleep>
...
801018c3:	e8 bd 35 00 00       	call   80104e85 <release>
...
8010196e:	e8 d3 37 00 00       	call   80105146 <memmove>
    brelse(bp);
...
80101999:	75 0c                	jne    801019a7 <ilock+0x14c>
      panic("ilock: no type");
8010199b:	c7 04 24 11 87 10 80 	movl   $0x80108711,(%esp)
...
801019ca:	7f 0c                	jg     801019d8 <iunlock+0x2f>
    panic("iunlock");
801019cc:	c7 04 24 20 87 10 80 	movl   $0x80108720,(%esp)
801019d3:	e8 62 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019d8:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
801019df:	e8 3f 34 00 00       	call   80104e23 <acquire>
  ip->flags &= ~I_BUSY;
...
801019fb:	e8 32 32 00 00       	call   80104c32 <wakeup>
  release(&icache.lock);
80101a00:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
80101a07:	e8 79 34 00 00       	call   80104e85 <release>
}
80101a0c:	c9                   	leave  
80101a0d:	c3                   	ret    
...
80101a1b:	e8 03 34 00 00       	call   80104e23 <acquire>
...
80101a57:	74 0c                	je     80101a65 <iput+0x57>
      panic("iput busy");
80101a59:	c7 04 24 28 87 10 80 	movl   $0x80108728,(%esp)
...
80101a7d:	e8 03 34 00 00       	call   80104e85 <release>
    itrunc(ip);
...
80101aa8:	e8 76 33 00 00       	call   80104e23 <acquire>
    ip->flags = 0;
...
80101abd:	e8 70 31 00 00       	call   80104c32 <wakeup>
  }
  ip->ref--;
...
80101ad8:	e8 a8 33 00 00       	call   80104e85 <release>
}
80101add:	c9                   	leave  
80101ade:	c3                   	ret    
...
80101bf8:	c7 04 24 32 87 10 80 	movl   $0x80108732,(%esp)
...
80101e99:	e8 a8 32 00 00       	call   80105146 <memmove>
    brelse(bp);
...
80101ff8:	e8 49 31 00 00       	call   80105146 <memmove>
    log_write(bp);
...
80102076:	e8 6e 31 00 00       	call   801051e9 <strncmp>
}
8010207b:	c9                   	leave  
8010207c:	c3                   	ret    
...
80102090:	c7 04 24 45 87 10 80 	movl   $0x80108745,(%esp)
...
801020cc:	74 0c                	je     801020da <dirlookup+0x5d>
      panic("dirlink read");
801020ce:	c7 04 24 57 87 10 80 	movl   $0x80108757,(%esp)
...
801021b1:	74 0c                	je     801021bf <dirlink+0x79>
      panic("dirlink read");
801021b3:	c7 04 24 57 87 10 80 	movl   $0x80108757,(%esp)
...
801021f8:	e8 42 30 00 00       	call   8010523f <strncpy>
  de.inum = inum;
...
80102228:	74 0c                	je     80102236 <dirlink+0xf0>
    panic("dirlink");
8010222a:	c7 04 24 64 87 10 80 	movl   $0x80108764,(%esp)
...
801022af:	e8 92 2e 00 00       	call   80105146 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022ca:	e8 77 2e 00 00       	call   80105146 <memmove>
    name[len] = 0;
...
80102519:	c7 44 24 04 6c 87 10 	movl   $0x8010876c,0x4(%esp)
80102520:	80 
80102521:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102528:	e8 d5 28 00 00       	call   80104e02 <initlock>
  picenable(IRQ_IDE);
8010252d:	c7 04 24 0e 00 00 00 	movl   $0xe,(%esp)
80102534:	e8 ab 18 00 00       	call   80103de4 <picenable>
...
801025c3:	75 0c                	jne    801025d1 <idestart+0x18>
    panic("idestart");
801025c5:	c7 04 24 70 87 10 80 	movl   $0x80108770,(%esp)
...
801026eb:	e8 33 27 00 00       	call   80104e23 <acquire>
  if((b = idequeue) == 0){
...
80102705:	e8 7b 27 00 00       	call   80104e85 <release>
...
80102778:	e8 b5 24 00 00       	call   80104c32 <wakeup>
...
8010279a:	e8 e6 26 00 00       	call   80104e85 <release>
}
8010279f:	c9                   	leave  
801027a0:	c3                   	ret    
...
801027b3:	c7 04 24 79 87 10 80 	movl   $0x80108779,(%esp)
...
801027cc:	c7 04 24 8d 87 10 80 	movl   $0x8010878d,(%esp)
...
80102859:	e8 fb 22 00 00       	call   80104b59 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
80102872:	e8 0e 26 00 00       	call   80104e85 <release>
}
80102877:	c9                   	leave  
80102878:	c3                   	ret    
...
80102900:	c7 04 24 c0 87 10 80 	movl   $0x801087c0,(%esp)
...
801029ba:	c7 44 24 04 f2 87 10 	movl   $0x801087f2,0x4(%esp)
801029c1:	80 
801029c2:	c7 04 24 20 22 11 80 	movl   $0x80112220,(%esp)
801029c9:	e8 34 24 00 00       	call   80104e02 <initlock>
  kmem.use_lock = 0;
...
80102a5b:	81 7d 08 58 51 11 80 	cmpl   $0x80115158,0x8(%ebp)
...
80102a74:	76 0c                	jbe    80102a82 <kfree+0x39>
    panic("kfree");
80102a76:	c7 04 24 f7 87 10 80 	movl   $0x801087f7,(%esp)
...
80102a98:	e8 da 25 00 00       	call   80105077 <memset>
...
80102aad:	e8 71 23 00 00       	call   80104e23 <acquire>
  r = (struct run*)v;
...
80102adb:	e8 a5 23 00 00       	call   80104e85 <release>
}
80102ae0:	c9                   	leave  
80102ae1:	c3                   	ret    
...
80102af8:	e8 26 23 00 00       	call   80104e23 <acquire>
  r = kmem.freelist;
...
80102b25:	e8 5b 23 00 00       	call   80104e85 <release>
  return (char*)r;
...
80102ea5:	c7 04 24 00 88 10 80 	movl   $0x80108800,(%esp)
...
80103108:	e8 e1 1f 00 00       	call   801050ee <memcmp>
...
80103208:	c7 44 24 04 2c 88 10 	movl   $0x8010882c,0x4(%esp)
8010320f:	80 
80103210:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80103217:	e8 e6 1b 00 00       	call   80104e02 <initlock>
  readsb(ROOTDEV, &sb);
...
801032cb:	e8 76 1e 00 00       	call   80105146 <memmove>
...
8010341d:	e8 01 1a 00 00       	call   80104e23 <acquire>
  while(1){
    if(log.committing){
...
8010343a:	e8 1a 17 00 00       	call   80104b59 <sleep>
...
8010346e:	e8 e6 16 00 00       	call   80104b59 <sleep>
...
80103489:	e8 f7 19 00 00       	call   80104e85 <release>
      break;
...
801034a8:	e8 76 19 00 00       	call   80104e23 <acquire>
  log.outstanding -= 1;
...
801034c3:	c7 04 24 30 88 10 80 	movl   $0x80108830,(%esp)
...
801034f2:	e8 3b 17 00 00       	call   80104c32 <wakeup>
  }
  release(&log.lock);
801034f7:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801034fe:	e8 82 19 00 00       	call   80104e85 <release>
...
801035b2:	e8 8f 1b 00 00       	call   80105146 <memmove>
...
8010363d:	c7 04 24 3f 88 10 80 	movl   $0x8010883f,(%esp)
...
80103652:	c7 04 24 55 88 10 80 	movl   $0x80108855,(%esp)
80103659:	e8 dc ce ff ff       	call   8010053a <panic>

  acquire(&log.lock);
8010365e:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80103665:	e8 b9 17 00 00       	call   80104e23 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801036dc:	e8 a4 17 00 00       	call   80104e85 <release>
}
801036e1:	c9                   	leave  
801036e2:	c3                   	ret    
...
80103727:	80 
80103728:	c7 04 24 58 51 11 80 	movl   $0x80115158,(%esp)
8010372f:	e8 80 f2 ff ff       	call   801029b4 <kinit1>
  seginit();       // set up segments
80103734:	e8 73 40 00 00       	call   801077ac <seginit>
  kvmalloc(cpu);   // kernel page table
80103739:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010373f:	89 04 24             	mov    %eax,(%esp)
80103742:	e8 34 47 00 00       	call   80107e7b <kvmalloc>
  mpinit();        // collect info about this machine
80103747:	e8 60 04 00 00       	call   80103bac <mpinit>
  lapicinit();
...
80103761:	c7 04 24 70 88 10 80 	movl   $0x80108870,(%esp)
80103768:	e8 33 cc ff ff       	call   801003a0 <cprintf>
  picinit();       // interrupt controller
8010376d:	e8 a0 06 00 00       	call   80103e12 <picinit>
  ioapicinit();    // another interrupt controller
80103772:	e8 33 f1 ff ff       	call   801028aa <ioapicinit>
  consoleinit();   // I/O devices & their interrupts
80103777:	e8 05 d3 ff ff       	call   80100a81 <consoleinit>
  uartinit();      // serial port
8010377c:	e8 7a 33 00 00       	call   80106afb <uartinit>
  pinit();         // process table
80103781:	e8 96 0b 00 00       	call   8010431c <pinit>
  tvinit();        // trap vectors
80103786:	e8 5f 2d 00 00       	call   801064ea <tvinit>
  binit();         // buffer cache
...
801037a8:	e8 6e 2c 00 00       	call   8010641b <timerinit>
...
801037c6:	e8 6c 0c 00 00       	call   80104437 <userinit>
...
801037dd:	e8 b7 46 00 00       	call   80107e99 <switchkvm>
  seginit();
801037e2:	e8 c5 3f 00 00       	call   801077ac <seginit>
  kvmalloc(cpu);
801037e7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801037ed:	89 04 24             	mov    %eax,(%esp)
801037f0:	e8 86 46 00 00       	call   80107e7b <kvmalloc>
  lapicinit();
...
80103815:	c7 04 24 87 88 10 80 	movl   $0x80108887,(%esp)
8010381c:	e8 7f cb ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
80103821:	e8 38 2e 00 00       	call   8010665e <idtinit>
...
80103841:	e8 62 11 00 00       	call   801049a8 <scheduler>
...
80103873:	e8 ce 18 00 00       	call   80105146 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80103878:	c7 45 f4 60 23 11 80 	movl   $0x80112360,-0xc(%ebp)
8010387f:	e9 8a 00 00 00       	jmp    8010390e <startothers+0xc8>
    if(c == cpus+cpunum())  // We've started already.
80103884:	e8 ef f5 ff ff       	call   80102e78 <cpunum>
80103889:	89 c2                	mov    %eax,%edx
8010388b:	89 d0                	mov    %edx,%eax
8010388d:	01 c0                	add    %eax,%eax
8010388f:	01 d0                	add    %edx,%eax
80103891:	c1 e0 06             	shl    $0x6,%eax
80103894:	05 60 23 11 80       	add    $0x80112360,%eax
80103899:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010389c:	75 02                	jne    801038a0 <startothers+0x5a>
      continue;
8010389e:	eb 67                	jmp    80103907 <startothers+0xc1>

    // Tell entryother.S what stack to use, where to enter, and what 
    // pgdir to use. We cannot use kpgdir yet, because the AP processor
    // is running in low  memory, so we use entrypgdir for the APs too.
    stack = kalloc();
801038a0:	e8 3d f2 ff ff       	call   80102ae2 <kalloc>
801038a5:	89 45 ec             	mov    %eax,-0x14(%ebp)
    *(void**)(code-4) = stack + KSTACKSIZE;
801038a8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801038ab:	83 e8 04             	sub    $0x4,%eax
801038ae:	8b 55 ec             	mov    -0x14(%ebp),%edx
801038b1:	81 c2 00 10 00 00    	add    $0x1000,%edx
801038b7:	89 10                	mov    %edx,(%eax)
    *(void**)(code-8) = mpenter;
801038b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801038bc:	83 e8 08             	sub    $0x8,%eax
801038bf:	c7 00 d0 37 10 80    	movl   $0x801037d0,(%eax)
    *(int**)(code-12) = (void *) v2p(entrypgdir);
801038c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801038c8:	8d 58 f4             	lea    -0xc(%eax),%ebx
801038cb:	c7 04 24 00 a0 10 80 	movl   $0x8010a000,(%esp)
801038d2:	e8 0c fe ff ff       	call   801036e3 <v2p>
801038d7:	89 03                	mov    %eax,(%ebx)

    lapicstartap(c->id, v2p(code));
801038d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801038dc:	89 04 24             	mov    %eax,(%esp)
801038df:	e8 ff fd ff ff       	call   801036e3 <v2p>
801038e4:	8b 55 f4             	mov    -0xc(%ebp),%edx
801038e7:	0f b6 12             	movzbl (%edx),%edx
801038ea:	0f b6 d2             	movzbl %dl,%edx
801038ed:	89 44 24 04          	mov    %eax,0x4(%esp)
801038f1:	89 14 24             	mov    %edx,(%esp)
801038f4:	e8 01 f6 ff ff       	call   80102efa <lapicstartap>

    // wait for cpu to finish mpmain()
    while(c->started == 0)
801038f9:	90                   	nop
801038fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801038fd:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80103903:	85 c0                	test   %eax,%eax
80103905:	74 f3                	je     801038fa <startothers+0xb4>
  // The linker has placed the image of entryother.S in
  // _binary_entryother_start.
  code = p2v(0x7000);
  memmove(code, _binary_entryother_start, (uint)_binary_entryother_size);
  ...
  for(c = cpus; c < cpus+ncpu; c++){
80103907:	81 45 f4 c0 00 00 00 	addl   $0xc0,-0xc(%ebp)
8010390e:	a1 60 29 11 80       	mov    0x80112960,%eax
80103913:	89 c2                	mov    %eax,%edx
80103915:	89 d0                	mov    %edx,%eax
80103917:	01 c0                	add    %eax,%eax
80103919:	01 d0                	add    %edx,%eax
8010391b:	c1 e0 06             	shl    $0x6,%eax
8010391e:	05 60 23 11 80       	add    $0x80112360,%eax
80103923:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80103926:	0f 87 58 ff ff ff    	ja     80103884 <startothers+0x3e>
...
8010392c:	83 c4 24             	add    $0x24,%esp
8010392f:	5b                   	pop    %ebx
80103930:	5d                   	pop    %ebp
80103931:	c3                   	ret    
...
80103938:	05 00 00 00 80       	add    $0x80000000,%eax
8010393d:	5d                   	pop    %ebp
8010393e:	c3                   	ret    
...
80103948:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010394c:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80103950:	89 c2                	mov    %eax,%edx
80103952:	ec                   	in     (%dx),%al
80103953:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80103956:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
8010395a:	c9                   	leave  
8010395b:	c3                   	ret    
...
80103962:	8b 55 08             	mov    0x8(%ebp),%edx
80103965:	8b 45 0c             	mov    0xc(%ebp),%eax
80103968:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010396c:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010396f:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80103973:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80103977:	ee                   	out    %al,(%dx)
}
80103978:	c9                   	leave  
80103979:	c3                   	ret    
...
8010397b:	89 e5                	mov    %esp,%ebp
  return bcpu-cpus;
8010397d:	a1 44 b6 10 80       	mov    0x8010b644,%eax
80103982:	89 c2                	mov    %eax,%edx
80103984:	b8 60 23 11 80       	mov    $0x80112360,%eax
80103989:	29 c2                	sub    %eax,%edx
8010398b:	89 d0                	mov    %edx,%eax
8010398d:	c1 f8 06             	sar    $0x6,%eax
80103990:	69 c0 ab aa aa aa    	imul   $0xaaaaaaab,%eax,%eax
}
80103996:	5d                   	pop    %ebp
80103997:	c3                   	ret    
...
8010399b:	83 ec 10             	sub    $0x10,%esp
  int i, sum;
  
  sum = 0;
8010399e:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
  for(i=0; i<len; i++)
801039a5:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801039ac:	eb 15                	jmp    801039c3 <sum+0x2b>
    sum += addr[i];
801039ae:	8b 55 fc             	mov    -0x4(%ebp),%edx
801039b1:	8b 45 08             	mov    0x8(%ebp),%eax
801039b4:	01 d0                	add    %edx,%eax
801039b6:	0f b6 00             	movzbl (%eax),%eax
801039b9:	0f b6 c0             	movzbl %al,%eax
801039bc:	01 45 f8             	add    %eax,-0x8(%ebp)
sum(uchar *addr, int len)
{
  int i, sum;
  ...
  sum = 0;
  for(i=0; i<len; i++)
801039bf:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801039c3:	8b 45 fc             	mov    -0x4(%ebp),%eax
801039c6:	3b 45 0c             	cmp    0xc(%ebp),%eax
801039c9:	7c e3                	jl     801039ae <sum+0x16>
    sum += addr[i];
  return sum;
801039cb:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
801039ce:	c9                   	leave  
801039cf:	c3                   	ret    
...
801039d3:	83 ec 28             	sub    $0x28,%esp
  uchar *e, *p, *addr;

  addr = p2v(a);
801039d6:	8b 45 08             	mov    0x8(%ebp),%eax
801039d9:	89 04 24             	mov    %eax,(%esp)
801039dc:	e8 51 ff ff ff       	call   80103932 <p2v>
801039e1:	89 45 f0             	mov    %eax,-0x10(%ebp)
  e = addr+len;
801039e4:	8b 55 0c             	mov    0xc(%ebp),%edx
...
801039f2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801039f5:	eb 3f                	jmp    80103a36 <mpsearch1+0x66>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
801039f7:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801039fe:	00 
801039ff:	c7 44 24 04 98 88 10 	movl   $0x80108898,0x4(%esp)
80103a06:	80 
80103a07:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a0a:	89 04 24             	mov    %eax,(%esp)
80103a0d:	e8 dc 16 00 00       	call   801050ee <memcmp>
80103a12:	85 c0                	test   %eax,%eax
80103a14:	75 1c                	jne    80103a32 <mpsearch1+0x62>
80103a16:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
80103a1d:	00 
80103a1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a21:	89 04 24             	mov    %eax,(%esp)
80103a24:	e8 6f ff ff ff       	call   80103998 <sum>
80103a29:	84 c0                	test   %al,%al
80103a2b:	75 05                	jne    80103a32 <mpsearch1+0x62>
      return (struct mp*)p;
80103a2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a30:	eb 11                	jmp    80103a43 <mpsearch1+0x73>
{
  uchar *e, *p, *addr;
  ...
  e = addr+len;
  for(p = addr; p < e; p += sizeof(struct mp))
80103a32:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80103a36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a39:	3b 45 ec             	cmp    -0x14(%ebp),%eax
80103a3c:	72 b9                	jb     801039f7 <mpsearch1+0x27>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
      return (struct mp*)p;
  return 0;
...
80103a48:	83 ec 28             	sub    $0x28,%esp
  ...
  bda = (uchar *) P2V(0x400);
80103a4b:	c7 45 f4 00 04 00 80 	movl   $0x80000400,-0xc(%ebp)
  if((p = ((bda[0x0F]<<8)| bda[0x0E]) << 4)){
80103a52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a55:	83 c0 0f             	add    $0xf,%eax
80103a58:	0f b6 00             	movzbl (%eax),%eax
80103a5b:	0f b6 c0             	movzbl %al,%eax
80103a5e:	c1 e0 08             	shl    $0x8,%eax
80103a61:	89 c2                	mov    %eax,%edx
80103a63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a66:	83 c0 0e             	add    $0xe,%eax
80103a69:	0f b6 00             	movzbl (%eax),%eax
80103a6c:	0f b6 c0             	movzbl %al,%eax
80103a6f:	09 d0                	or     %edx,%eax
80103a71:	c1 e0 04             	shl    $0x4,%eax
80103a74:	89 45 f0             	mov    %eax,-0x10(%ebp)
80103a77:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80103a7b:	74 21                	je     80103a9e <mpsearch+0x59>
    if((mp = mpsearch1(p, 1024)))
80103a7d:	c7 44 24 04 00 04 00 	movl   $0x400,0x4(%esp)
80103a84:	00 
80103a85:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103a88:	89 04 24             	mov    %eax,(%esp)
80103a8b:	e8 40 ff ff ff       	call   801039d0 <mpsearch1>
80103a90:	89 45 ec             	mov    %eax,-0x14(%ebp)
80103a93:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80103a97:	74 50                	je     80103ae9 <mpsearch+0xa4>
      return mp;
80103a99:	8b 45 ec             	mov    -0x14(%ebp),%eax
80103a9c:	eb 5f                	jmp    80103afd <mpsearch+0xb8>
  } else {
    p = ((bda[0x14]<<8)|bda[0x13])*1024;
80103a9e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103aa1:	83 c0 14             	add    $0x14,%eax
80103aa4:	0f b6 00             	movzbl (%eax),%eax
80103aa7:	0f b6 c0             	movzbl %al,%eax
80103aaa:	c1 e0 08             	shl    $0x8,%eax
80103aad:	89 c2                	mov    %eax,%edx
80103aaf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103ab2:	83 c0 13             	add    $0x13,%eax
80103ab5:	0f b6 00             	movzbl (%eax),%eax
80103ab8:	0f b6 c0             	movzbl %al,%eax
80103abb:	09 d0                	or     %edx,%eax
80103abd:	c1 e0 0a             	shl    $0xa,%eax
80103ac0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if((mp = mpsearch1(p-1024, 1024)))
80103ac3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103ac6:	2d 00 04 00 00       	sub    $0x400,%eax
80103acb:	c7 44 24 04 00 04 00 	movl   $0x400,0x4(%esp)
80103ad2:	00 
80103ad3:	89 04 24             	mov    %eax,(%esp)
80103ad6:	e8 f5 fe ff ff       	call   801039d0 <mpsearch1>
80103adb:	89 45 ec             	mov    %eax,-0x14(%ebp)
80103ade:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80103ae2:	74 05                	je     80103ae9 <mpsearch+0xa4>
      return mp;
80103ae4:	8b 45 ec             	mov    -0x14(%ebp),%eax
80103ae7:	eb 14                	jmp    80103afd <mpsearch+0xb8>
  }
  return mpsearch1(0xF0000, 0x10000);
80103ae9:	c7 44 24 04 00 00 01 	movl   $0x10000,0x4(%esp)
80103af0:	00 
80103af1:	c7 04 24 00 00 0f 00 	movl   $0xf0000,(%esp)
80103af8:	e8 d3 fe ff ff       	call   801039d0 <mpsearch1>
}
80103afd:	c9                   	leave  
80103afe:	c3                   	ret    
...
80103b02:	83 ec 28             	sub    $0x28,%esp
  struct mpconf *conf;
  struct mp *mp;

  if((mp = mpsearch()) == 0 || mp->physaddr == 0)
80103b05:	e8 3b ff ff ff       	call   80103a45 <mpsearch>
80103b0a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80103b0d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80103b11:	74 0a                	je     80103b1d <mpconfig+0x1e>
80103b13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103b16:	8b 40 04             	mov    0x4(%eax),%eax
80103b19:	85 c0                	test   %eax,%eax
80103b1b:	75 0a                	jne    80103b27 <mpconfig+0x28>
    return 0;
80103b1d:	b8 00 00 00 00       	mov    $0x0,%eax
80103b22:	e9 83 00 00 00       	jmp    80103baa <mpconfig+0xab>
  conf = (struct mpconf*) p2v((uint) mp->physaddr);
80103b27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103b2a:	8b 40 04             	mov    0x4(%eax),%eax
80103b2d:	89 04 24             	mov    %eax,(%esp)
80103b30:	e8 fd fd ff ff       	call   80103932 <p2v>
80103b35:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103b38:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80103b3f:	00 
80103b40:	c7 44 24 04 9d 88 10 	movl   $0x8010889d,0x4(%esp)
80103b47:	80 
80103b48:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b4b:	89 04 24             	mov    %eax,(%esp)
80103b4e:	e8 9b 15 00 00       	call   801050ee <memcmp>
80103b53:	85 c0                	test   %eax,%eax
80103b55:	74 07                	je     80103b5e <mpconfig+0x5f>
    return 0;
80103b57:	b8 00 00 00 00       	mov    $0x0,%eax
80103b5c:	eb 4c                	jmp    80103baa <mpconfig+0xab>
  if(conf->version != 1 && conf->version != 4)
80103b5e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b61:	0f b6 40 06          	movzbl 0x6(%eax),%eax
80103b65:	3c 01                	cmp    $0x1,%al
80103b67:	74 12                	je     80103b7b <mpconfig+0x7c>
80103b69:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b6c:	0f b6 40 06          	movzbl 0x6(%eax),%eax
80103b70:	3c 04                	cmp    $0x4,%al
80103b72:	74 07                	je     80103b7b <mpconfig+0x7c>
    return 0;
80103b74:	b8 00 00 00 00       	mov    $0x0,%eax
80103b79:	eb 2f                	jmp    80103baa <mpconfig+0xab>
  if(sum((uchar*)conf, conf->length) != 0)
80103b7b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b7e:	0f b7 40 04          	movzwl 0x4(%eax),%eax
80103b82:	0f b7 c0             	movzwl %ax,%eax
80103b85:	89 44 24 04          	mov    %eax,0x4(%esp)
80103b89:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b8c:	89 04 24             	mov    %eax,(%esp)
80103b8f:	e8 04 fe ff ff       	call   80103998 <sum>
80103b94:	84 c0                	test   %al,%al
80103b96:	74 07                	je     80103b9f <mpconfig+0xa0>
    return 0;
80103b98:	b8 00 00 00 00       	mov    $0x0,%eax
80103b9d:	eb 0b                	jmp    80103baa <mpconfig+0xab>
  *pmp = mp;
80103b9f:	8b 45 08             	mov    0x8(%ebp),%eax
80103ba2:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
80103baf:	83 ec 38             	sub    $0x38,%esp
  struct mp *mp;
  struct mpconf *conf;
  struct mpproc *proc;
  ...
  bcpu = &cpus[0];
80103bb2:	c7 05 44 b6 10 80 60 	movl   $0x80112360,0x8010b644
80103bb9:	23 11 80 
  if((conf = mpconfig(&mp)) == 0)
80103bbc:	8d 45 e0             	lea    -0x20(%ebp),%eax
80103bbf:	89 04 24             	mov    %eax,(%esp)
80103bc2:	e8 38 ff ff ff       	call   80103aff <mpconfig>
80103bc7:	89 45 f0             	mov    %eax,-0x10(%ebp)
80103bca:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80103bce:	75 05                	jne    80103bd5 <mpinit+0x29>
    return;
80103bd0:	e9 a4 01 00 00       	jmp    80103d79 <mpinit+0x1cd>
  ismp = 1;
80103bd5:	c7 05 44 23 11 80 01 	movl   $0x1,0x80112344
80103bdc:	00 00 00 
  lapic = (uint*)conf->lapicaddr;
80103bdf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103be2:	8b 40 24             	mov    0x24(%eax),%eax
80103be5:	a3 5c 22 11 80       	mov    %eax,0x8011225c
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
80103bea:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103bed:	83 c0 2c             	add    $0x2c,%eax
80103bf0:	89 45 f4             	mov    %eax,-0xc(%ebp)
80103bf3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103bf6:	0f b7 40 04          	movzwl 0x4(%eax),%eax
80103bfa:	0f b7 d0             	movzwl %ax,%edx
80103bfd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103c00:	01 d0                	add    %edx,%eax
80103c02:	89 45 ec             	mov    %eax,-0x14(%ebp)
80103c05:	e9 fc 00 00 00       	jmp    80103d06 <mpinit+0x15a>
    switch(*p){
80103c0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103c0d:	0f b6 00             	movzbl (%eax),%eax
80103c10:	0f b6 c0             	movzbl %al,%eax
80103c13:	83 f8 04             	cmp    $0x4,%eax
80103c16:	0f 87 c7 00 00 00    	ja     80103ce3 <mpinit+0x137>
80103c1c:	8b 04 85 e0 88 10 80 	mov    -0x7fef7720(,%eax,4),%eax
80103c23:	ff e0                	jmp    *%eax
    case MPPROC:
      proc = (struct mpproc*)p;
80103c25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103c28:	89 45 e8             	mov    %eax,-0x18(%ebp)
      if(ncpu != proc->apicid){
80103c2b:	8b 45 e8             	mov    -0x18(%ebp),%eax
80103c2e:	0f b6 40 01          	movzbl 0x1(%eax),%eax
80103c32:	0f b6 d0             	movzbl %al,%edx
80103c35:	a1 60 29 11 80       	mov    0x80112960,%eax
80103c3a:	39 c2                	cmp    %eax,%edx
80103c3c:	74 2d                	je     80103c6b <mpinit+0xbf>
        cprintf("mpinit: ncpu=%d apicid=%d\n", ncpu, proc->apicid);
80103c3e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80103c41:	0f b6 40 01          	movzbl 0x1(%eax),%eax
80103c45:	0f b6 d0             	movzbl %al,%edx
80103c48:	a1 60 29 11 80       	mov    0x80112960,%eax
80103c4d:	89 54 24 08          	mov    %edx,0x8(%esp)
80103c51:	89 44 24 04          	mov    %eax,0x4(%esp)
80103c55:	c7 04 24 a2 88 10 80 	movl   $0x801088a2,(%esp)
80103c5c:	e8 3f c7 ff ff       	call   801003a0 <cprintf>
        ismp = 0;
80103c61:	c7 05 44 23 11 80 00 	movl   $0x0,0x80112344
80103c68:	00 00 00 
      }
      if(proc->flags & MPBOOT)
80103c6b:	8b 45 e8             	mov    -0x18(%ebp),%eax
80103c6e:	0f b6 40 03          	movzbl 0x3(%eax),%eax
80103c72:	0f b6 c0             	movzbl %al,%eax
80103c75:	83 e0 02             	and    $0x2,%eax
80103c78:	85 c0                	test   %eax,%eax
80103c7a:	74 19                	je     80103c95 <mpinit+0xe9>
        bcpu = &cpus[ncpu];
80103c7c:	8b 15 60 29 11 80    	mov    0x80112960,%edx
80103c82:	89 d0                	mov    %edx,%eax
80103c84:	01 c0                	add    %eax,%eax
80103c86:	01 d0                	add    %edx,%eax
80103c88:	c1 e0 06             	shl    $0x6,%eax
80103c8b:	05 60 23 11 80       	add    $0x80112360,%eax
80103c90:	a3 44 b6 10 80       	mov    %eax,0x8010b644
      cpus[ncpu].id = ncpu;
80103c95:	8b 15 60 29 11 80    	mov    0x80112960,%edx
80103c9b:	a1 60 29 11 80       	mov    0x80112960,%eax
80103ca0:	89 c1                	mov    %eax,%ecx
80103ca2:	89 d0                	mov    %edx,%eax
80103ca4:	01 c0                	add    %eax,%eax
80103ca6:	01 d0                	add    %edx,%eax
80103ca8:	c1 e0 06             	shl    $0x6,%eax
80103cab:	05 60 23 11 80       	add    $0x80112360,%eax
80103cb0:	88 08                	mov    %cl,(%eax)
      ncpu++;
80103cb2:	a1 60 29 11 80       	mov    0x80112960,%eax
80103cb7:	83 c0 01             	add    $0x1,%eax
80103cba:	a3 60 29 11 80       	mov    %eax,0x80112960
      p += sizeof(struct mpproc);
80103cbf:	83 45 f4 14          	addl   $0x14,-0xc(%ebp)
      continue;
80103cc3:	eb 41                	jmp    80103d06 <mpinit+0x15a>
    case MPIOAPIC:
      ioapic = (struct mpioapic*)p;
80103cc5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103cc8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      ioapicid = ioapic->apicno;
80103ccb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103cce:	0f b6 40 01          	movzbl 0x1(%eax),%eax
80103cd2:	a2 40 23 11 80       	mov    %al,0x80112340
      p += sizeof(struct mpioapic);
80103cd7:	83 45 f4 08          	addl   $0x8,-0xc(%ebp)
      continue;
80103cdb:	eb 29                	jmp    80103d06 <mpinit+0x15a>
    case MPBUS:
    case MPIOINTR:
    case MPLINTR:
      p += 8;
80103cdd:	83 45 f4 08          	addl   $0x8,-0xc(%ebp)
      continue;
80103ce1:	eb 23                	jmp    80103d06 <mpinit+0x15a>
    default:
...
80103cf0:	c7 04 24 c0 88 10 80 	movl   $0x801088c0,(%esp)
80103cf7:	e8 a4 c6 ff ff       	call   801003a0 <cprintf>
      ismp = 0;
80103cfc:	c7 05 44 23 11 80 00 	movl   $0x0,0x80112344
80103d03:	00 00 00 
  bcpu = &cpus[0];
  if((conf = mpconfig(&mp)) == 0)
    return;
...
80103d09:	3b 45 ec             	cmp    -0x14(%ebp),%eax
80103d0c:	0f 82 f8 fe ff ff    	jb     80103c0a <mpinit+0x5e>
    default:
      cprintf("mpinit: unknown config type %x\n", *p);
      ismp = 0;
    }
  ...
  if(!ismp){
80103d12:	a1 44 23 11 80       	mov    0x80112344,%eax
80103d17:	85 c0                	test   %eax,%eax
80103d19:	75 1d                	jne    80103d38 <mpinit+0x18c>
    // Didn't like what we found; fall back to no MP.
    ncpu = 1;
80103d1b:	c7 05 60 29 11 80 01 	movl   $0x1,0x80112960
80103d22:	00 00 00 
    lapic = 0;
80103d25:	c7 05 5c 22 11 80 00 	movl   $0x0,0x8011225c
80103d2c:	00 00 00 
    ioapicid = 0;
80103d2f:	c6 05 40 23 11 80 00 	movb   $0x0,0x80112340
    return;
80103d36:	eb 41                	jmp    80103d79 <mpinit+0x1cd>
  }

  if(mp->imcrp){
80103d38:	8b 45 e0             	mov    -0x20(%ebp),%eax
80103d3b:	0f b6 40 0c          	movzbl 0xc(%eax),%eax
80103d3f:	84 c0                	test   %al,%al
80103d41:	74 36                	je     80103d79 <mpinit+0x1cd>
    // Bochs doesn't support IMCR, so this doesn't run on Bochs.
    // But it would on real hardware.
    outb(0x22, 0x70);   // Select IMCR
80103d43:	c7 44 24 04 70 00 00 	movl   $0x70,0x4(%esp)
80103d4a:	00 
80103d4b:	c7 04 24 22 00 00 00 	movl   $0x22,(%esp)
80103d52:	e8 05 fc ff ff       	call   8010395c <outb>
    outb(0x23, inb(0x23) | 1);  // Mask external interrupts.
80103d57:	c7 04 24 23 00 00 00 	movl   $0x23,(%esp)
80103d5e:	e8 dc fb ff ff       	call   8010393f <inb>
80103d63:	83 c8 01             	or     $0x1,%eax
80103d66:	0f b6 c0             	movzbl %al,%eax
80103d69:	89 44 24 04          	mov    %eax,0x4(%esp)
80103d6d:	c7 04 24 23 00 00 00 	movl   $0x23,(%esp)
80103d74:	e8 e3 fb ff ff       	call   8010395c <outb>
  }
}
80103d79:	c9                   	leave  
80103d7a:	c3                   	ret    
...
80103da2:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  irqmask = mask;
80103da6:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80103daa:	66 a3 00 b0 10 80    	mov    %ax,0x8010b000
  outb(IO_PIC1+1, mask);
80103db0:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80103db4:	0f b6 c0             	movzbl %al,%eax
80103db7:	89 44 24 04          	mov    %eax,0x4(%esp)
80103dbb:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103dc2:	e8 b4 ff ff ff       	call   80103d7b <outb>
  outb(IO_PIC2+1, mask >> 8);
80103dc7:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80103dcb:	66 c1 e8 08          	shr    $0x8,%ax
80103dcf:	0f b6 c0             	movzbl %al,%eax
80103dd2:	89 44 24 04          	mov    %eax,0x4(%esp)
80103dd6:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103ddd:	e8 99 ff ff ff       	call   80103d7b <outb>
}
80103de2:	c9                   	leave  
80103de3:	c3                   	ret    
...
80103ded:	ba 01 00 00 00       	mov    $0x1,%edx
80103df2:	89 c1                	mov    %eax,%ecx
80103df4:	d3 e2                	shl    %cl,%edx
80103df6:	89 d0                	mov    %edx,%eax
80103df8:	f7 d0                	not    %eax
80103dfa:	89 c2                	mov    %eax,%edx
80103dfc:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
80103e03:	21 d0                	and    %edx,%eax
80103e05:	0f b7 c0             	movzwl %ax,%eax
80103e08:	89 04 24             	mov    %eax,(%esp)
80103e0b:	e8 89 ff ff ff       	call   80103d99 <picsetmask>
}
80103e10:	c9                   	leave  
80103e11:	c3                   	ret    
...
80103e15:	83 ec 08             	sub    $0x8,%esp
  // mask all interrupts
  outb(IO_PIC1+1, 0xFF);
80103e18:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
80103e1f:	00 
80103e20:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103e27:	e8 4f ff ff ff       	call   80103d7b <outb>
  outb(IO_PIC2+1, 0xFF);
80103e2c:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
80103e33:	00 
80103e34:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103e3b:	e8 3b ff ff ff       	call   80103d7b <outb>
  ...
  outb(IO_PIC1, 0x11);
80103e40:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
80103e47:	00 
80103e48:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80103e4f:	e8 27 ff ff ff       	call   80103d7b <outb>

  // ICW2:  Vector offset
  outb(IO_PIC1+1, T_IRQ0);
80103e54:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
80103e5b:	00 
80103e5c:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103e63:	e8 13 ff ff ff       	call   80103d7b <outb>

  // ICW3:  (master PIC) bit mask of IR lines connected to slaves
  //        (slave PIC) 3-bit # of slave's connection to master
  outb(IO_PIC1+1, 1<<IRQ_SLAVE);
80103e68:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
80103e6f:	00 
80103e70:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103e77:	e8 ff fe ff ff       	call   80103d7b <outb>
  ...
  outb(IO_PIC1+1, 0x3);
80103e7c:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80103e83:	00 
80103e84:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103e8b:	e8 eb fe ff ff       	call   80103d7b <outb>

  // Set up slave (8259A-2)
  outb(IO_PIC2, 0x11);                  // ICW1
80103e90:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
80103e97:	00 
80103e98:	c7 04 24 a0 00 00 00 	movl   $0xa0,(%esp)
80103e9f:	e8 d7 fe ff ff       	call   80103d7b <outb>
  outb(IO_PIC2+1, T_IRQ0 + 8);      // ICW2
80103ea4:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
80103eab:	00 
80103eac:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103eb3:	e8 c3 fe ff ff       	call   80103d7b <outb>
  outb(IO_PIC2+1, IRQ_SLAVE);           // ICW3
80103eb8:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80103ebf:	00 
80103ec0:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103ec7:	e8 af fe ff ff       	call   80103d7b <outb>
  // NB Automatic EOI mode doesn't tend to work on the slave.
  // Linux source code says it's "to be investigated".
  outb(IO_PIC2+1, 0x3);                 // ICW4
80103ecc:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80103ed3:	00 
80103ed4:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103edb:	e8 9b fe ff ff       	call   80103d7b <outb>
...
80103ee0:	c7 44 24 04 68 00 00 	movl   $0x68,0x4(%esp)
80103ee7:	00 
80103ee8:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80103eef:	e8 87 fe ff ff       	call   80103d7b <outb>
  outb(IO_PIC1, 0x0a);             // read IRR by default
80103ef4:	c7 44 24 04 0a 00 00 	movl   $0xa,0x4(%esp)
80103efb:	00 
80103efc:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80103f03:	e8 73 fe ff ff       	call   80103d7b <outb>

  outb(IO_PIC2, 0x68);             // OCW3
80103f08:	c7 44 24 04 68 00 00 	movl   $0x68,0x4(%esp)
80103f0f:	00 
80103f10:	c7 04 24 a0 00 00 00 	movl   $0xa0,(%esp)
80103f17:	e8 5f fe ff ff       	call   80103d7b <outb>
  outb(IO_PIC2, 0x0a);             // OCW3
80103f1c:	c7 44 24 04 0a 00 00 	movl   $0xa,0x4(%esp)
80103f23:	00 
80103f24:	c7 04 24 a0 00 00 00 	movl   $0xa0,(%esp)
80103f2b:	e8 4b fe ff ff       	call   80103d7b <outb>

  if(irqmask != 0xFFFF)
80103f30:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
80103f37:	66 83 f8 ff          	cmp    $0xffff,%ax
80103f3b:	74 12                	je     80103f4f <picinit+0x13d>
    picsetmask(irqmask);
80103f3d:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
80103f44:	0f b7 c0             	movzwl %ax,%eax
80103f47:	89 04 24             	mov    %eax,(%esp)
80103f4a:	e8 4a fe ff ff       	call   80103d99 <picsetmask>
}
80103f4f:	c9                   	leave  
80103f50:	c3                   	ret    
...
80103f54:	83 ec 28             	sub    $0x28,%esp
  ...
  p = 0;
80103f57:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  *f0 = *f1 = 0;
80103f5e:	8b 45 0c             	mov    0xc(%ebp),%eax
80103f61:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
80103f71:	e8 b0 cf ff ff       	call   80100f26 <filealloc>
80103f76:	8b 55 08             	mov    0x8(%ebp),%edx
80103f79:	89 02                	mov    %eax,(%edx)
80103f7b:	8b 45 08             	mov    0x8(%ebp),%eax
80103f7e:	8b 00                	mov    (%eax),%eax
80103f80:	85 c0                	test   %eax,%eax
80103f82:	0f 84 c8 00 00 00    	je     80104050 <pipealloc+0xff>
80103f88:	e8 99 cf ff ff       	call   80100f26 <filealloc>
80103f8d:	8b 55 0c             	mov    0xc(%ebp),%edx
80103f90:	89 02                	mov    %eax,(%edx)
80103f92:	8b 45 0c             	mov    0xc(%ebp),%eax
80103f95:	8b 00                	mov    (%eax),%eax
80103f97:	85 c0                	test   %eax,%eax
80103f99:	0f 84 b1 00 00 00    	je     80104050 <pipealloc+0xff>
    goto bad;
  if((p = (struct pipe*)kalloc()) == 0)
80103f9f:	e8 3e eb ff ff       	call   80102ae2 <kalloc>
80103fa4:	89 45 f4             	mov    %eax,-0xc(%ebp)
80103fa7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80103fab:	75 05                	jne    80103fb2 <pipealloc+0x61>
    goto bad;
80103fad:	e9 9e 00 00 00       	jmp    80104050 <pipealloc+0xff>
  p->readopen = 1;
80103fb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103fb5:	c7 80 3c 02 00 00 01 	movl   $0x1,0x23c(%eax)
80103fbc:	00 00 00 
  p->writeopen = 1;
80103fbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103fc2:	c7 80 40 02 00 00 01 	movl   $0x1,0x240(%eax)
80103fc9:	00 00 00 
  p->nwrite = 0;
80103fcc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103fcf:	c7 80 38 02 00 00 00 	movl   $0x0,0x238(%eax)
80103fd6:	00 00 00 
  p->nread = 0;
80103fd9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103fdc:	c7 80 34 02 00 00 00 	movl   $0x0,0x234(%eax)
80103fe3:	00 00 00 
  initlock(&p->lock, "pipe");
80103fe6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103fe9:	c7 44 24 04 f4 88 10 	movl   $0x801088f4,0x4(%esp)
80103ff0:	80 
80103ff1:	89 04 24             	mov    %eax,(%esp)
80103ff4:	e8 09 0e 00 00       	call   80104e02 <initlock>
  (*f0)->type = FD_PIPE;
80103ff9:	8b 45 08             	mov    0x8(%ebp),%eax
80103ffc:	8b 00                	mov    (%eax),%eax
80103ffe:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  (*f0)->readable = 1;
80104004:	8b 45 08             	mov    0x8(%ebp),%eax
80104007:	8b 00                	mov    (%eax),%eax
80104009:	c6 40 08 01          	movb   $0x1,0x8(%eax)
  (*f0)->writable = 0;
8010400d:	8b 45 08             	mov    0x8(%ebp),%eax
80104010:	8b 00                	mov    (%eax),%eax
80104012:	c6 40 09 00          	movb   $0x0,0x9(%eax)
  (*f0)->pipe = p;
80104016:	8b 45 08             	mov    0x8(%ebp),%eax
80104019:	8b 00                	mov    (%eax),%eax
8010401b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010401e:	89 50 0c             	mov    %edx,0xc(%eax)
  (*f1)->type = FD_PIPE;
80104021:	8b 45 0c             	mov    0xc(%ebp),%eax
80104024:	8b 00                	mov    (%eax),%eax
80104026:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  (*f1)->readable = 0;
8010402c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010402f:	8b 00                	mov    (%eax),%eax
80104031:	c6 40 08 00          	movb   $0x0,0x8(%eax)
  (*f1)->writable = 1;
80104035:	8b 45 0c             	mov    0xc(%ebp),%eax
80104038:	8b 00                	mov    (%eax),%eax
8010403a:	c6 40 09 01          	movb   $0x1,0x9(%eax)
  (*f1)->pipe = p;
8010403e:	8b 45 0c             	mov    0xc(%ebp),%eax
80104041:	8b 00                	mov    (%eax),%eax
80104043:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104046:	89 50 0c             	mov    %edx,0xc(%eax)
  return 0;
80104049:	b8 00 00 00 00       	mov    $0x0,%eax
8010404e:	eb 42                	jmp    80104092 <pipealloc+0x141>

//PAGEBREAK: 20
 bad:
  if(p)
80104050:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104054:	74 0b                	je     80104061 <pipealloc+0x110>
    kfree((char*)p);
80104056:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104059:	89 04 24             	mov    %eax,(%esp)
8010405c:	e8 e8 e9 ff ff       	call   80102a49 <kfree>
  if(*f0)
80104061:	8b 45 08             	mov    0x8(%ebp),%eax
80104064:	8b 00                	mov    (%eax),%eax
80104066:	85 c0                	test   %eax,%eax
80104068:	74 0d                	je     80104077 <pipealloc+0x126>
    fileclose(*f0);
8010406a:	8b 45 08             	mov    0x8(%ebp),%eax
8010406d:	8b 00                	mov    (%eax),%eax
8010406f:	89 04 24             	mov    %eax,(%esp)
80104072:	e8 57 cf ff ff       	call   80100fce <fileclose>
  if(*f1)
80104077:	8b 45 0c             	mov    0xc(%ebp),%eax
8010407a:	8b 00                	mov    (%eax),%eax
8010407c:	85 c0                	test   %eax,%eax
8010407e:	74 0d                	je     8010408d <pipealloc+0x13c>
    fileclose(*f1);
80104080:	8b 45 0c             	mov    0xc(%ebp),%eax
80104083:	8b 00                	mov    (%eax),%eax
80104085:	89 04 24             	mov    %eax,(%esp)
80104088:	e8 41 cf ff ff       	call   80100fce <fileclose>
  return -1;
...
801040a0:	e8 7e 0d 00 00       	call   80104e23 <acquire>
  if(writable){
801040a5:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801040a9:	74 1f                	je     801040ca <pipeclose+0x36>
    p->writeopen = 0;
801040ab:	8b 45 08             	mov    0x8(%ebp),%eax
801040ae:	c7 80 40 02 00 00 00 	movl   $0x0,0x240(%eax)
801040b5:	00 00 00 
    wakeup(&p->nread);
801040b8:	8b 45 08             	mov    0x8(%ebp),%eax
801040bb:	05 34 02 00 00       	add    $0x234,%eax
801040c0:	89 04 24             	mov    %eax,(%esp)
801040c3:	e8 6a 0b 00 00       	call   80104c32 <wakeup>
801040c8:	eb 1d                	jmp    801040e7 <pipeclose+0x53>
  } else {
    p->readopen = 0;
801040ca:	8b 45 08             	mov    0x8(%ebp),%eax
801040cd:	c7 80 3c 02 00 00 00 	movl   $0x0,0x23c(%eax)
801040d4:	00 00 00 
    wakeup(&p->nwrite);
801040d7:	8b 45 08             	mov    0x8(%ebp),%eax
801040da:	05 38 02 00 00       	add    $0x238,%eax
801040df:	89 04 24             	mov    %eax,(%esp)
801040e2:	e8 4b 0b 00 00       	call   80104c32 <wakeup>
  }
  if(p->readopen == 0 && p->writeopen == 0){
801040e7:	8b 45 08             	mov    0x8(%ebp),%eax
801040ea:	8b 80 3c 02 00 00    	mov    0x23c(%eax),%eax
801040f0:	85 c0                	test   %eax,%eax
801040f2:	75 25                	jne    80104119 <pipeclose+0x85>
801040f4:	8b 45 08             	mov    0x8(%ebp),%eax
801040f7:	8b 80 40 02 00 00    	mov    0x240(%eax),%eax
801040fd:	85 c0                	test   %eax,%eax
801040ff:	75 18                	jne    80104119 <pipeclose+0x85>
    release(&p->lock);
80104101:	8b 45 08             	mov    0x8(%ebp),%eax
80104104:	89 04 24             	mov    %eax,(%esp)
80104107:	e8 79 0d 00 00       	call   80104e85 <release>
    kfree((char*)p);
8010410c:	8b 45 08             	mov    0x8(%ebp),%eax
8010410f:	89 04 24             	mov    %eax,(%esp)
80104112:	e8 32 e9 ff ff       	call   80102a49 <kfree>
80104117:	eb 0b                	jmp    80104124 <pipeclose+0x90>
  } else
    release(&p->lock);
80104119:	8b 45 08             	mov    0x8(%ebp),%eax
8010411c:	89 04 24             	mov    %eax,(%esp)
8010411f:	e8 61 0d 00 00       	call   80104e85 <release>
}
80104124:	c9                   	leave  
80104125:	c3                   	ret    
...
80104132:	e8 ec 0c 00 00       	call   80104e23 <acquire>
  for(i = 0; i < n; i++){
80104137:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010413e:	e9 a6 00 00 00       	jmp    801041e9 <pipewrite+0xc3>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
80104143:	eb 57                	jmp    8010419c <pipewrite+0x76>
      if(p->readopen == 0 || proc->killed){
80104145:	8b 45 08             	mov    0x8(%ebp),%eax
80104148:	8b 80 3c 02 00 00    	mov    0x23c(%eax),%eax
8010414e:	85 c0                	test   %eax,%eax
80104150:	74 0d                	je     8010415f <pipewrite+0x39>
80104152:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104158:	8b 40 24             	mov    0x24(%eax),%eax
8010415b:	85 c0                	test   %eax,%eax
8010415d:	74 15                	je     80104174 <pipewrite+0x4e>
        release(&p->lock);
8010415f:	8b 45 08             	mov    0x8(%ebp),%eax
80104162:	89 04 24             	mov    %eax,(%esp)
80104165:	e8 1b 0d 00 00       	call   80104e85 <release>
        return -1;
8010416a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010416f:	e9 9f 00 00 00       	jmp    80104213 <pipewrite+0xed>
      }
      wakeup(&p->nread);
80104174:	8b 45 08             	mov    0x8(%ebp),%eax
80104177:	05 34 02 00 00       	add    $0x234,%eax
8010417c:	89 04 24             	mov    %eax,(%esp)
8010417f:	e8 ae 0a 00 00       	call   80104c32 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80104184:	8b 45 08             	mov    0x8(%ebp),%eax
80104187:	8b 55 08             	mov    0x8(%ebp),%edx
8010418a:	81 c2 38 02 00 00    	add    $0x238,%edx
80104190:	89 44 24 04          	mov    %eax,0x4(%esp)
80104194:	89 14 24             	mov    %edx,(%esp)
80104197:	e8 bd 09 00 00       	call   80104b59 <sleep>
{
  int i;
...
8010419f:	8b 90 38 02 00 00    	mov    0x238(%eax),%edx
801041a5:	8b 45 08             	mov    0x8(%ebp),%eax
801041a8:	8b 80 34 02 00 00    	mov    0x234(%eax),%eax
801041ae:	05 00 02 00 00       	add    $0x200,%eax
801041b3:	39 c2                	cmp    %eax,%edx
801041b5:	74 8e                	je     80104145 <pipewrite+0x1f>
        return -1;
      }
      wakeup(&p->nread);
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
801041ba:	8b 80 38 02 00 00    	mov    0x238(%eax),%eax
801041c0:	8d 48 01             	lea    0x1(%eax),%ecx
801041c3:	8b 55 08             	mov    0x8(%ebp),%edx
801041c6:	89 8a 38 02 00 00    	mov    %ecx,0x238(%edx)
801041cc:	25 ff 01 00 00       	and    $0x1ff,%eax
801041d1:	89 c1                	mov    %eax,%ecx
801041d3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801041d6:	8b 45 0c             	mov    0xc(%ebp),%eax
801041d9:	01 d0                	add    %edx,%eax
801041db:	0f b6 10             	movzbl (%eax),%edx
801041de:	8b 45 08             	mov    0x8(%ebp),%eax
801041e1:	88 54 08 34          	mov    %dl,0x34(%eax,%ecx,1)
pipewrite(struct pipe *p, char *addr, int n)
{
  int i;
  ...
  acquire(&p->lock);
  for(i = 0; i < n; i++){
801041e5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801041e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041ec:	3b 45 10             	cmp    0x10(%ebp),%eax
801041ef:	0f 8c 4e ff ff ff    	jl     80104143 <pipewrite+0x1d>
      wakeup(&p->nread);
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
    }
    p->data[p->nwrite++ % PIPESIZE] = addr[i];
...
801041f8:	05 34 02 00 00       	add    $0x234,%eax
801041fd:	89 04 24             	mov    %eax,(%esp)
80104200:	e8 2d 0a 00 00       	call   80104c32 <wakeup>
  release(&p->lock);
80104205:	8b 45 08             	mov    0x8(%ebp),%eax
80104208:	89 04 24             	mov    %eax,(%esp)
8010420b:	e8 75 0c 00 00       	call   80104e85 <release>
  return n;
80104210:	8b 45 10             	mov    0x10(%ebp),%eax
}
80104213:	c9                   	leave  
80104214:	c3                   	ret    
...
80104219:	83 ec 24             	sub    $0x24,%esp
  int i;

  acquire(&p->lock);
8010421c:	8b 45 08             	mov    0x8(%ebp),%eax
8010421f:	89 04 24             	mov    %eax,(%esp)
80104222:	e8 fc 0b 00 00       	call   80104e23 <acquire>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
80104227:	eb 3a                	jmp    80104263 <piperead+0x4e>
    if(proc->killed){
80104229:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010422f:	8b 40 24             	mov    0x24(%eax),%eax
80104232:	85 c0                	test   %eax,%eax
80104234:	74 15                	je     8010424b <piperead+0x36>
      release(&p->lock);
80104236:	8b 45 08             	mov    0x8(%ebp),%eax
80104239:	89 04 24             	mov    %eax,(%esp)
8010423c:	e8 44 0c 00 00       	call   80104e85 <release>
      return -1;
80104241:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104246:	e9 b5 00 00 00       	jmp    80104300 <piperead+0xeb>
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
8010424b:	8b 45 08             	mov    0x8(%ebp),%eax
8010424e:	8b 55 08             	mov    0x8(%ebp),%edx
80104251:	81 c2 34 02 00 00    	add    $0x234,%edx
80104257:	89 44 24 04          	mov    %eax,0x4(%esp)
8010425b:	89 14 24             	mov    %edx,(%esp)
8010425e:	e8 f6 08 00 00       	call   80104b59 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80104266:	8b 90 34 02 00 00    	mov    0x234(%eax),%edx
8010426c:	8b 45 08             	mov    0x8(%ebp),%eax
8010426f:	8b 80 38 02 00 00    	mov    0x238(%eax),%eax
80104275:	39 c2                	cmp    %eax,%edx
80104277:	75 0d                	jne    80104286 <piperead+0x71>
80104279:	8b 45 08             	mov    0x8(%ebp),%eax
8010427c:	8b 80 40 02 00 00    	mov    0x240(%eax),%eax
80104282:	85 c0                	test   %eax,%eax
80104284:	75 a3                	jne    80104229 <piperead+0x14>
      release(&p->lock);
      return -1;
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
...
8010428d:	eb 4b                	jmp    801042da <piperead+0xc5>
    if(p->nread == p->nwrite)
8010428f:	8b 45 08             	mov    0x8(%ebp),%eax
80104292:	8b 90 34 02 00 00    	mov    0x234(%eax),%edx
80104298:	8b 45 08             	mov    0x8(%ebp),%eax
8010429b:	8b 80 38 02 00 00    	mov    0x238(%eax),%eax
801042a1:	39 c2                	cmp    %eax,%edx
801042a3:	75 02                	jne    801042a7 <piperead+0x92>
      break;
801042a5:	eb 3b                	jmp    801042e2 <piperead+0xcd>
    addr[i] = p->data[p->nread++ % PIPESIZE];
801042a7:	8b 55 f4             	mov    -0xc(%ebp),%edx
801042aa:	8b 45 0c             	mov    0xc(%ebp),%eax
801042ad:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
801042b0:	8b 45 08             	mov    0x8(%ebp),%eax
801042b3:	8b 80 34 02 00 00    	mov    0x234(%eax),%eax
801042b9:	8d 48 01             	lea    0x1(%eax),%ecx
801042bc:	8b 55 08             	mov    0x8(%ebp),%edx
801042bf:	89 8a 34 02 00 00    	mov    %ecx,0x234(%edx)
801042c5:	25 ff 01 00 00       	and    $0x1ff,%eax
801042ca:	89 c2                	mov    %eax,%edx
801042cc:	8b 45 08             	mov    0x8(%ebp),%eax
801042cf:	0f b6 44 10 34       	movzbl 0x34(%eax,%edx,1),%eax
801042d4:	88 03                	mov    %al,(%ebx)
      release(&p->lock);
      return -1;
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
...
801042e0:	7c ad                	jl     8010428f <piperead+0x7a>
    if(p->nread == p->nwrite)
      break;
    addr[i] = p->data[p->nread++ % PIPESIZE];
  }
...
801042e5:	05 38 02 00 00       	add    $0x238,%eax
801042ea:	89 04 24             	mov    %eax,(%esp)
801042ed:	e8 40 09 00 00       	call   80104c32 <wakeup>
  release(&p->lock);
801042f2:	8b 45 08             	mov    0x8(%ebp),%eax
801042f5:	89 04 24             	mov    %eax,(%esp)
801042f8:	e8 88 0b 00 00       	call   80104e85 <release>
  return i;
801042fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
80104300:	83 c4 24             	add    $0x24,%esp
80104303:	5b                   	pop    %ebx
80104304:	5d                   	pop    %ebp
80104305:	c3                   	ret    
...
8010430c:	9c                   	pushf  
8010430d:	58                   	pop    %eax
8010430e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
80104311:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80104314:	c9                   	leave  
80104315:	c3                   	ret    
...
80104322:	c7 44 24 04 f9 88 10 	movl   $0x801088f9,0x4(%esp)
80104329:	80 
8010432a:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104331:	e8 cc 0a 00 00       	call   80104e02 <initlock>
}
80104336:	c9                   	leave  
80104337:	c3                   	ret    
...
8010433b:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
8010433e:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104345:	e8 d9 0a 00 00       	call   80104e23 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010434a:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
80104351:	eb 50                	jmp    801043a3 <allocproc+0x6b>
    if(p->state == UNUSED)
...
80104361:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
  p->pid = nextpid++;
80104368:	a1 04 b0 10 80       	mov    0x8010b004,%eax
8010436d:	8d 50 01             	lea    0x1(%eax),%edx
80104370:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
80104376:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104379:	89 42 10             	mov    %eax,0x10(%edx)
  release(&ptable.lock);
8010437c:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104383:	e8 fd 0a 00 00       	call   80104e85 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80104388:	e8 55 e7 ff ff       	call   80102ae2 <kalloc>
...
8010439b:	75 33                	jne    801043d0 <allocproc+0x98>
8010439d:	eb 20                	jmp    801043bf <allocproc+0x87>
{
  struct proc *p;
  char *sp;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010439f:	83 45 f4 7c          	addl   $0x7c,-0xc(%ebp)
801043a3:	81 7d f4 b4 48 11 80 	cmpl   $0x801148b4,-0xc(%ebp)
801043aa:	72 a7                	jb     80104353 <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
801043ac:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
801043b3:	e8 cd 0a 00 00       	call   80104e85 <release>
  return 0;
801043b8:	b8 00 00 00 00       	mov    $0x0,%eax
801043bd:	eb 76                	jmp    80104435 <allocproc+0xfd>
  p->pid = nextpid++;
  release(&ptable.lock);
...
801043c2:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
801043c9:	b8 00 00 00 00       	mov    $0x0,%eax
801043ce:	eb 65                	jmp    80104435 <allocproc+0xfd>
  }
  sp = p->kstack + KSTACKSIZE;
801043d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043d3:	8b 40 08             	mov    0x8(%eax),%eax
801043d6:	05 00 10 00 00       	add    $0x1000,%eax
801043db:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
801043de:	83 6d f0 4c          	subl   $0x4c,-0x10(%ebp)
  p->tf = (struct trapframe*)sp;
801043e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043e5:	8b 55 f0             	mov    -0x10(%ebp),%edx
801043e8:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
801043eb:	83 6d f0 04          	subl   $0x4,-0x10(%ebp)
  *(uint*)sp = (uint)trapret;
801043ef:	ba 8b 64 10 80       	mov    $0x8010648b,%edx
801043f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801043f7:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
801043f9:	83 6d f0 14          	subl   $0x14,-0x10(%ebp)
  p->context = (struct context*)sp;
801043fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104400:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104403:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
80104406:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104409:	8b 40 1c             	mov    0x1c(%eax),%eax
8010440c:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104413:	00 
80104414:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010441b:	00 
8010441c:	89 04 24             	mov    %eax,(%esp)
8010441f:	e8 53 0c 00 00       	call   80105077 <memset>
  p->context->eip = (uint)forkret;
80104424:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104427:	8b 40 1c             	mov    0x1c(%eax),%eax
8010442a:	ba 2d 4b 10 80       	mov    $0x80104b2d,%edx
8010442f:	89 50 10             	mov    %edx,0x10(%eax)
...
8010443a:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  extern char _binary_initcode_start[], _binary_initcode_size[];
  
  p = allocproc();
8010443d:	e8 f6 fe ff ff       	call   80104338 <allocproc>
80104442:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
80104445:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104448:	a3 48 b6 10 80       	mov    %eax,0x8010b648
  if((p->pgdir = setupkvm()) == 0)
8010444d:	e8 6c 39 00 00       	call   80107dbe <setupkvm>
80104452:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104455:	89 42 04             	mov    %eax,0x4(%edx)
80104458:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010445b:	8b 40 04             	mov    0x4(%eax),%eax
8010445e:	85 c0                	test   %eax,%eax
80104460:	75 0c                	jne    8010446e <userinit+0x37>
    panic("userinit: out of memory?");
80104462:	c7 04 24 00 89 10 80 	movl   $0x80108900,(%esp)
80104469:	e8 cc c0 ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
8010446e:	ba 2c 00 00 00       	mov    $0x2c,%edx
80104473:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104476:	8b 40 04             	mov    0x4(%eax),%eax
80104479:	89 54 24 08          	mov    %edx,0x8(%esp)
8010447d:	c7 44 24 04 e0 b4 10 	movl   $0x8010b4e0,0x4(%esp)
80104484:	80 
80104485:	89 04 24             	mov    %eax,(%esp)
80104488:	e8 91 3b 00 00       	call   8010801e <inituvm>
  p->sz = PGSIZE;
8010448d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104490:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104496:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104499:	8b 40 18             	mov    0x18(%eax),%eax
8010449c:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
801044a3:	00 
801044a4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801044ab:	00 
801044ac:	89 04 24             	mov    %eax,(%esp)
801044af:	e8 c3 0b 00 00       	call   80105077 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
801044b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044b7:	8b 40 18             	mov    0x18(%eax),%eax
801044ba:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
801044c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044c3:	8b 40 18             	mov    0x18(%eax),%eax
801044c6:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
801044cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044cf:	8b 40 18             	mov    0x18(%eax),%eax
801044d2:	8b 55 f4             	mov    -0xc(%ebp),%edx
801044d5:	8b 52 18             	mov    0x18(%edx),%edx
801044d8:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
801044dc:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
...
801044f0:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
801044f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044f7:	8b 40 18             	mov    0x18(%eax),%eax
801044fa:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80104501:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104504:	8b 40 18             	mov    0x18(%eax),%eax
80104507:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
8010450e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104511:	8b 40 18             	mov    0x18(%eax),%eax
80104514:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
8010451b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010451e:	83 c0 6c             	add    $0x6c,%eax
80104521:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104528:	00 
80104529:	c7 44 24 04 19 89 10 	movl   $0x80108919,0x4(%esp)
80104530:	80 
80104531:	89 04 24             	mov    %eax,(%esp)
80104534:	e8 5e 0d 00 00       	call   80105297 <safestrcpy>
  p->cwd = namei("/");
80104539:	c7 04 24 22 89 10 80 	movl   $0x80108922,(%esp)
80104540:	e8 c1 de ff ff       	call   80102406 <namei>
80104545:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104548:	89 42 68             	mov    %eax,0x68(%edx)

  p->state = RUNNABLE;
8010454b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010454e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
}
80104555:	c9                   	leave  
80104556:	c3                   	ret    
...
8010455a:	83 ec 28             	sub    $0x28,%esp
  uint sz;
...
80104565:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
80104568:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010456c:	7e 34                	jle    801045a2 <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
8010456e:	8b 55 08             	mov    0x8(%ebp),%edx
80104571:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104574:	01 c2                	add    %eax,%edx
...
80104586:	89 54 24 04          	mov    %edx,0x4(%esp)
8010458a:	89 04 24             	mov    %eax,(%esp)
8010458d:	e8 02 3c 00 00       	call   80108194 <allocuvm>
80104592:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104595:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104599:	75 41                	jne    801045dc <growproc+0x85>
      return -1;
8010459b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045a0:	eb 58                	jmp    801045fa <growproc+0xa3>
  } else if(n < 0){
801045a2:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801045a6:	79 34                	jns    801045dc <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
801045a8:	8b 55 08             	mov    0x8(%ebp),%edx
801045ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045ae:	01 c2                	add    %eax,%edx
801045b0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045b6:	8b 40 04             	mov    0x4(%eax),%eax
801045b9:	89 54 24 08          	mov    %edx,0x8(%esp)
801045bd:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045c0:	89 54 24 04          	mov    %edx,0x4(%esp)
801045c4:	89 04 24             	mov    %eax,(%esp)
801045c7:	e8 a2 3c 00 00       	call   8010826e <deallocuvm>
801045cc:	89 45 f4             	mov    %eax,-0xc(%ebp)
801045cf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801045d3:	75 07                	jne    801045dc <growproc+0x85>
      return -1;
801045d5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045da:	eb 1e                	jmp    801045fa <growproc+0xa3>
  }
  proc->sz = sz;
...
801045f0:	e8 c2 38 00 00       	call   80107eb7 <switchuvm>
  return 0;
...
801045ff:	57                   	push   %edi
80104600:	56                   	push   %esi
80104601:	53                   	push   %ebx
80104602:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
80104605:	e8 2e fd ff ff       	call   80104338 <allocproc>
8010460a:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010460d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104611:	75 0a                	jne    8010461d <fork+0x21>
    return -1;
80104613:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104618:	e9 52 01 00 00       	jmp    8010476f <fork+0x173>

  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){			//change in copyuvm if not allc ???????
8010461d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104623:	8b 10                	mov    (%eax),%edx
...
80104635:	e8 d0 3d 00 00       	call   8010840a <copyuvm>
8010463a:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010463d:	89 42 04             	mov    %eax,0x4(%edx)
80104640:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104643:	8b 40 04             	mov    0x4(%eax),%eax
80104646:	85 c0                	test   %eax,%eax
80104648:	75 2c                	jne    80104676 <fork+0x7a>
    kfree(np->kstack);
8010464a:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010464d:	8b 40 08             	mov    0x8(%eax),%eax
80104650:	89 04 24             	mov    %eax,(%esp)
80104653:	e8 f1 e3 ff ff       	call   80102a49 <kfree>
    np->kstack = 0;
80104658:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010465b:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
...
80104671:	e9 f9 00 00 00       	jmp    8010476f <fork+0x173>
  }
  np->sz = proc->sz;
...
80104681:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
80104683:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010468a:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010468d:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
80104690:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104693:	8b 50 18             	mov    0x18(%eax),%edx
80104696:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010469c:	8b 40 18             	mov    0x18(%eax),%eax
8010469f:	89 c3                	mov    %eax,%ebx
801046a1:	b8 13 00 00 00       	mov    $0x13,%eax
801046a6:	89 d7                	mov    %edx,%edi
801046a8:	89 de                	mov    %ebx,%esi
801046aa:	89 c1                	mov    %eax,%ecx
801046ac:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
801046ae:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046b1:	8b 40 18             	mov    0x18(%eax),%eax
801046b4:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
801046bb:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801046c2:	eb 3d                	jmp    80104701 <fork+0x105>
    if(proc->ofile[i])
801046c4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046ca:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801046cd:	83 c2 08             	add    $0x8,%edx
801046d0:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801046d4:	85 c0                	test   %eax,%eax
801046d6:	74 25                	je     801046fd <fork+0x101>
...
80104705:	7e bd                	jle    801046c4 <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
80104707:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010470d:	8b 40 68             	mov    0x68(%eax),%eax
80104710:	89 04 24             	mov    %eax,(%esp)
80104713:	e8 11 d1 ff ff       	call   80101829 <idup>
80104718:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010471b:	89 42 68             	mov    %eax,0x68(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
8010471e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104724:	8d 50 6c             	lea    0x6c(%eax),%edx
80104727:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010472a:	83 c0 6c             	add    $0x6c,%eax
8010472d:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104734:	00 
80104735:	89 54 24 04          	mov    %edx,0x4(%esp)
80104739:	89 04 24             	mov    %eax,(%esp)
8010473c:	e8 56 0b 00 00       	call   80105297 <safestrcpy>
 
  pid = np->pid;
80104741:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104744:	8b 40 10             	mov    0x10(%eax),%eax
80104747:	89 45 dc             	mov    %eax,-0x24(%ebp)

  // lock to force the compiler to emit the np->state write last.
  acquire(&ptable.lock);
8010474a:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104751:	e8 cd 06 00 00       	call   80104e23 <acquire>
  np->state = RUNNABLE;
80104756:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104759:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
80104760:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104767:	e8 19 07 00 00       	call   80104e85 <release>
  
  return pid;
8010476c:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
8010476f:	83 c4 2c             	add    $0x2c,%esp
80104772:	5b                   	pop    %ebx
80104773:	5e                   	pop    %esi
80104774:	5f                   	pop    %edi
80104775:	5d                   	pop    %ebp
...
8010477a:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int fd;

  if(proc == initproc)
8010477d:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104784:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104789:	39 c2                	cmp    %eax,%edx
8010478b:	75 0c                	jne    80104799 <exit+0x22>
    panic("init exiting");
8010478d:	c7 04 24 24 89 10 80 	movl   $0x80108924,(%esp)
80104794:	e8 a1 bd ff ff       	call   8010053a <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104799:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
801047a0:	eb 44                	jmp    801047e6 <exit+0x6f>
    if(proc->ofile[fd]){
801047a2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047a8:	8b 55 f0             	mov    -0x10(%ebp),%edx
801047ab:	83 c2 08             	add    $0x8,%edx
801047ae:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801047b2:	85 c0                	test   %eax,%eax
801047b4:	74 2c                	je     801047e2 <exit+0x6b>
      fileclose(proc->ofile[fd]);
801047b6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047bc:	8b 55 f0             	mov    -0x10(%ebp),%edx
801047bf:	83 c2 08             	add    $0x8,%edx
801047c2:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801047c6:	89 04 24             	mov    %eax,(%esp)
801047c9:	e8 00 c8 ff ff       	call   80100fce <fileclose>
      proc->ofile[fd] = 0;
801047ce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047d4:	8b 55 f0             	mov    -0x10(%ebp),%edx
801047d7:	83 c2 08             	add    $0x8,%edx
801047da:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801047e1:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801047e2:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
801047e6:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
801047ea:	7e b6                	jle    801047a2 <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
801047ec:	e8 1f ec ff ff       	call   80103410 <begin_op>
  iput(proc->cwd);
801047f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047f7:	8b 40 68             	mov    0x68(%eax),%eax
801047fa:	89 04 24             	mov    %eax,(%esp)
801047fd:	e8 0c d2 ff ff       	call   80101a0e <iput>
  end_op();
80104802:	e8 8d ec ff ff       	call   80103494 <end_op>
  proc->cwd = 0;
80104807:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010480d:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80104814:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
8010481b:	e8 03 06 00 00       	call   80104e23 <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80104820:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104826:	8b 40 14             	mov    0x14(%eax),%eax
80104829:	89 04 24             	mov    %eax,(%esp)
8010482c:	e8 c3 03 00 00       	call   80104bf4 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104831:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
80104838:	eb 38                	jmp    80104872 <exit+0xfb>
    if(p->parent == proc){
8010483a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010483d:	8b 50 14             	mov    0x14(%eax),%edx
80104840:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104846:	39 c2                	cmp    %eax,%edx
80104848:	75 24                	jne    8010486e <exit+0xf7>
      p->parent = initproc;
8010484a:	8b 15 48 b6 10 80    	mov    0x8010b648,%edx
80104850:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104853:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
80104856:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104859:	8b 40 0c             	mov    0xc(%eax),%eax
8010485c:	83 f8 05             	cmp    $0x5,%eax
8010485f:	75 0d                	jne    8010486e <exit+0xf7>
        wakeup1(initproc);
80104861:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104866:	89 04 24             	mov    %eax,(%esp)
80104869:	e8 86 03 00 00       	call   80104bf4 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010486e:	83 45 f4 7c          	addl   $0x7c,-0xc(%ebp)
80104872:	81 7d f4 b4 48 11 80 	cmpl   $0x801148b4,-0xc(%ebp)
80104879:	72 bf                	jb     8010483a <exit+0xc3>
        wakeup1(initproc);
    }
  }
...
80104881:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104888:	e8 bc 01 00 00       	call   80104a49 <sched>
  panic("zombie exit");
8010488d:	c7 04 24 31 89 10 80 	movl   $0x80108931,(%esp)
80104894:	e8 a1 bc ff ff       	call   8010053a <panic>
...
8010489c:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
8010489f:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
801048a6:	e8 78 05 00 00       	call   80104e23 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
801048ab:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048b2:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
801048b9:	e9 9a 00 00 00       	jmp    80104958 <wait+0xbf>
      if(p->parent != proc)
801048be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048c1:	8b 50 14             	mov    0x14(%eax),%edx
801048c4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048ca:	39 c2                	cmp    %eax,%edx
801048cc:	74 05                	je     801048d3 <wait+0x3a>
        continue;
801048ce:	e9 81 00 00 00       	jmp    80104954 <wait+0xbb>
      havekids = 1;
801048d3:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
801048da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048dd:	8b 40 0c             	mov    0xc(%eax),%eax
801048e0:	83 f8 05             	cmp    $0x5,%eax
801048e3:	75 6f                	jne    80104954 <wait+0xbb>
        // Found one.
        pid = p->pid;
801048e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048e8:	8b 40 10             	mov    0x10(%eax),%eax
801048eb:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
801048ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048f1:	8b 40 08             	mov    0x8(%eax),%eax
801048f4:	89 04 24             	mov    %eax,(%esp)
801048f7:	e8 4d e1 ff ff       	call   80102a49 <kfree>
        p->kstack = 0;
801048fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048ff:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        freevm(p->pgdir);
80104906:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104909:	8b 40 04             	mov    0x4(%eax),%eax
8010490c:	89 04 24             	mov    %eax,(%esp)
8010490f:	e8 16 3a 00 00       	call   8010832a <freevm>
        p->state = UNUSED;
80104914:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104917:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
8010491e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104921:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104928:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010492b:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80104932:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104935:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80104939:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010493c:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104943:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
8010494a:	e8 36 05 00 00       	call   80104e85 <release>
        return pid;
8010494f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104952:	eb 52                	jmp    801049a6 <wait+0x10d>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104954:	83 45 f4 7c          	addl   $0x7c,-0xc(%ebp)
80104958:	81 7d f4 b4 48 11 80 	cmpl   $0x801148b4,-0xc(%ebp)
8010495f:	0f 82 59 ff ff ff    	jb     801048be <wait+0x25>
        return pid;
      }
    }
...
80104965:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104969:	74 0d                	je     80104978 <wait+0xdf>
8010496b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104971:	8b 40 24             	mov    0x24(%eax),%eax
80104974:	85 c0                	test   %eax,%eax
80104976:	74 13                	je     8010498b <wait+0xf2>
      release(&ptable.lock);
80104978:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
8010497f:	e8 01 05 00 00       	call   80104e85 <release>
      return -1;
80104984:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104989:	eb 1b                	jmp    801049a6 <wait+0x10d>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
8010498b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104991:	c7 44 24 04 80 29 11 	movl   $0x80112980,0x4(%esp)
80104998:	80 
80104999:	89 04 24             	mov    %eax,(%esp)
8010499c:	e8 b8 01 00 00       	call   80104b59 <sleep>
  }
801049a1:	e9 05 ff ff ff       	jmp    801048ab <wait+0x12>
}
801049a6:	c9                   	leave  
801049a7:	c3                   	ret    
...
801049ab:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
801049ae:	e8 63 f9 ff ff       	call   80104316 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
801049b3:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
801049ba:	e8 64 04 00 00       	call   80104e23 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049bf:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
801049c6:	eb 67                	jmp    80104a2f <scheduler+0x87>
      if(p->state != RUNNABLE)
801049c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049cb:	8b 40 0c             	mov    0xc(%eax),%eax
801049ce:	83 f8 03             	cmp    $0x3,%eax
801049d1:	74 02                	je     801049d5 <scheduler+0x2d>
        continue;
801049d3:	eb 56                	jmp    80104a2b <scheduler+0x83>
...
801049d8:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
801049de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049e1:	89 04 24             	mov    %eax,(%esp)
801049e4:	e8 ce 34 00 00       	call   80107eb7 <switchuvm>
      p->state = RUNNING;
801049e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049ec:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
801049f3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049f9:	8b 40 1c             	mov    0x1c(%eax),%eax
801049fc:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104a03:	83 c2 08             	add    $0x8,%edx
80104a06:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a0a:	89 14 24             	mov    %edx,(%esp)
80104a0d:	e8 f6 08 00 00       	call   80105308 <swtch>
      switchkvm(cpu);
80104a12:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a18:	89 04 24             	mov    %eax,(%esp)
80104a1b:	e8 79 34 00 00       	call   80107e99 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104a20:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104a27:	00 00 00 00 
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a2b:	83 45 f4 7c          	addl   $0x7c,-0xc(%ebp)
80104a2f:	81 7d f4 b4 48 11 80 	cmpl   $0x801148b4,-0xc(%ebp)
80104a36:	72 90                	jb     801049c8 <scheduler+0x20>
    ...
    release(&ptable.lock);
80104a38:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104a3f:	e8 41 04 00 00       	call   80104e85 <release>

  }
80104a44:	e9 65 ff ff ff       	jmp    801049ae <scheduler+0x6>
...
80104a4f:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104a56:	e8 f2 04 00 00       	call   80104f4d <holding>
80104a5b:	85 c0                	test   %eax,%eax
80104a5d:	75 0c                	jne    80104a6b <sched+0x22>
    panic("sched ptable.lock");
80104a5f:	c7 04 24 3d 89 10 80 	movl   $0x8010893d,(%esp)
...
80104a77:	83 f8 01             	cmp    $0x1,%eax
80104a7a:	74 0c                	je     80104a88 <sched+0x3f>
    panic("sched locks");
80104a7c:	c7 04 24 4f 89 10 80 	movl   $0x8010894f,(%esp)
...
80104a91:	83 f8 04             	cmp    $0x4,%eax
80104a94:	75 0c                	jne    80104aa2 <sched+0x59>
    panic("sched running");
80104a96:	c7 04 24 5b 89 10 80 	movl   $0x8010895b,(%esp)
80104a9d:	e8 98 ba ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
80104aa2:	e8 5f f8 ff ff       	call   80104306 <readeflags>
80104aa7:	25 00 02 00 00       	and    $0x200,%eax
80104aac:	85 c0                	test   %eax,%eax
80104aae:	74 0c                	je     80104abc <sched+0x73>
    panic("sched interruptible");
80104ab0:	c7 04 24 69 89 10 80 	movl   $0x80108969,(%esp)
80104ab7:	e8 7e ba ff ff       	call   8010053a <panic>
  intena = cpu->intena;
80104abc:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ac2:	8b 80 b4 00 00 00    	mov    0xb4(%eax),%eax
80104ac8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104acb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ad1:	8b 40 08             	mov    0x8(%eax),%eax
80104ad4:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104adb:	83 c2 1c             	add    $0x1c,%edx
80104ade:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ae2:	89 14 24             	mov    %edx,(%esp)
80104ae5:	e8 1e 08 00 00       	call   80105308 <swtch>
  cpu->intena = intena;
80104aea:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104af0:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104af3:	89 90 b4 00 00 00    	mov    %edx,0xb4(%eax)
}
80104af9:	c9                   	leave  
80104afa:	c3                   	ret    
...
80104b01:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104b08:	e8 16 03 00 00       	call   80104e23 <acquire>
  proc->state = RUNNABLE;
80104b0d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b13:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104b1a:	e8 2a ff ff ff       	call   80104a49 <sched>
  release(&ptable.lock);
80104b1f:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104b26:	e8 5a 03 00 00       	call   80104e85 <release>
}
80104b2b:	c9                   	leave  
80104b2c:	c3                   	ret    
...
80104b30:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104b33:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104b3a:	e8 46 03 00 00       	call   80104e85 <release>

  if (first) {
80104b3f:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80104b44:	85 c0                	test   %eax,%eax
80104b46:	74 0f                	je     80104b57 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104b48:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104b4f:	00 00 00 
    initlog();
80104b52:	e8 ab e6 ff ff       	call   80103202 <initlog>
  }
...
80104b67:	75 0c                	jne    80104b75 <sleep+0x1c>
    panic("sleep");
80104b69:	c7 04 24 7d 89 10 80 	movl   $0x8010897d,(%esp)
80104b70:	e8 c5 b9 ff ff       	call   8010053a <panic>

  if(lk == 0)
80104b75:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104b79:	75 0c                	jne    80104b87 <sleep+0x2e>
    panic("sleep without lk");
80104b7b:	c7 04 24 83 89 10 80 	movl   $0x80108983,(%esp)
...
80104b87:	81 7d 0c 80 29 11 80 	cmpl   $0x80112980,0xc(%ebp)
80104b8e:	74 17                	je     80104ba7 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104b90:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104b97:	e8 87 02 00 00       	call   80104e23 <acquire>
    release(lk);
80104b9c:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b9f:	89 04 24             	mov    %eax,(%esp)
80104ba2:	e8 de 02 00 00       	call   80104e85 <release>
  }
...
80104bb0:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104bb3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bb9:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104bc0:	e8 84 fe ff ff       	call   80104a49 <sched>

  // Tidy up.
  proc->chan = 0;
80104bc5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bcb:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104bd2:	81 7d 0c 80 29 11 80 	cmpl   $0x80112980,0xc(%ebp)
80104bd9:	74 17                	je     80104bf2 <sleep+0x99>
    release(&ptable.lock);
80104bdb:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104be2:	e8 9e 02 00 00       	call   80104e85 <release>
    acquire(lk);
80104be7:	8b 45 0c             	mov    0xc(%ebp),%eax
80104bea:	89 04 24             	mov    %eax,(%esp)
80104bed:	e8 31 02 00 00       	call   80104e23 <acquire>
  }
}
80104bf2:	c9                   	leave  
80104bf3:	c3                   	ret    
...
80104bf7:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104bfa:	c7 45 fc b4 29 11 80 	movl   $0x801129b4,-0x4(%ebp)
80104c01:	eb 24                	jmp    80104c27 <wakeup1+0x33>
    if(p->state == SLEEPING && p->chan == chan)
80104c03:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104c06:	8b 40 0c             	mov    0xc(%eax),%eax
80104c09:	83 f8 02             	cmp    $0x2,%eax
80104c0c:	75 15                	jne    80104c23 <wakeup1+0x2f>
80104c0e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104c11:	8b 40 20             	mov    0x20(%eax),%eax
80104c14:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c17:	75 0a                	jne    80104c23 <wakeup1+0x2f>
      p->state = RUNNABLE;
80104c19:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104c1c:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104c23:	83 45 fc 7c          	addl   $0x7c,-0x4(%ebp)
80104c27:	81 7d fc b4 48 11 80 	cmpl   $0x801148b4,-0x4(%ebp)
80104c2e:	72 d3                	jb     80104c03 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104c30:	c9                   	leave  
...
80104c35:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104c38:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104c3f:	e8 df 01 00 00       	call   80104e23 <acquire>
  wakeup1(chan);
80104c44:	8b 45 08             	mov    0x8(%ebp),%eax
80104c47:	89 04 24             	mov    %eax,(%esp)
80104c4a:	e8 a5 ff ff ff       	call   80104bf4 <wakeup1>
  release(&ptable.lock);
80104c4f:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104c56:	e8 2a 02 00 00       	call   80104e85 <release>
}
80104c5b:	c9                   	leave  
80104c5c:	c3                   	ret    
...
80104c60:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
80104c63:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104c6a:	e8 b4 01 00 00       	call   80104e23 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c6f:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
80104c76:	eb 41                	jmp    80104cb9 <kill+0x5c>
    if(p->pid == pid){
80104c78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c7b:	8b 40 10             	mov    0x10(%eax),%eax
80104c7e:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c81:	75 32                	jne    80104cb5 <kill+0x58>
      p->killed = 1;
80104c83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c86:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104c8d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c90:	8b 40 0c             	mov    0xc(%eax),%eax
80104c93:	83 f8 02             	cmp    $0x2,%eax
80104c96:	75 0a                	jne    80104ca2 <kill+0x45>
        p->state = RUNNABLE;
80104c98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c9b:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104ca2:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104ca9:	e8 d7 01 00 00       	call   80104e85 <release>
      return 0;
80104cae:	b8 00 00 00 00       	mov    $0x0,%eax
80104cb3:	eb 1e                	jmp    80104cd3 <kill+0x76>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cb5:	83 45 f4 7c          	addl   $0x7c,-0xc(%ebp)
80104cb9:	81 7d f4 b4 48 11 80 	cmpl   $0x801148b4,-0xc(%ebp)
80104cc0:	72 b6                	jb     80104c78 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104cc2:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104cc9:	e8 b7 01 00 00       	call   80104e85 <release>
  return -1;
...
80104cd8:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cdb:	c7 45 f0 b4 29 11 80 	movl   $0x801129b4,-0x10(%ebp)
80104ce2:	e9 d6 00 00 00       	jmp    80104dbd <procdump+0xe8>
    if(p->state == UNUSED)
80104ce7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cea:	8b 40 0c             	mov    0xc(%eax),%eax
80104ced:	85 c0                	test   %eax,%eax
80104cef:	75 05                	jne    80104cf6 <procdump+0x21>
      continue;
80104cf1:	e9 c3 00 00 00       	jmp    80104db9 <procdump+0xe4>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104cf6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cf9:	8b 40 0c             	mov    0xc(%eax),%eax
80104cfc:	83 f8 05             	cmp    $0x5,%eax
80104cff:	77 23                	ja     80104d24 <procdump+0x4f>
80104d01:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d04:	8b 40 0c             	mov    0xc(%eax),%eax
80104d07:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104d0e:	85 c0                	test   %eax,%eax
80104d10:	74 12                	je     80104d24 <procdump+0x4f>
      state = states[p->state];
80104d12:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d15:	8b 40 0c             	mov    0xc(%eax),%eax
80104d18:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104d1f:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104d22:	eb 07                	jmp    80104d2b <procdump+0x56>
    else
      state = "???";
80104d24:	c7 45 ec 94 89 10 80 	movl   $0x80108994,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104d2b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d2e:	8d 50 6c             	lea    0x6c(%eax),%edx
80104d31:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d34:	8b 40 10             	mov    0x10(%eax),%eax
80104d37:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104d3b:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104d3e:	89 54 24 08          	mov    %edx,0x8(%esp)
80104d42:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d46:	c7 04 24 98 89 10 80 	movl   $0x80108998,(%esp)
80104d4d:	e8 4e b6 ff ff       	call   801003a0 <cprintf>
    if(p->state == SLEEPING){
80104d52:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d55:	8b 40 0c             	mov    0xc(%eax),%eax
80104d58:	83 f8 02             	cmp    $0x2,%eax
80104d5b:	75 50                	jne    80104dad <procdump+0xd8>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104d5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d60:	8b 40 1c             	mov    0x1c(%eax),%eax
80104d63:	8b 40 0c             	mov    0xc(%eax),%eax
80104d66:	83 c0 08             	add    $0x8,%eax
80104d69:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104d6c:	89 54 24 04          	mov    %edx,0x4(%esp)
80104d70:	89 04 24             	mov    %eax,(%esp)
80104d73:	e8 5c 01 00 00       	call   80104ed4 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104d78:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104d7f:	eb 1b                	jmp    80104d9c <procdump+0xc7>
        cprintf(" %p", pc[i]);
80104d81:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d84:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104d88:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d8c:	c7 04 24 a1 89 10 80 	movl   $0x801089a1,(%esp)
80104d93:	e8 08 b6 ff ff       	call   801003a0 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104d98:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104d9c:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104da0:	7f 0b                	jg     80104dad <procdump+0xd8>
80104da2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104da5:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104da9:	85 c0                	test   %eax,%eax
80104dab:	75 d4                	jne    80104d81 <procdump+0xac>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104dad:	c7 04 24 a5 89 10 80 	movl   $0x801089a5,(%esp)
80104db4:	e8 e7 b5 ff ff       	call   801003a0 <cprintf>
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104db9:	83 45 f0 7c          	addl   $0x7c,-0x10(%ebp)
80104dbd:	81 7d f0 b4 48 11 80 	cmpl   $0x801148b4,-0x10(%ebp)
80104dc4:	0f 82 1d ff ff ff    	jb     80104ce7 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104df7:	f0 87 02             	lock xchg %eax,(%edx)
80104dfa:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
80104e0b:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80104e0e:	8b 45 08             	mov    0x8(%ebp),%eax
80104e11:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80104e17:	8b 45 08             	mov    0x8(%ebp),%eax
80104e1a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80104e21:	5d                   	pop    %ebp
80104e22:	c3                   	ret    
...
80104e29:	e8 49 01 00 00       	call   80104f77 <pushcli>
  if(holding(lk))
80104e2e:	8b 45 08             	mov    0x8(%ebp),%eax
80104e31:	89 04 24             	mov    %eax,(%esp)
80104e34:	e8 14 01 00 00       	call   80104f4d <holding>
80104e39:	85 c0                	test   %eax,%eax
80104e3b:	74 0c                	je     80104e49 <acquire+0x26>
    panic("acquire");
80104e3d:	c7 04 24 d1 89 10 80 	movl   $0x801089d1,(%esp)
...
80104e4d:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104e54:	00 
80104e55:	89 04 24             	mov    %eax,(%esp)
80104e58:	e8 8b ff ff ff       	call   80104de8 <xchg>
80104e5d:	85 c0                	test   %eax,%eax
80104e5f:	75 e9                	jne    80104e4a <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104e61:	8b 45 08             	mov    0x8(%ebp),%eax
80104e64:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104e6b:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104e6e:	8b 45 08             	mov    0x8(%ebp),%eax
80104e71:	83 c0 0c             	add    $0xc,%eax
80104e74:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e78:	8d 45 08             	lea    0x8(%ebp),%eax
80104e7b:	89 04 24             	mov    %eax,(%esp)
80104e7e:	e8 51 00 00 00       	call   80104ed4 <getcallerpcs>
}
80104e83:	c9                   	leave  
80104e84:	c3                   	ret    
...
80104e91:	e8 b7 00 00 00       	call   80104f4d <holding>
80104e96:	85 c0                	test   %eax,%eax
80104e98:	75 0c                	jne    80104ea6 <release+0x21>
    panic("release");
80104e9a:	c7 04 24 d9 89 10 80 	movl   $0x801089d9,(%esp)
80104ea1:	e8 94 b6 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104ea6:	8b 45 08             	mov    0x8(%ebp),%eax
80104ea9:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104eb0:	8b 45 08             	mov    0x8(%ebp),%eax
80104eb3:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104ebd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104ec4:	00 
80104ec5:	89 04 24             	mov    %eax,(%esp)
80104ec8:	e8 1b ff ff ff       	call   80104de8 <xchg>

  popcli();
80104ecd:	e8 e9 00 00 00       	call   80104fbb <popcli>
}
80104ed2:	c9                   	leave  
80104ed3:	c3                   	ret    

80104ed4 <getcallerpcs>:
...
80104edd:	83 e8 08             	sub    $0x8,%eax
80104ee0:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104ee3:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104eea:	eb 38                	jmp    80104f24 <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104eec:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104ef0:	74 38                	je     80104f2a <getcallerpcs+0x56>
80104ef2:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104ef9:	76 2f                	jbe    80104f2a <getcallerpcs+0x56>
80104efb:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104eff:	74 29                	je     80104f2a <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104f01:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104f04:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104f0b:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f0e:	01 c2                	add    %eax,%edx
80104f10:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104f13:	8b 40 04             	mov    0x4(%eax),%eax
80104f16:	89 02                	mov    %eax,(%edx)
...
80104f1d:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104f20:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104f24:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104f28:	7e c2                	jle    80104eec <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104f2a:	eb 19                	jmp    80104f45 <getcallerpcs+0x71>
    pcs[i] = 0;
80104f2c:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104f2f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104f36:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f39:	01 d0                	add    %edx,%eax
80104f3b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104f41:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104f45:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104f49:	7e e1                	jle    80104f2c <getcallerpcs+0x58>
    pcs[i] = 0;
}
80104f4b:	c9                   	leave  
80104f4c:	c3                   	ret    
...
80104f57:	74 17                	je     80104f70 <holding+0x23>
80104f59:	8b 45 08             	mov    0x8(%ebp),%eax
80104f5c:	8b 50 08             	mov    0x8(%eax),%edx
80104f5f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f65:	39 c2                	cmp    %eax,%edx
80104f67:	75 07                	jne    80104f70 <holding+0x23>
80104f69:	b8 01 00 00 00       	mov    $0x1,%eax
80104f6e:	eb 05                	jmp    80104f75 <holding+0x28>
...
80104f7a:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80104f7d:	e8 4a fe ff ff       	call   80104dcc <readeflags>
80104f82:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104f85:	e8 52 fe ff ff       	call   80104ddc <cli>
  if(cpu->ncli++ == 0)
80104f8a:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104f91:	8b 82 b0 00 00 00    	mov    0xb0(%edx),%eax
80104f97:	8d 48 01             	lea    0x1(%eax),%ecx
80104f9a:	89 8a b0 00 00 00    	mov    %ecx,0xb0(%edx)
80104fa0:	85 c0                	test   %eax,%eax
80104fa2:	75 15                	jne    80104fb9 <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
80104fa4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104faa:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104fad:	81 e2 00 02 00 00    	and    $0x200,%edx
80104fb3:	89 90 b4 00 00 00    	mov    %edx,0xb4(%eax)
}
80104fb9:	c9                   	leave  
80104fba:	c3                   	ret    
...
80104fbe:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104fc1:	e8 06 fe ff ff       	call   80104dcc <readeflags>
80104fc6:	25 00 02 00 00       	and    $0x200,%eax
80104fcb:	85 c0                	test   %eax,%eax
80104fcd:	74 0c                	je     80104fdb <popcli+0x20>
    panic("popcli - interruptible");
80104fcf:	c7 04 24 e1 89 10 80 	movl   $0x801089e1,(%esp)
80104fd6:	e8 5f b5 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
80104fdb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104fe1:	8b 90 b0 00 00 00    	mov    0xb0(%eax),%edx
80104fe7:	83 ea 01             	sub    $0x1,%edx
80104fea:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
80104ff0:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104ff6:	85 c0                	test   %eax,%eax
80104ff8:	79 0c                	jns    80105006 <popcli+0x4b>
    panic("popcli");
80104ffa:	c7 04 24 f8 89 10 80 	movl   $0x801089f8,(%esp)
80105001:	e8 34 b5 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
80105006:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010500c:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105012:	85 c0                	test   %eax,%eax
80105014:	75 15                	jne    8010502b <popcli+0x70>
80105016:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010501c:	8b 80 b4 00 00 00    	mov    0xb4(%eax),%eax
80105022:	85 c0                	test   %eax,%eax
80105024:	74 05                	je     8010502b <popcli+0x70>
    sti();
80105026:	e8 b7 fd ff ff       	call   80104de2 <sti>
}
8010502b:	c9                   	leave  
8010502c:	c3                   	ret    
...
8010503b:	89 cb                	mov    %ecx,%ebx
8010503d:	89 df                	mov    %ebx,%edi
8010503f:	89 d1                	mov    %edx,%ecx
80105041:	fc                   	cld    
80105042:	f3 aa                	rep stos %al,%es:(%edi)
80105044:	89 ca                	mov    %ecx,%edx
80105046:	89 fb                	mov    %edi,%ebx
80105048:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010504b:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80105057:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010505a:	8b 55 10             	mov    0x10(%ebp),%edx
8010505d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105060:	89 cb                	mov    %ecx,%ebx
80105062:	89 df                	mov    %ebx,%edi
80105064:	89 d1                	mov    %edx,%ecx
80105066:	fc                   	cld    
80105067:	f3 ab                	rep stos %eax,%es:(%edi)
80105069:	89 ca                	mov    %ecx,%edx
8010506b:	89 fb                	mov    %edi,%ebx
8010506d:	89 5d 08             	mov    %ebx,0x8(%ebp)
80105070:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80105085:	75 49                	jne    801050d0 <memset+0x59>
80105087:	8b 45 10             	mov    0x10(%ebp),%eax
8010508a:	83 e0 03             	and    $0x3,%eax
8010508d:	85 c0                	test   %eax,%eax
8010508f:	75 3f                	jne    801050d0 <memset+0x59>
    c &= 0xFF;
80105091:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105098:	8b 45 10             	mov    0x10(%ebp),%eax
8010509b:	c1 e8 02             	shr    $0x2,%eax
...
801050ab:	c1 e0 10             	shl    $0x10,%eax
801050ae:	09 c1                	or     %eax,%ecx
801050b0:	8b 45 0c             	mov    0xc(%ebp),%eax
801050b3:	c1 e0 08             	shl    $0x8,%eax
801050b6:	09 c8                	or     %ecx,%eax
801050b8:	0b 45 0c             	or     0xc(%ebp),%eax
801050bb:	89 54 24 08          	mov    %edx,0x8(%esp)
801050bf:	89 44 24 04          	mov    %eax,0x4(%esp)
801050c3:	8b 45 08             	mov    0x8(%ebp),%eax
801050c6:	89 04 24             	mov    %eax,(%esp)
801050c9:	e8 84 ff ff ff       	call   80105052 <stosl>
801050ce:	eb 19                	jmp    801050e9 <memset+0x72>
  } else
    stosb(dst, c, n);
801050d0:	8b 45 10             	mov    0x10(%ebp),%eax
801050d3:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801050e4:	e8 44 ff ff ff       	call   8010502d <stosb>
  return dst;
...
801050f1:	83 ec 10             	sub    $0x10,%esp
  const uchar *s1, *s2;
...
80105135:	8d 50 ff             	lea    -0x1(%eax),%edx
80105138:	89 55 10             	mov    %edx,0x10(%ebp)
8010513b:	85 c0                	test   %eax,%eax
8010513d:	75 c3                	jne    80105102 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105155:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
80105158:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010515b:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010515e:	73 3d                	jae    8010519d <memmove+0x57>
80105160:	8b 45 10             	mov    0x10(%ebp),%eax
80105163:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105166:	01 d0                	add    %edx,%eax
80105168:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010516b:	76 30                	jbe    8010519d <memmove+0x57>
    s += n;
8010516d:	8b 45 10             	mov    0x10(%ebp),%eax
80105170:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105173:	8b 45 10             	mov    0x10(%ebp),%eax
80105176:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105179:	eb 13                	jmp    8010518e <memmove+0x48>
      *--d = *--s;
8010517b:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010517f:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
80105199:	75 e0                	jne    8010517b <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010519b:	eb 26                	jmp    801051c3 <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
801051bc:	89 55 10             	mov    %edx,0x10(%ebp)
801051bf:	85 c0                	test   %eax,%eax
801051c1:	75 dc                	jne    8010519f <memmove+0x59>
      *d++ = *s++;
...
801051ce:	8b 45 10             	mov    0x10(%ebp),%eax
801051d1:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801051e2:	e8 5f ff ff ff       	call   80105146 <memmove>
}
801051e7:	c9                   	leave  
801051e8:	c3                   	ret    
...
801051ea:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801051ec:	eb 0c                	jmp    801051fa <strncmp+0x11>
    n--, p++, q++;
801051ee:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801051f2:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801051f6:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801051fe:	74 1a                	je     8010521a <strncmp+0x31>
80105200:	8b 45 08             	mov    0x8(%ebp),%eax
80105203:	0f b6 00             	movzbl (%eax),%eax
80105206:	84 c0                	test   %al,%al
80105208:	74 10                	je     8010521a <strncmp+0x31>
8010520a:	8b 45 08             	mov    0x8(%ebp),%eax
8010520d:	0f b6 10             	movzbl (%eax),%edx
80105210:	8b 45 0c             	mov    0xc(%ebp),%eax
80105213:	0f b6 00             	movzbl (%eax),%eax
80105216:	38 c2                	cmp    %al,%dl
80105218:	74 d4                	je     801051ee <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
8010521a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010521e:	75 07                	jne    80105227 <strncmp+0x3e>
    return 0;
80105220:	b8 00 00 00 00       	mov    $0x0,%eax
80105225:	eb 16                	jmp    8010523d <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
80105227:	8b 45 08             	mov    0x8(%ebp),%eax
8010522a:	0f b6 00             	movzbl (%eax),%eax
8010522d:	0f b6 d0             	movzbl %al,%edx
...
80105257:	7e 1e                	jle    80105277 <strncpy+0x38>
...
80105275:	75 d5                	jne    8010524c <strncpy+0xd>
    ;
  while(n-- > 0)
80105277:	eb 0c                	jmp    80105285 <strncpy+0x46>
    *s++ = 0;
80105279:	8b 45 08             	mov    0x8(%ebp),%eax
8010527c:	8d 50 01             	lea    0x1(%eax),%edx
8010527f:	89 55 08             	mov    %edx,0x8(%ebp)
80105282:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
80105290:	7f e7                	jg     80105279 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
801052a0:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
801052a3:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801052a7:	7f 05                	jg     801052ae <safestrcpy+0x17>
    return os;
801052a9:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052ac:	eb 31                	jmp    801052df <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
801052ae:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801052b2:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801052b6:	7e 1e                	jle    801052d6 <safestrcpy+0x3f>
801052b8:	8b 45 08             	mov    0x8(%ebp),%eax
801052bb:	8d 50 01             	lea    0x1(%eax),%edx
801052be:	89 55 08             	mov    %edx,0x8(%ebp)
801052c1:	8b 55 0c             	mov    0xc(%ebp),%edx
801052c4:	8d 4a 01             	lea    0x1(%edx),%ecx
801052c7:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801052ca:	0f b6 12             	movzbl (%edx),%edx
801052cd:	88 10                	mov    %dl,(%eax)
801052cf:	0f b6 00             	movzbl (%eax),%eax
801052d2:	84 c0                	test   %al,%al
801052d4:	75 d8                	jne    801052ae <safestrcpy+0x17>
    ;
  *s = 0;
...
801052ee:	eb 04                	jmp    801052f4 <strlen+0x13>
801052f0:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801052f4:	8b 55 fc             	mov    -0x4(%ebp),%edx
801052f7:	8b 45 08             	mov    0x8(%ebp),%eax
801052fa:	01 d0                	add    %edx,%eax
801052fc:	0f b6 00             	movzbl (%eax),%eax
801052ff:	84 c0                	test   %al,%al
80105301:	75 ed                	jne    801052f0 <strlen+0xf>
    ;
  return n;
...
80105365:	3b 45 08             	cmp    0x8(%ebp),%eax
80105368:	77 07                	ja     80105371 <fetchstr+0x1a>
    return -1;
8010536a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010536f:	eb 46                	jmp    801053b7 <fetchstr+0x60>
  *pp = (char*)addr;
80105371:	8b 55 08             	mov    0x8(%ebp),%edx
80105374:	8b 45 0c             	mov    0xc(%ebp),%eax
80105377:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
80105379:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010537f:	8b 00                	mov    (%eax),%eax
80105381:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
80105384:	8b 45 0c             	mov    0xc(%ebp),%eax
80105387:	8b 00                	mov    (%eax),%eax
80105389:	89 45 fc             	mov    %eax,-0x4(%ebp)
8010538c:	eb 1c                	jmp    801053aa <fetchstr+0x53>
    if(*s == 0)
8010538e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105391:	0f b6 00             	movzbl (%eax),%eax
80105394:	84 c0                	test   %al,%al
80105396:	75 0e                	jne    801053a6 <fetchstr+0x4f>
      return s - *pp;
...
801053a4:	eb 11                	jmp    801053b7 <fetchstr+0x60>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
801053a6:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801053aa:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053ad:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801053b0:	72 dc                	jb     8010538e <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
801053c5:	8b 40 18             	mov    0x18(%eax),%eax
801053c8:	8b 50 44             	mov    0x44(%eax),%edx
801053cb:	8b 45 08             	mov    0x8(%ebp),%eax
801053ce:	c1 e0 02             	shl    $0x2,%eax
801053d1:	01 d0                	add    %edx,%eax
801053d3:	8d 50 04             	lea    0x4(%eax),%edx
801053d6:	8b 45 0c             	mov    0xc(%ebp),%eax
801053d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801053dd:	89 14 24             	mov    %edx,(%esp)
801053e0:	e8 38 ff ff ff       	call   8010531d <fetchint>
}
801053e5:	c9                   	leave  
801053e6:	c3                   	ret    
...
80105419:	73 16                	jae    80105431 <argptr+0x4a>
...
8010542f:	76 07                	jbe    80105438 <argptr+0x51>
    return -1;
80105431:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105436:	eb 0f                	jmp    80105447 <argptr+0x60>
  *pp = (char*)i;
80105438:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010543b:	89 c2                	mov    %eax,%edx
8010543d:	8b 45 0c             	mov    0xc(%ebp),%eax
...
80105493:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105496:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010549a:	7e 30                	jle    801054cc <syscall+0x4c>
8010549c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010549f:	83 f8 15             	cmp    $0x15,%eax
801054a2:	77 28                	ja     801054cc <syscall+0x4c>
801054a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054a7:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054ae:	85 c0                	test   %eax,%eax
801054b0:	74 1a                	je     801054cc <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
801054b2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054b8:	8b 58 18             	mov    0x18(%eax),%ebx
801054bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054be:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054c5:	ff d0                	call   *%eax
801054c7:	89 43 1c             	mov    %eax,0x1c(%ebx)
801054ca:	eb 3d                	jmp    80105509 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801054cc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054d2:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
801054e1:	89 54 24 0c          	mov    %edx,0xc(%esp)
801054e5:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801054e9:	89 44 24 04          	mov    %eax,0x4(%esp)
801054ed:	c7 04 24 ff 89 10 80 	movl   $0x801089ff,(%esp)
801054f4:	e8 a7 ae ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801054f9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054ff:	8b 40 18             	mov    0x18(%eax),%eax
80105502:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105509:	83 c4 24             	add    $0x24,%esp
8010550c:	5b                   	pop    %ebx
8010550d:	5d                   	pop    %ebp
8010550e:	c3                   	ret    
...
80105512:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
80105515:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105518:	89 44 24 04          	mov    %eax,0x4(%esp)
8010551c:	8b 45 08             	mov    0x8(%ebp),%eax
8010551f:	89 04 24             	mov    %eax,(%esp)
80105522:	e8 92 fe ff ff       	call   801053b9 <argint>
80105527:	85 c0                	test   %eax,%eax
80105529:	79 07                	jns    80105532 <argfd+0x23>
    return -1;
8010552b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105530:	eb 50                	jmp    80105582 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105532:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105535:	85 c0                	test   %eax,%eax
80105537:	78 21                	js     8010555a <argfd+0x4b>
80105539:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010553c:	83 f8 0f             	cmp    $0xf,%eax
8010553f:	7f 19                	jg     8010555a <argfd+0x4b>
80105541:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105547:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010554a:	83 c2 08             	add    $0x8,%edx
8010554d:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105551:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105554:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105558:	75 07                	jne    80105561 <argfd+0x52>
    return -1;
8010555a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010555f:	eb 21                	jmp    80105582 <argfd+0x73>
  if(pfd)
80105561:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105565:	74 08                	je     8010556f <argfd+0x60>
    *pfd = fd;
80105567:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010556a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010556d:	89 10                	mov    %edx,(%eax)
  if(pf)
8010556f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105573:	74 08                	je     8010557d <argfd+0x6e>
    *pf = f;
80105575:	8b 45 10             	mov    0x10(%ebp),%eax
80105578:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010557b:	89 10                	mov    %edx,(%eax)
  return 0;
8010557d:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105582:	c9                   	leave  
80105583:	c3                   	ret    
...
80105587:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010558a:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105591:	eb 30                	jmp    801055c3 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105593:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105599:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010559c:	83 c2 08             	add    $0x8,%edx
8010559f:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801055a3:	85 c0                	test   %eax,%eax
801055a5:	75 18                	jne    801055bf <fdalloc+0x3b>
      proc->ofile[fd] = f;
801055a7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055ad:	8b 55 fc             	mov    -0x4(%ebp),%edx
801055b0:	8d 4a 08             	lea    0x8(%edx),%ecx
801055b3:	8b 55 08             	mov    0x8(%ebp),%edx
801055b6:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
801055ba:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055bd:	eb 0f                	jmp    801055ce <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
801055bf:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801055c3:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
801055c7:	7e ca                	jle    80105593 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
801055ec:	e8 1e ff ff ff       	call   8010550f <argfd>
801055f1:	85 c0                	test   %eax,%eax
801055f3:	79 07                	jns    801055fc <sys_dup+0x2c>
    return -1;
801055f5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055fa:	eb 29                	jmp    80105625 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
801055fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055ff:	89 04 24             	mov    %eax,(%esp)
80105602:	e8 7d ff ff ff       	call   80105584 <fdalloc>
80105607:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010560a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010560e:	79 07                	jns    80105617 <sys_dup+0x47>
    return -1;
80105610:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105615:	eb 0e                	jmp    80105625 <sys_dup+0x55>
  filedup(f);
80105617:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010561a:	89 04 24             	mov    %eax,(%esp)
8010561d:	e8 64 b9 ff ff       	call   80100f86 <filedup>
  return fd;
...
80105643:	e8 c7 fe ff ff       	call   8010550f <argfd>
80105648:	85 c0                	test   %eax,%eax
8010564a:	78 35                	js     80105681 <sys_read+0x5a>
8010564c:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010564f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105653:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010565a:	e8 5a fd ff ff       	call   801053b9 <argint>
8010565f:	85 c0                	test   %eax,%eax
80105661:	78 1e                	js     80105681 <sys_read+0x5a>
...
80105678:	e8 6a fd ff ff       	call   801053e7 <argptr>
8010567d:	85 c0                	test   %eax,%eax
8010567f:	79 07                	jns    80105688 <sys_read+0x61>
    return -1;
80105681:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105686:	eb 19                	jmp    801056a1 <sys_read+0x7a>
...
8010569c:	e8 52 ba ff ff       	call   801010f3 <fileread>
}
801056a1:	c9                   	leave  
801056a2:	c3                   	ret    
...
801056b0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801056b7:	00 
801056b8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056bf:	e8 4b fe ff ff       	call   8010550f <argfd>
801056c4:	85 c0                	test   %eax,%eax
801056c6:	78 35                	js     801056fd <sys_write+0x5a>
801056c8:	8d 45 f0             	lea    -0x10(%ebp),%eax
801056cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801056cf:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801056d6:	e8 de fc ff ff       	call   801053b9 <argint>
801056db:	85 c0                	test   %eax,%eax
801056dd:	78 1e                	js     801056fd <sys_write+0x5a>
801056df:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056e2:	89 44 24 08          	mov    %eax,0x8(%esp)
801056e6:	8d 45 ec             	lea    -0x14(%ebp),%eax
801056e9:	89 44 24 04          	mov    %eax,0x4(%esp)
801056ed:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801056f4:	e8 ee fc ff ff       	call   801053e7 <argptr>
801056f9:	85 c0                	test   %eax,%eax
801056fb:	79 07                	jns    80105704 <sys_write+0x61>
    return -1;
801056fd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105702:	eb 19                	jmp    8010571d <sys_write+0x7a>
  return filewrite(f, p, n);
80105704:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105707:	8b 55 ec             	mov    -0x14(%ebp),%edx
...
80105718:	e8 92 ba ff ff       	call   801011af <filewrite>
}
8010571d:	c9                   	leave  
8010571e:	c3                   	ret    
...
8010578c:	e8 7e fd ff ff       	call   8010550f <argfd>
80105791:	85 c0                	test   %eax,%eax
80105793:	78 1f                	js     801057b4 <sys_fstat+0x44>
80105795:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010579c:	00 
8010579d:	8d 45 f0             	lea    -0x10(%ebp),%eax
801057a0:	89 44 24 04          	mov    %eax,0x4(%esp)
801057a4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057ab:	e8 37 fc ff ff       	call   801053e7 <argptr>
801057b0:	85 c0                	test   %eax,%eax
801057b2:	79 07                	jns    801057bb <sys_fstat+0x4b>
    return -1;
801057b4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057b9:	eb 12                	jmp    801057cd <sys_fstat+0x5d>
...
801057c8:	e8 d7 b8 ff ff       	call   801010a4 <filestat>
}
801057cd:	c9                   	leave  
801057ce:	c3                   	ret    
...
801057d2:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801057d5:	8d 45 d8             	lea    -0x28(%ebp),%eax
801057d8:	89 44 24 04          	mov    %eax,0x4(%esp)
801057dc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801057e3:	e8 61 fc ff ff       	call   80105449 <argstr>
801057e8:	85 c0                	test   %eax,%eax
801057ea:	78 17                	js     80105803 <sys_link+0x34>
801057ec:	8d 45 dc             	lea    -0x24(%ebp),%eax
801057ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801057f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057fa:	e8 4a fc ff ff       	call   80105449 <argstr>
801057ff:	85 c0                	test   %eax,%eax
80105801:	79 0a                	jns    8010580d <sys_link+0x3e>
    return -1;
80105803:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105808:	e9 42 01 00 00       	jmp    8010594f <sys_link+0x180>

  begin_op();
8010580d:	e8 fe db ff ff       	call   80103410 <begin_op>
  if((ip = namei(old)) == 0){
80105812:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105815:	89 04 24             	mov    %eax,(%esp)
80105818:	e8 e9 cb ff ff       	call   80102406 <namei>
8010581d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105820:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105824:	75 0f                	jne    80105835 <sys_link+0x66>
    end_op();
80105826:	e8 69 dc ff ff       	call   80103494 <end_op>
    return -1;
8010582b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105830:	e9 1a 01 00 00       	jmp    8010594f <sys_link+0x180>
  }

  ilock(ip);
80105835:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105838:	89 04 24             	mov    %eax,(%esp)
8010583b:	e8 1b c0 ff ff       	call   8010185b <ilock>
  if(ip->type == T_DIR){
80105840:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105843:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105847:	66 83 f8 01          	cmp    $0x1,%ax
8010584b:	75 1a                	jne    80105867 <sys_link+0x98>
    iunlockput(ip);
8010584d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105850:	89 04 24             	mov    %eax,(%esp)
80105853:	e8 87 c2 ff ff       	call   80101adf <iunlockput>
    end_op();
80105858:	e8 37 dc ff ff       	call   80103494 <end_op>
    return -1;
8010585d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105862:	e9 e8 00 00 00       	jmp    8010594f <sys_link+0x180>
  }

  ip->nlink++;
80105867:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010586a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
8010587e:	e8 1c be ff ff       	call   8010169f <iupdate>
  iunlock(ip);
80105883:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105886:	89 04 24             	mov    %eax,(%esp)
80105889:	e8 1b c1 ff ff       	call   801019a9 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
8010588e:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105891:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105894:	89 54 24 04          	mov    %edx,0x4(%esp)
80105898:	89 04 24             	mov    %eax,(%esp)
8010589b:	e8 88 cb ff ff       	call   80102428 <nameiparent>
801058a0:	89 45 f0             	mov    %eax,-0x10(%ebp)
801058a3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801058a7:	75 02                	jne    801058ab <sys_link+0xdc>
    goto bad;
801058a9:	eb 68                	jmp    80105913 <sys_link+0x144>
  ilock(dp);
801058ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058ae:	89 04 24             	mov    %eax,(%esp)
801058b1:	e8 a5 bf ff ff       	call   8010185b <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801058b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058b9:	8b 10                	mov    (%eax),%edx
801058bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058be:	8b 00                	mov    (%eax),%eax
801058c0:	39 c2                	cmp    %eax,%edx
801058c2:	75 20                	jne    801058e4 <sys_link+0x115>
801058c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058c7:	8b 40 04             	mov    0x4(%eax),%eax
801058ca:	89 44 24 08          	mov    %eax,0x8(%esp)
801058ce:	8d 45 e2             	lea    -0x1e(%ebp),%eax
801058d1:	89 44 24 04          	mov    %eax,0x4(%esp)
801058d5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058d8:	89 04 24             	mov    %eax,(%esp)
801058db:	e8 66 c8 ff ff       	call   80102146 <dirlink>
801058e0:	85 c0                	test   %eax,%eax
801058e2:	79 0d                	jns    801058f1 <sys_link+0x122>
    iunlockput(dp);
801058e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058e7:	89 04 24             	mov    %eax,(%esp)
801058ea:	e8 f0 c1 ff ff       	call   80101adf <iunlockput>
    goto bad;
801058ef:	eb 22                	jmp    80105913 <sys_link+0x144>
  }
  iunlockput(dp);
801058f1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058f4:	89 04 24             	mov    %eax,(%esp)
801058f7:	e8 e3 c1 ff ff       	call   80101adf <iunlockput>
  iput(ip);
801058fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058ff:	89 04 24             	mov    %eax,(%esp)
80105902:	e8 07 c1 ff ff       	call   80101a0e <iput>

  end_op();
80105907:	e8 88 db ff ff       	call   80103494 <end_op>

  return 0;
8010590c:	b8 00 00 00 00       	mov    $0x0,%eax
80105911:	eb 3c                	jmp    8010594f <sys_link+0x180>

bad:
  ilock(ip);
80105913:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105916:	89 04 24             	mov    %eax,(%esp)
80105919:	e8 3d bf ff ff       	call   8010185b <ilock>
  ip->nlink--;
...
80105935:	e8 65 bd ff ff       	call   8010169f <iupdate>
  iunlockput(ip);
8010593a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010593d:	89 04 24             	mov    %eax,(%esp)
80105940:	e8 9a c1 ff ff       	call   80101adf <iunlockput>
  end_op();
80105945:	e8 4a db ff ff       	call   80103494 <end_op>
  return -1;
...
80105954:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105957:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
8010595e:	eb 4b                	jmp    801059ab <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105960:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105963:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010596a:	00 
8010596b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010596f:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105972:	89 44 24 04          	mov    %eax,0x4(%esp)
80105976:	8b 45 08             	mov    0x8(%ebp),%eax
80105979:	89 04 24             	mov    %eax,(%esp)
8010597c:	e8 e7 c3 ff ff       	call   80101d68 <readi>
80105981:	83 f8 10             	cmp    $0x10,%eax
80105984:	74 0c                	je     80105992 <isdirempty+0x41>
      panic("isdirempty: readi");
80105986:	c7 04 24 1b 8a 10 80 	movl   $0x80108a1b,(%esp)
8010598d:	e8 a8 ab ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105992:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105996:	66 85 c0             	test   %ax,%ax
80105999:	74 07                	je     801059a2 <isdirempty+0x51>
      return 0;
8010599b:	b8 00 00 00 00       	mov    $0x0,%eax
801059a0:	eb 1b                	jmp    801059bd <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801059a5:	83 c0 10             	add    $0x10,%eax
...
801059b4:	39 c2                	cmp    %eax,%edx
801059b6:	72 a8                	jb     80105960 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
801059b8:	b8 01 00 00 00       	mov    $0x1,%eax
}
801059bd:	c9                   	leave  
801059be:	c3                   	ret    
...
801059c2:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801059c5:	8d 45 cc             	lea    -0x34(%ebp),%eax
801059c8:	89 44 24 04          	mov    %eax,0x4(%esp)
801059cc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059d3:	e8 71 fa ff ff       	call   80105449 <argstr>
801059d8:	85 c0                	test   %eax,%eax
801059da:	79 0a                	jns    801059e6 <sys_unlink+0x27>
    return -1;
801059dc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059e1:	e9 af 01 00 00       	jmp    80105b95 <sys_unlink+0x1d6>

  begin_op();
801059e6:	e8 25 da ff ff       	call   80103410 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801059eb:	8b 45 cc             	mov    -0x34(%ebp),%eax
801059ee:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801059f1:	89 54 24 04          	mov    %edx,0x4(%esp)
801059f5:	89 04 24             	mov    %eax,(%esp)
801059f8:	e8 2b ca ff ff       	call   80102428 <nameiparent>
801059fd:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a00:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a04:	75 0f                	jne    80105a15 <sys_unlink+0x56>
    end_op();
80105a06:	e8 89 da ff ff       	call   80103494 <end_op>
    return -1;
80105a0b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a10:	e9 80 01 00 00       	jmp    80105b95 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105a15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a18:	89 04 24             	mov    %eax,(%esp)
80105a1b:	e8 3b be ff ff       	call   8010185b <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105a20:	c7 44 24 04 2d 8a 10 	movl   $0x80108a2d,0x4(%esp)
80105a27:	80 
80105a28:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a2b:	89 04 24             	mov    %eax,(%esp)
80105a2e:	e8 28 c6 ff ff       	call   8010205b <namecmp>
80105a33:	85 c0                	test   %eax,%eax
80105a35:	0f 84 45 01 00 00    	je     80105b80 <sys_unlink+0x1c1>
80105a3b:	c7 44 24 04 2f 8a 10 	movl   $0x80108a2f,0x4(%esp)
80105a42:	80 
80105a43:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a46:	89 04 24             	mov    %eax,(%esp)
80105a49:	e8 0d c6 ff ff       	call   8010205b <namecmp>
80105a4e:	85 c0                	test   %eax,%eax
80105a50:	0f 84 2a 01 00 00    	je     80105b80 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105a56:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105a59:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a5d:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a60:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a67:	89 04 24             	mov    %eax,(%esp)
80105a6a:	e8 0e c6 ff ff       	call   8010207d <dirlookup>
80105a6f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105a72:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105a76:	75 05                	jne    80105a7d <sys_unlink+0xbe>
    goto bad;
80105a78:	e9 03 01 00 00       	jmp    80105b80 <sys_unlink+0x1c1>
  ilock(ip);
80105a7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a80:	89 04 24             	mov    %eax,(%esp)
80105a83:	e8 d3 bd ff ff       	call   8010185b <ilock>

  if(ip->nlink < 1)
80105a88:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a8b:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105a8f:	66 85 c0             	test   %ax,%ax
80105a92:	7f 0c                	jg     80105aa0 <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105a94:	c7 04 24 32 8a 10 80 	movl   $0x80108a32,(%esp)
80105a9b:	e8 9a aa ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105aa0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105aa3:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105aa7:	66 83 f8 01          	cmp    $0x1,%ax
80105aab:	75 1f                	jne    80105acc <sys_unlink+0x10d>
80105aad:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ab0:	89 04 24             	mov    %eax,(%esp)
80105ab3:	e8 99 fe ff ff       	call   80105951 <isdirempty>
80105ab8:	85 c0                	test   %eax,%eax
80105aba:	75 10                	jne    80105acc <sys_unlink+0x10d>
    iunlockput(ip);
80105abc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105abf:	89 04 24             	mov    %eax,(%esp)
80105ac2:	e8 18 c0 ff ff       	call   80101adf <iunlockput>
    goto bad;
80105ac7:	e9 b4 00 00 00       	jmp    80105b80 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105acc:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105ad3:	00 
80105ad4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105adb:	00 
80105adc:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105adf:	89 04 24             	mov    %eax,(%esp)
80105ae2:	e8 90 f5 ff ff       	call   80105077 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105ae7:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105aea:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105af1:	00 
...
80105b03:	e8 c4 c3 ff ff       	call   80101ecc <writei>
80105b08:	83 f8 10             	cmp    $0x10,%eax
80105b0b:	74 0c                	je     80105b19 <sys_unlink+0x15a>
    panic("unlink: writei");
80105b0d:	c7 04 24 44 8a 10 80 	movl   $0x80108a44,(%esp)
80105b14:	e8 21 aa ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105b19:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b1c:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b20:	66 83 f8 01          	cmp    $0x1,%ax
80105b24:	75 1c                	jne    80105b42 <sys_unlink+0x183>
    dp->nlink--;
...
80105b3d:	e8 5d bb ff ff       	call   8010169f <iupdate>
  }
  iunlockput(dp);
80105b42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b45:	89 04 24             	mov    %eax,(%esp)
80105b48:	e8 92 bf ff ff       	call   80101adf <iunlockput>

  ip->nlink--;
80105b4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b50:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
80105b64:	e8 36 bb ff ff       	call   8010169f <iupdate>
  iunlockput(ip);
80105b69:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b6c:	89 04 24             	mov    %eax,(%esp)
80105b6f:	e8 6b bf ff ff       	call   80101adf <iunlockput>

  end_op();
80105b74:	e8 1b d9 ff ff       	call   80103494 <end_op>

  return 0;
80105b79:	b8 00 00 00 00       	mov    $0x0,%eax
80105b7e:	eb 15                	jmp    80105b95 <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105b80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b83:	89 04 24             	mov    %eax,(%esp)
80105b86:	e8 54 bf ff ff       	call   80101adf <iunlockput>
  end_op();
80105b8b:	e8 04 d9 ff ff       	call   80103494 <end_op>
  return -1;
...
80105b9a:	83 ec 48             	sub    $0x48,%esp
80105b9d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105ba0:	8b 55 10             	mov    0x10(%ebp),%edx
80105ba3:	8b 45 14             	mov    0x14(%ebp),%eax
80105ba6:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105baa:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105bae:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80105bbf:	e8 64 c8 ff ff       	call   80102428 <nameiparent>
80105bc4:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105bc7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105bcb:	75 0a                	jne    80105bd7 <create+0x40>
    return 0;
80105bcd:	b8 00 00 00 00       	mov    $0x0,%eax
80105bd2:	e9 7e 01 00 00       	jmp    80105d55 <create+0x1be>
  ilock(dp);
80105bd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bda:	89 04 24             	mov    %eax,(%esp)
80105bdd:	e8 79 bc ff ff       	call   8010185b <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105be2:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105be5:	89 44 24 08          	mov    %eax,0x8(%esp)
80105be9:	8d 45 de             	lea    -0x22(%ebp),%eax
80105bec:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bf0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bf3:	89 04 24             	mov    %eax,(%esp)
80105bf6:	e8 82 c4 ff ff       	call   8010207d <dirlookup>
80105bfb:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105bfe:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c02:	74 47                	je     80105c4b <create+0xb4>
    iunlockput(dp);
80105c04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c07:	89 04 24             	mov    %eax,(%esp)
80105c0a:	e8 d0 be ff ff       	call   80101adf <iunlockput>
    ilock(ip);
80105c0f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c12:	89 04 24             	mov    %eax,(%esp)
80105c15:	e8 41 bc ff ff       	call   8010185b <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105c1a:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105c1f:	75 15                	jne    80105c36 <create+0x9f>
80105c21:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c24:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105c28:	66 83 f8 02          	cmp    $0x2,%ax
80105c2c:	75 08                	jne    80105c36 <create+0x9f>
      return ip;
80105c2e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c31:	e9 1f 01 00 00       	jmp    80105d55 <create+0x1be>
    iunlockput(ip);
80105c36:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c39:	89 04 24             	mov    %eax,(%esp)
80105c3c:	e8 9e be ff ff       	call   80101adf <iunlockput>
    return 0;
80105c41:	b8 00 00 00 00       	mov    $0x0,%eax
80105c46:	e9 0a 01 00 00       	jmp    80105d55 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105c4b:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
80105c5b:	e8 60 b9 ff ff       	call   801015c0 <ialloc>
80105c60:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c63:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c67:	75 0c                	jne    80105c75 <create+0xde>
    panic("create: ialloc");
80105c69:	c7 04 24 53 8a 10 80 	movl   $0x80108a53,(%esp)
80105c70:	e8 c5 a8 ff ff       	call   8010053a <panic>
...
80105c83:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105c87:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105c8b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c8e:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105c92:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105c96:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c99:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105c9f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ca2:	89 04 24             	mov    %eax,(%esp)
80105ca5:	e8 f5 b9 ff ff       	call   8010169f <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105caa:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105caf:	75 6a                	jne    80105d1b <create+0x184>
    dp->nlink++;  // for ".."
80105cb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cb4:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105cb8:	8d 50 01             	lea    0x1(%eax),%edx
...
80105cc8:	e8 d2 b9 ff ff       	call   8010169f <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105ccd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cd0:	8b 40 04             	mov    0x4(%eax),%eax
80105cd3:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cd7:	c7 44 24 04 2d 8a 10 	movl   $0x80108a2d,0x4(%esp)
80105cde:	80 
80105cdf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ce2:	89 04 24             	mov    %eax,(%esp)
80105ce5:	e8 5c c4 ff ff       	call   80102146 <dirlink>
80105cea:	85 c0                	test   %eax,%eax
80105cec:	78 21                	js     80105d0f <create+0x178>
80105cee:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cf1:	8b 40 04             	mov    0x4(%eax),%eax
80105cf4:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cf8:	c7 44 24 04 2f 8a 10 	movl   $0x80108a2f,0x4(%esp)
80105cff:	80 
80105d00:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d03:	89 04 24             	mov    %eax,(%esp)
80105d06:	e8 3b c4 ff ff       	call   80102146 <dirlink>
80105d0b:	85 c0                	test   %eax,%eax
80105d0d:	79 0c                	jns    80105d1b <create+0x184>
      panic("create dots");
80105d0f:	c7 04 24 62 8a 10 80 	movl   $0x80108a62,(%esp)
80105d16:	e8 1f a8 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105d1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d1e:	8b 40 04             	mov    0x4(%eax),%eax
80105d21:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d25:	8d 45 de             	lea    -0x22(%ebp),%eax
80105d28:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d2f:	89 04 24             	mov    %eax,(%esp)
80105d32:	e8 0f c4 ff ff       	call   80102146 <dirlink>
80105d37:	85 c0                	test   %eax,%eax
80105d39:	79 0c                	jns    80105d47 <create+0x1b0>
    panic("create: dirlink");
80105d3b:	c7 04 24 6e 8a 10 80 	movl   $0x80108a6e,(%esp)
80105d42:	e8 f3 a7 ff ff       	call   8010053a <panic>

  iunlockput(dp);
80105d47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d4a:	89 04 24             	mov    %eax,(%esp)
80105d4d:	e8 8d bd ff ff       	call   80101adf <iunlockput>
...
80105d5d:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105d60:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d64:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d6b:	e8 d9 f6 ff ff       	call   80105449 <argstr>
80105d70:	85 c0                	test   %eax,%eax
80105d72:	78 17                	js     80105d8b <sys_open+0x34>
80105d74:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105d77:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d7b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d82:	e8 32 f6 ff ff       	call   801053b9 <argint>
80105d87:	85 c0                	test   %eax,%eax
80105d89:	79 0a                	jns    80105d95 <sys_open+0x3e>
    return -1;
80105d8b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d90:	e9 5c 01 00 00       	jmp    80105ef1 <sys_open+0x19a>

  begin_op();
80105d95:	e8 76 d6 ff ff       	call   80103410 <begin_op>

  if(omode & O_CREATE){
80105d9a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d9d:	25 00 02 00 00       	and    $0x200,%eax
80105da2:	85 c0                	test   %eax,%eax
80105da4:	74 3b                	je     80105de1 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80105da6:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105da9:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105db0:	00 
80105db1:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105db8:	00 
80105db9:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105dc0:	00 
80105dc1:	89 04 24             	mov    %eax,(%esp)
80105dc4:	e8 ce fd ff ff       	call   80105b97 <create>
80105dc9:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80105dcc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105dd0:	75 6b                	jne    80105e3d <sys_open+0xe6>
      end_op();
80105dd2:	e8 bd d6 ff ff       	call   80103494 <end_op>
      return -1;
80105dd7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ddc:	e9 10 01 00 00       	jmp    80105ef1 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80105de1:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105de4:	89 04 24             	mov    %eax,(%esp)
80105de7:	e8 1a c6 ff ff       	call   80102406 <namei>
80105dec:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105def:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105df3:	75 0f                	jne    80105e04 <sys_open+0xad>
      end_op();
80105df5:	e8 9a d6 ff ff       	call   80103494 <end_op>
      return -1;
80105dfa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dff:	e9 ed 00 00 00       	jmp    80105ef1 <sys_open+0x19a>
    }
    ilock(ip);
80105e04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e07:	89 04 24             	mov    %eax,(%esp)
80105e0a:	e8 4c ba ff ff       	call   8010185b <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105e0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e12:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e16:	66 83 f8 01          	cmp    $0x1,%ax
80105e1a:	75 21                	jne    80105e3d <sys_open+0xe6>
80105e1c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e1f:	85 c0                	test   %eax,%eax
80105e21:	74 1a                	je     80105e3d <sys_open+0xe6>
      iunlockput(ip);
80105e23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e26:	89 04 24             	mov    %eax,(%esp)
80105e29:	e8 b1 bc ff ff       	call   80101adf <iunlockput>
      end_op();
80105e2e:	e8 61 d6 ff ff       	call   80103494 <end_op>
      return -1;
80105e33:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e38:	e9 b4 00 00 00       	jmp    80105ef1 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105e3d:	e8 e4 b0 ff ff       	call   80100f26 <filealloc>
80105e42:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e45:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e49:	74 14                	je     80105e5f <sys_open+0x108>
80105e4b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e4e:	89 04 24             	mov    %eax,(%esp)
80105e51:	e8 2e f7 ff ff       	call   80105584 <fdalloc>
80105e56:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105e59:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105e5d:	79 28                	jns    80105e87 <sys_open+0x130>
    if(f)
80105e5f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e63:	74 0b                	je     80105e70 <sys_open+0x119>
      fileclose(f);
80105e65:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e68:	89 04 24             	mov    %eax,(%esp)
80105e6b:	e8 5e b1 ff ff       	call   80100fce <fileclose>
    iunlockput(ip);
80105e70:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e73:	89 04 24             	mov    %eax,(%esp)
80105e76:	e8 64 bc ff ff       	call   80101adf <iunlockput>
    end_op();
80105e7b:	e8 14 d6 ff ff       	call   80103494 <end_op>
    return -1;
80105e80:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e85:	eb 6a                	jmp    80105ef1 <sys_open+0x19a>
  }
  iunlock(ip);
80105e87:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e8a:	89 04 24             	mov    %eax,(%esp)
80105e8d:	e8 17 bb ff ff       	call   801019a9 <iunlock>
  end_op();
80105e92:	e8 fd d5 ff ff       	call   80103494 <end_op>

  f->type = FD_INODE;
80105e97:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e9a:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105ea0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ea3:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105ea6:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105ea9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eac:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105eb3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105eb6:	83 e0 01             	and    $0x1,%eax
80105eb9:	85 c0                	test   %eax,%eax
80105ebb:	0f 94 c0             	sete   %al
80105ebe:	89 c2                	mov    %eax,%edx
80105ec0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ec3:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105ec6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ec9:	83 e0 01             	and    $0x1,%eax
80105ecc:	85 c0                	test   %eax,%eax
80105ece:	75 0a                	jne    80105eda <sys_open+0x183>
80105ed0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ed3:	83 e0 02             	and    $0x2,%eax
80105ed6:	85 c0                	test   %eax,%eax
80105ed8:	74 07                	je     80105ee1 <sys_open+0x18a>
80105eda:	b8 01 00 00 00       	mov    $0x1,%eax
80105edf:	eb 05                	jmp    80105ee6 <sys_open+0x18f>
80105ee1:	b8 00 00 00 00       	mov    $0x0,%eax
80105ee6:	89 c2                	mov    %eax,%edx
80105ee8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eeb:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80105eee:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80105ef1:	c9                   	leave  
80105ef2:	c3                   	ret    
...
80105ef6:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_op();
80105ef9:	e8 12 d5 ff ff       	call   80103410 <begin_op>
...
80105f0c:	e8 38 f5 ff ff       	call   80105449 <argstr>
80105f11:	85 c0                	test   %eax,%eax
80105f13:	78 2c                	js     80105f41 <sys_mkdir+0x4e>
...
80105f27:	00 
80105f28:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105f2f:	00 
80105f30:	89 04 24             	mov    %eax,(%esp)
80105f33:	e8 5f fc ff ff       	call   80105b97 <create>
80105f38:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f3b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f3f:	75 0c                	jne    80105f4d <sys_mkdir+0x5a>
    end_op();
80105f41:	e8 4e d5 ff ff       	call   80103494 <end_op>
    return -1;
80105f46:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f4b:	eb 15                	jmp    80105f62 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80105f4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f50:	89 04 24             	mov    %eax,(%esp)
80105f53:	e8 87 bb ff ff       	call   80101adf <iunlockput>
  end_op();
80105f58:	e8 37 d5 ff ff       	call   80103494 <end_op>
  return 0;
...
80105fa0:	78 47                	js     80105fe9 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105fa2:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105fa5:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fa9:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105fb0:	e8 04 f4 ff ff       	call   801053b9 <argint>
  int len;
  int major, minor;
...
80105fb7:	78 30                	js     80105fe9 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80105fb9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fbc:	0f bf c8             	movswl %ax,%ecx
80105fbf:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105fc2:	0f bf d0             	movswl %ax,%edx
80105fc5:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105fc8:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80105fcc:	89 54 24 08          	mov    %edx,0x8(%esp)
80105fd0:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80105fd7:	00 
80105fd8:	89 04 24             	mov    %eax,(%esp)
80105fdb:	e8 b7 fb ff ff       	call   80105b97 <create>
80105fe0:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105fe3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105fe7:	75 0c                	jne    80105ff5 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80105fe9:	e8 a6 d4 ff ff       	call   80103494 <end_op>
    return -1;
80105fee:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ff3:	eb 15                	jmp    8010600a <sys_mknod+0xa6>
  }
  iunlockput(ip);
80105ff5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ff8:	89 04 24             	mov    %eax,(%esp)
80105ffb:	e8 df ba ff ff       	call   80101adf <iunlockput>
  end_op();
80106000:	e8 8f d4 ff ff       	call   80103494 <end_op>
  return 0;
...
8010600f:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106012:	e8 f9 d3 ff ff       	call   80103410 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106017:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010601a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010601e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106025:	e8 1f f4 ff ff       	call   80105449 <argstr>
8010602a:	85 c0                	test   %eax,%eax
8010602c:	78 14                	js     80106042 <sys_chdir+0x36>
8010602e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106031:	89 04 24             	mov    %eax,(%esp)
80106034:	e8 cd c3 ff ff       	call   80102406 <namei>
80106039:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010603c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106040:	75 0c                	jne    8010604e <sys_chdir+0x42>
    end_op();
80106042:	e8 4d d4 ff ff       	call   80103494 <end_op>
    return -1;
80106047:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010604c:	eb 61                	jmp    801060af <sys_chdir+0xa3>
  }
  ilock(ip);
8010604e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106051:	89 04 24             	mov    %eax,(%esp)
80106054:	e8 02 b8 ff ff       	call   8010185b <ilock>
  if(ip->type != T_DIR){
80106059:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010605c:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106060:	66 83 f8 01          	cmp    $0x1,%ax
80106064:	74 17                	je     8010607d <sys_chdir+0x71>
    iunlockput(ip);
80106066:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106069:	89 04 24             	mov    %eax,(%esp)
8010606c:	e8 6e ba ff ff       	call   80101adf <iunlockput>
    end_op();
80106071:	e8 1e d4 ff ff       	call   80103494 <end_op>
    return -1;
80106076:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010607b:	eb 32                	jmp    801060af <sys_chdir+0xa3>
  }
  iunlock(ip);
8010607d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106080:	89 04 24             	mov    %eax,(%esp)
80106083:	e8 21 b9 ff ff       	call   801019a9 <iunlock>
  iput(proc->cwd);
80106088:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010608e:	8b 40 68             	mov    0x68(%eax),%eax
80106091:	89 04 24             	mov    %eax,(%esp)
80106094:	e8 75 b9 ff ff       	call   80101a0e <iput>
  end_op();
80106099:	e8 f6 d3 ff ff       	call   80103494 <end_op>
  proc->cwd = ip;
8010609e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801060a4:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
801060b4:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
801060c8:	e8 7c f3 ff ff       	call   80105449 <argstr>
801060cd:	85 c0                	test   %eax,%eax
801060cf:	78 1a                	js     801060eb <sys_exec+0x3a>
801060d1:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801060d7:	89 44 24 04          	mov    %eax,0x4(%esp)
801060db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801060e2:	e8 d2 f2 ff ff       	call   801053b9 <argint>
801060e7:	85 c0                	test   %eax,%eax
801060e9:	79 0a                	jns    801060f5 <sys_exec+0x44>
    return -1;
801060eb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060f0:	e9 c8 00 00 00       	jmp    801061bd <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
801060f5:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801060fc:	00 
801060fd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106104:	00 
80106105:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010610b:	89 04 24             	mov    %eax,(%esp)
8010610e:	e8 64 ef ff ff       	call   80105077 <memset>
  for(i=0;; i++){
80106113:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
8010611a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010611d:	83 f8 1f             	cmp    $0x1f,%eax
80106120:	76 0a                	jbe    8010612c <sys_exec+0x7b>
      return -1;
80106122:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106127:	e9 91 00 00 00       	jmp    801061bd <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
8010612c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010612f:	c1 e0 02             	shl    $0x2,%eax
80106132:	89 c2                	mov    %eax,%edx
80106134:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
8010613a:	01 c2                	add    %eax,%edx
8010613c:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106142:	89 44 24 04          	mov    %eax,0x4(%esp)
80106146:	89 14 24             	mov    %edx,(%esp)
80106149:	e8 cf f1 ff ff       	call   8010531d <fetchint>
8010614e:	85 c0                	test   %eax,%eax
80106150:	79 07                	jns    80106159 <sys_exec+0xa8>
      return -1;
80106152:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106157:	eb 64                	jmp    801061bd <sys_exec+0x10c>
    if(uarg == 0){
80106159:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010615f:	85 c0                	test   %eax,%eax
80106161:	75 26                	jne    80106189 <sys_exec+0xd8>
      argv[i] = 0;
80106163:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106166:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
8010616d:	00 00 00 00 
      break;
80106171:	90                   	nop
    }
...
80106175:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
8010617b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010617f:	89 04 24             	mov    %eax,(%esp)
80106182:	e8 68 a9 ff ff       	call   80100aef <exec>
80106187:	eb 34                	jmp    801061bd <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
80106189:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010618f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106192:	c1 e2 02             	shl    $0x2,%edx
80106195:	01 c2                	add    %eax,%edx
80106197:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010619d:	89 54 24 04          	mov    %edx,0x4(%esp)
801061a1:	89 04 24             	mov    %eax,(%esp)
801061a4:	e8 ae f1 ff ff       	call   80105357 <fetchstr>
801061a9:	85 c0                	test   %eax,%eax
801061ab:	79 07                	jns    801061b4 <sys_exec+0x103>
      return -1;
801061ad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061b2:	eb 09                	jmp    801061bd <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801061b4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
801061b8:	e9 5d ff ff ff       	jmp    8010611a <sys_exec+0x69>
  return exec(path, argv);
}
801061bd:	c9                   	leave  
801061be:	c3                   	ret    
...
801061c2:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801061c5:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801061cc:	00 
801061cd:	8d 45 ec             	lea    -0x14(%ebp),%eax
801061d0:	89 44 24 04          	mov    %eax,0x4(%esp)
801061d4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061db:	e8 07 f2 ff ff       	call   801053e7 <argptr>
801061e0:	85 c0                	test   %eax,%eax
801061e2:	79 0a                	jns    801061ee <sys_pipe+0x2f>
    return -1;
801061e4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061e9:	e9 9b 00 00 00       	jmp    80106289 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801061ee:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801061f1:	89 44 24 04          	mov    %eax,0x4(%esp)
801061f5:	8d 45 e8             	lea    -0x18(%ebp),%eax
801061f8:	89 04 24             	mov    %eax,(%esp)
801061fb:	e8 51 dd ff ff       	call   80103f51 <pipealloc>
80106200:	85 c0                	test   %eax,%eax
80106202:	79 07                	jns    8010620b <sys_pipe+0x4c>
    return -1;
80106204:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106209:	eb 7e                	jmp    80106289 <sys_pipe+0xca>
  fd0 = -1;
8010620b:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106212:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106215:	89 04 24             	mov    %eax,(%esp)
80106218:	e8 67 f3 ff ff       	call   80105584 <fdalloc>
8010621d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106220:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106224:	78 14                	js     8010623a <sys_pipe+0x7b>
80106226:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106229:	89 04 24             	mov    %eax,(%esp)
8010622c:	e8 53 f3 ff ff       	call   80105584 <fdalloc>
80106231:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106234:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106238:	79 37                	jns    80106271 <sys_pipe+0xb2>
    if(fd0 >= 0)
8010623a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010623e:	78 14                	js     80106254 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106240:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106246:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106249:	83 c2 08             	add    $0x8,%edx
8010624c:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106253:	00 
    fileclose(rf);
80106254:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106257:	89 04 24             	mov    %eax,(%esp)
8010625a:	e8 6f ad ff ff       	call   80100fce <fileclose>
    fileclose(wf);
8010625f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106262:	89 04 24             	mov    %eax,(%esp)
80106265:	e8 64 ad ff ff       	call   80100fce <fileclose>
    return -1;
8010626a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010626f:	eb 18                	jmp    80106289 <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106271:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106274:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106277:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106279:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010627c:	8d 50 04             	lea    0x4(%eax),%edx
8010627f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106282:	89 02                	mov    %eax,(%edx)
  return 0;
...
8010628e:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106291:	e8 66 e3 ff ff       	call   801045fc <fork>
}
80106296:	c9                   	leave  
80106297:	c3                   	ret    
...
8010629b:	83 ec 08             	sub    $0x8,%esp
  exit();
8010629e:	e8 d4 e4 ff ff       	call   80104777 <exit>
...
801062ad:	83 ec 08             	sub    $0x8,%esp
  return wait();
801062b0:	e8 e4 e5 ff ff       	call   80104899 <wait>
}
801062b5:	c9                   	leave  
801062b6:	c3                   	ret    
...
801062f1:	8b 40 10             	mov    0x10(%eax),%eax
}
801062f4:	5d                   	pop    %ebp
801062f5:	c3                   	ret    
...
801062f9:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
801062fc:	8d 45 f0             	lea    -0x10(%ebp),%eax
801062ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80106303:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010630a:	e8 aa f0 ff ff       	call   801053b9 <argint>
8010630f:	85 c0                	test   %eax,%eax
80106311:	79 07                	jns    8010631a <sys_sbrk+0x24>
    return -1;
80106313:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106318:	eb 24                	jmp    8010633e <sys_sbrk+0x48>
  addr = proc->sz;
...
8010632b:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80106332:	8b 0a                	mov    (%edx),%ecx
80106334:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106337:	01 ca                	add    %ecx,%edx
80106339:	89 10                	mov    %edx,(%eax)
  //if(growproc(n) < 0)
    //return -1;
...
80106354:	e8 60 f0 ff ff       	call   801053b9 <argint>
80106359:	85 c0                	test   %eax,%eax
8010635b:	79 07                	jns    80106364 <sys_sleep+0x24>
    return -1;
8010635d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106362:	eb 6c                	jmp    801063d0 <sys_sleep+0x90>
  acquire(&tickslock);
80106364:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
8010636b:	e8 b3 ea ff ff       	call   80104e23 <acquire>
  ticks0 = ticks;
80106370:	a1 00 51 11 80       	mov    0x80115100,%eax
80106375:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106378:	eb 34                	jmp    801063ae <sys_sleep+0x6e>
    if(proc->killed){
8010637a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106380:	8b 40 24             	mov    0x24(%eax),%eax
80106383:	85 c0                	test   %eax,%eax
80106385:	74 13                	je     8010639a <sys_sleep+0x5a>
      release(&tickslock);
80106387:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
8010638e:	e8 f2 ea ff ff       	call   80104e85 <release>
      return -1;
80106393:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106398:	eb 36                	jmp    801063d0 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
8010639a:	c7 44 24 04 c0 48 11 	movl   $0x801148c0,0x4(%esp)
801063a1:	80 
801063a2:	c7 04 24 00 51 11 80 	movl   $0x80115100,(%esp)
801063a9:	e8 ab e7 ff ff       	call   80104b59 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801063ae:	a1 00 51 11 80       	mov    0x80115100,%eax
801063b3:	2b 45 f4             	sub    -0xc(%ebp),%eax
801063b6:	89 c2                	mov    %eax,%edx
801063b8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063bb:	39 c2                	cmp    %eax,%edx
801063bd:	72 bb                	jb     8010637a <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
801063bf:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801063c6:	e8 ba ea ff ff       	call   80104e85 <release>
  return 0;
...
801063d5:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801063d8:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801063df:	e8 3f ea ff ff       	call   80104e23 <acquire>
  xticks = ticks;
801063e4:	a1 00 51 11 80       	mov    0x80115100,%eax
801063e9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801063ec:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801063f3:	e8 8d ea ff ff       	call   80104e85 <release>
  return xticks;
...
80106403:	8b 55 08             	mov    0x8(%ebp),%edx
80106406:	8b 45 0c             	mov    0xc(%ebp),%eax
80106409:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010640d:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106410:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106414:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106418:	ee                   	out    %al,(%dx)
}
80106419:	c9                   	leave  
8010641a:	c3                   	ret    
...
80106421:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106428:	00 
80106429:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106430:	e8 c8 ff ff ff       	call   801063fd <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106435:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
8010643c:	00 
8010643d:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106444:	e8 b4 ff ff ff       	call   801063fd <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106449:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106450:	00 
80106451:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106458:	e8 a0 ff ff ff       	call   801063fd <outb>
  picenable(IRQ_TIMER);
8010645d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106464:	e8 7b d9 ff ff       	call   80103de4 <picenable>
}
80106469:	c9                   	leave  
8010646a:	c3                   	ret    
...
8010646c:	06                   	push   %es
  pushl %fs
8010646d:	0f a0                	push   %fs
  pushl %gs
8010646f:	0f a8                	push   %gs
  pushal
80106471:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106472:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106476:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106478:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
8010647a:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
8010647e:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106480:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106482:	54                   	push   %esp
  call trap
80106483:	e8 82 02 00 00       	call   8010670a <trap>
  addl $4, %esp
80106488:	83 c4 04             	add    $0x4,%esp
...
8010648b:	61                   	popa   
  popl %gs
8010648c:	0f a9                	pop    %gs
  popl %fs
8010648e:	0f a1                	pop    %fs
  popl %es
80106490:	07                   	pop    %es
  popl %ds
80106491:	1f                   	pop    %ds
...
801064dc:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
801064df:	0f 20 d0             	mov    %cr2,%eax
801064e2:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
801064e5:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
801064e8:	c9                   	leave  
801064e9:	c3                   	ret    
...
801064ed:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
801064f0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801064f7:	e9 c3 00 00 00       	jmp    801065bf <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
801064fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064ff:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
80106506:	89 c2                	mov    %eax,%edx
80106508:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010650b:	66 89 14 c5 00 49 11 	mov    %dx,-0x7feeb700(,%eax,8)
80106512:	80 
80106513:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106516:	66 c7 04 c5 02 49 11 	movw   $0x8,-0x7feeb6fe(,%eax,8)
8010651d:	80 08 00 
80106520:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106523:	0f b6 14 c5 04 49 11 	movzbl -0x7feeb6fc(,%eax,8),%edx
8010652a:	80 
8010652b:	83 e2 e0             	and    $0xffffffe0,%edx
8010652e:	88 14 c5 04 49 11 80 	mov    %dl,-0x7feeb6fc(,%eax,8)
80106535:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106538:	0f b6 14 c5 04 49 11 	movzbl -0x7feeb6fc(,%eax,8),%edx
8010653f:	80 
80106540:	83 e2 1f             	and    $0x1f,%edx
80106543:	88 14 c5 04 49 11 80 	mov    %dl,-0x7feeb6fc(,%eax,8)
8010654a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010654d:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
80106554:	80 
80106555:	83 e2 f0             	and    $0xfffffff0,%edx
80106558:	83 ca 0e             	or     $0xe,%edx
8010655b:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
80106562:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106565:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
8010656c:	80 
8010656d:	83 e2 ef             	and    $0xffffffef,%edx
80106570:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
80106577:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010657a:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
80106581:	80 
80106582:	83 e2 9f             	and    $0xffffff9f,%edx
80106585:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
8010658c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010658f:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
80106596:	80 
80106597:	83 ca 80             	or     $0xffffff80,%edx
8010659a:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
801065a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065a4:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
801065ab:	c1 e8 10             	shr    $0x10,%eax
801065ae:	89 c2                	mov    %eax,%edx
801065b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065b3:	66 89 14 c5 06 49 11 	mov    %dx,-0x7feeb6fa(,%eax,8)
801065ba:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
801065bb:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801065bf:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
801065c6:	0f 8e 30 ff ff ff    	jle    801064fc <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801065cc:	a1 98 b1 10 80       	mov    0x8010b198,%eax
801065d1:	66 a3 00 4b 11 80    	mov    %ax,0x80114b00
801065d7:	66 c7 05 02 4b 11 80 	movw   $0x8,0x80114b02
801065de:	08 00 
801065e0:	0f b6 05 04 4b 11 80 	movzbl 0x80114b04,%eax
801065e7:	83 e0 e0             	and    $0xffffffe0,%eax
801065ea:	a2 04 4b 11 80       	mov    %al,0x80114b04
801065ef:	0f b6 05 04 4b 11 80 	movzbl 0x80114b04,%eax
801065f6:	83 e0 1f             	and    $0x1f,%eax
801065f9:	a2 04 4b 11 80       	mov    %al,0x80114b04
801065fe:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
80106605:	83 c8 0f             	or     $0xf,%eax
80106608:	a2 05 4b 11 80       	mov    %al,0x80114b05
8010660d:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
80106614:	83 e0 ef             	and    $0xffffffef,%eax
80106617:	a2 05 4b 11 80       	mov    %al,0x80114b05
8010661c:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
80106623:	83 c8 60             	or     $0x60,%eax
80106626:	a2 05 4b 11 80       	mov    %al,0x80114b05
8010662b:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
80106632:	83 c8 80             	or     $0xffffff80,%eax
80106635:	a2 05 4b 11 80       	mov    %al,0x80114b05
8010663a:	a1 98 b1 10 80       	mov    0x8010b198,%eax
8010663f:	c1 e8 10             	shr    $0x10,%eax
80106642:	66 a3 06 4b 11 80    	mov    %ax,0x80114b06
  
  initlock(&tickslock, "time");
80106648:	c7 44 24 04 80 8a 10 	movl   $0x80108a80,0x4(%esp)
8010664f:	80 
80106650:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
80106657:	e8 a6 e7 ff ff       	call   80104e02 <initlock>
}
8010665c:	c9                   	leave  
8010665d:	c3                   	ret    
...
80106661:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106664:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
8010666b:	00 
8010666c:	c7 04 24 00 49 11 80 	movl   $0x80114900,(%esp)
80106673:	e8 38 fe ff ff       	call   801064b0 <lidt>
}
80106678:	c9                   	leave  
80106679:	c3                   	ret    
...
8010667d:	83 ec 28             	sub    $0x28,%esp
   kfree(p2v(cpu->kpgdir[TLBIndex]));
80106680:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106686:	8b 40 04             	mov    0x4(%eax),%eax
80106689:	8b 15 4c b6 10 80    	mov    0x8010b64c,%edx
8010668f:	c1 e2 02             	shl    $0x2,%edx
80106692:	01 d0                	add    %edx,%eax
80106694:	8b 00                	mov    (%eax),%eax
80106696:	89 04 24             	mov    %eax,(%esp)
80106699:	e8 05 fe ff ff       	call   801064a3 <p2v>
8010669e:	89 04 24             	mov    %eax,(%esp)
801066a1:	e8 a3 c3 ff ff       	call   80102a49 <kfree>
   cpu->kpgdir[TLBIndex] = 0;   
801066a6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801066ac:	8b 40 04             	mov    0x4(%eax),%eax
801066af:	8b 15 4c b6 10 80    	mov    0x8010b64c,%edx
801066b5:	c1 e2 02             	shl    $0x2,%edx
801066b8:	01 d0                	add    %edx,%eax
801066ba:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
   pte_t * k_pte = (pte_t *)getOrCreatePTE(cpu->kpgdir, (void*)v_address, 1);
801066c0:	8b 55 08             	mov    0x8(%ebp),%edx
801066c3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801066c9:	8b 40 04             	mov    0x4(%eax),%eax
801066cc:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
801066d3:	00 
801066d4:	89 54 24 04          	mov    %edx,0x4(%esp)
801066d8:	89 04 24             	mov    %eax,(%esp)
801066db:	e8 25 16 00 00       	call   80107d05 <getOrCreatePTE>
801066e0:	89 45 f4             	mov    %eax,-0xc(%ebp)
   TLBIndex++;
801066e3:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
801066e8:	83 c0 01             	add    $0x1,%eax
801066eb:	a3 4c b6 10 80       	mov    %eax,0x8010b64c
   TLBIndex = TLBIndex % TLB_SIZE;
801066f0:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
801066f5:	99                   	cltd   
801066f6:	c1 ea 1f             	shr    $0x1f,%edx
801066f9:	01 d0                	add    %edx,%eax
801066fb:	83 e0 01             	and    $0x1,%eax
801066fe:	29 d0                	sub    %edx,%eax
80106700:	a3 4c b6 10 80       	mov    %eax,0x8010b64c
   return k_pte;
...
80106710:	83 ec 4c             	sub    $0x4c,%esp
  if(tf->trapno == T_SYSCALL){
80106713:	8b 45 08             	mov    0x8(%ebp),%eax
80106716:	8b 40 30             	mov    0x30(%eax),%eax
80106719:	83 f8 40             	cmp    $0x40,%eax
8010671c:	75 3f                	jne    8010675d <trap+0x53>
    if(proc->killed)
8010671e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106724:	8b 40 24             	mov    0x24(%eax),%eax
80106727:	85 c0                	test   %eax,%eax
80106729:	74 05                	je     80106730 <trap+0x26>
      exit();
8010672b:	e8 47 e0 ff ff       	call   80104777 <exit>
    proc->tf = tf;
80106730:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106736:	8b 55 08             	mov    0x8(%ebp),%edx
80106739:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010673c:	e8 3f ed ff ff       	call   80105480 <syscall>
    if(proc->killed)
80106741:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106747:	8b 40 24             	mov    0x24(%eax),%eax
8010674a:	85 c0                	test   %eax,%eax
8010674c:	74 0a                	je     80106758 <trap+0x4e>
      exit();
8010674e:	e8 24 e0 ff ff       	call   80104777 <exit>
    return;
80106753:	e9 60 03 00 00       	jmp    80106ab8 <trap+0x3ae>
80106758:	e9 5b 03 00 00       	jmp    80106ab8 <trap+0x3ae>
  }

  switch(tf->trapno){
8010675d:	8b 45 08             	mov    0x8(%ebp),%eax
80106760:	8b 40 30             	mov    0x30(%eax),%eax
80106763:	83 e8 0e             	sub    $0xe,%eax
80106766:	83 f8 31             	cmp    $0x31,%eax
80106769:	0f 87 ef 01 00 00    	ja     8010695e <trap+0x254>
8010676f:	8b 04 85 40 8b 10 80 	mov    -0x7fef74c0(,%eax,4),%eax
80106776:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106778:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010677e:	0f b6 00             	movzbl (%eax),%eax
80106781:	84 c0                	test   %al,%al
80106783:	75 31                	jne    801067b6 <trap+0xac>
      acquire(&tickslock);
80106785:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
8010678c:	e8 92 e6 ff ff       	call   80104e23 <acquire>
      ticks++;
80106791:	a1 00 51 11 80       	mov    0x80115100,%eax
80106796:	83 c0 01             	add    $0x1,%eax
80106799:	a3 00 51 11 80       	mov    %eax,0x80115100
      wakeup(&ticks);
8010679e:	c7 04 24 00 51 11 80 	movl   $0x80115100,(%esp)
801067a5:	e8 88 e4 ff ff       	call   80104c32 <wakeup>
      release(&tickslock);
801067aa:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801067b1:	e8 cf e6 ff ff       	call   80104e85 <release>
    }
    lapiceoi();
801067b6:	e8 15 c7 ff ff       	call   80102ed0 <lapiceoi>
    break;
801067bb:	e9 74 02 00 00       	jmp    80106a34 <trap+0x32a>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801067c0:	e8 19 bf ff ff       	call   801026de <ideintr>
    lapiceoi();
801067c5:	e8 06 c7 ff ff       	call   80102ed0 <lapiceoi>
    break;
801067ca:	e9 65 02 00 00       	jmp    80106a34 <trap+0x32a>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801067cf:	e8 cb c4 ff ff       	call   80102c9f <kbdintr>
    lapiceoi();
801067d4:	e8 f7 c6 ff ff       	call   80102ed0 <lapiceoi>
    break;
801067d9:	e9 56 02 00 00       	jmp    80106a34 <trap+0x32a>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801067de:	e8 ca 04 00 00       	call   80106cad <uartintr>
    lapiceoi();
801067e3:	e8 e8 c6 ff ff       	call   80102ed0 <lapiceoi>
    break;
801067e8:	e9 47 02 00 00       	jmp    80106a34 <trap+0x32a>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801067ed:	8b 45 08             	mov    0x8(%ebp),%eax
801067f0:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801067f3:	8b 45 08             	mov    0x8(%ebp),%eax
801067f6:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801067fa:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
80106838:	e8 9c fc ff ff       	call   801064d9 <rcr2>
8010683d:	89 c2                	mov    %eax,%edx
8010683f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106845:	8b 40 04             	mov    0x4(%eax),%eax
80106848:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010684f:	00 
80106850:	89 54 24 04          	mov    %edx,0x4(%esp)
80106854:	89 04 24             	mov    %eax,(%esp)
80106857:	e8 a9 14 00 00       	call   80107d05 <getOrCreatePTE>
8010685c:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if (!u_pte || !(*u_pte & PTE_P) ) {    
8010685f:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80106863:	74 10                	je     80106875 <trap+0x16b>
80106865:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106868:	8b 00                	mov    (%eax),%eax
8010686a:	83 e0 01             	and    $0x1,%eax
8010686d:	85 c0                	test   %eax,%eax
8010686f:	0f 85 df 00 00 00    	jne    80106954 <trap+0x24a>
	char * mem = kalloc();
80106875:	e8 68 c2 ff ff       	call   80102ae2 <kalloc>
8010687a:	89 45 dc             	mov    %eax,-0x24(%ebp)
	if(mem == 0){
8010687d:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
80106881:	75 7e                	jne    80106901 <trap+0x1f7>
	    cprintf("allocuvm out of memory\n");
80106883:	c7 04 24 ac 8a 10 80 	movl   $0x80108aac,(%esp)
8010688a:	e8 11 9b ff ff       	call   801003a0 <cprintf>
	    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010688f:	e8 45 fc ff ff       	call   801064d9 <rcr2>
80106894:	89 c2                	mov    %eax,%edx
80106896:	8b 45 08             	mov    0x8(%ebp),%eax
80106899:	8b 78 38             	mov    0x38(%eax),%edi
		"eip 0x%x addr 0x%x--kill proc\n",
		proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip,
8010689c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801068a2:	0f b6 00             	movzbl (%eax),%eax
	...
	if(mem == 0){
	    cprintf("allocuvm out of memory\n");
	    cprintf("pid %d %s: trap %d err %d on cpu %d "
801068a5:	0f b6 f0             	movzbl %al,%esi
801068a8:	8b 45 08             	mov    0x8(%ebp),%eax
801068ab:	8b 58 34             	mov    0x34(%eax),%ebx
801068ae:	8b 45 08             	mov    0x8(%ebp),%eax
801068b1:	8b 48 30             	mov    0x30(%eax),%ecx
		"eip 0x%x addr 0x%x--kill proc\n",
		proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip,
801068b4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068ba:	83 c0 6c             	add    $0x6c,%eax
801068bd:	89 45 d4             	mov    %eax,-0x2c(%ebp)
...
801068c9:	89 54 24 1c          	mov    %edx,0x1c(%esp)
801068cd:	89 7c 24 18          	mov    %edi,0x18(%esp)
801068d1:	89 74 24 14          	mov    %esi,0x14(%esp)
801068d5:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801068d9:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801068dd:	8b 75 d4             	mov    -0x2c(%ebp),%esi
801068e0:	89 74 24 08          	mov    %esi,0x8(%esp)
801068e4:	89 44 24 04          	mov    %eax,0x4(%esp)
801068e8:	c7 04 24 c4 8a 10 80 	movl   $0x80108ac4,(%esp)
...
801068fa:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
	}
	memset(mem, 0, PGSIZE);
80106901:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106908:	00 
80106909:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106910:	00 
80106911:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106914:	89 04 24             	mov    %eax,(%esp)
80106917:	e8 5b e7 ff ff       	call   80105077 <memset>
	mappages(proc->pgdir, (void *)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010691c:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010691f:	89 04 24             	mov    %eax,(%esp)
80106922:	e8 6f fb ff ff       	call   80106496 <v2p>
80106927:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010692a:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80106931:	8b 52 04             	mov    0x4(%edx),%edx
80106934:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010693b:	00 
8010693c:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106940:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106947:	00 
80106948:	89 4c 24 04          	mov    %ecx,0x4(%esp)
8010694c:	89 14 24             	mov    %edx,(%esp)
8010694f:	e8 d2 13 00 00       	call   80107d26 <mappages>
    }
    //pte_t * k_pte = pushToTLB(a);
    //*k_pte = *u_pte;
    
    lapiceoi();
80106954:	e8 77 c5 ff ff       	call   80102ed0 <lapiceoi>
    break;
80106959:	e9 d6 00 00 00       	jmp    80106a34 <trap+0x32a>
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
8010695e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106964:	85 c0                	test   %eax,%eax
80106966:	74 11                	je     80106979 <trap+0x26f>
...
80106977:	75 46                	jne    801069bf <trap+0x2b5>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106979:	e8 5b fb ff ff       	call   801064d9 <rcr2>
8010697e:	8b 55 08             	mov    0x8(%ebp),%edx
80106981:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106984:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010698b:	0f b6 12             	movzbl (%edx),%edx
    break;
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010698e:	0f b6 ca             	movzbl %dl,%ecx
80106991:	8b 55 08             	mov    0x8(%ebp),%edx
80106994:	8b 52 30             	mov    0x30(%edx),%edx
80106997:	89 44 24 10          	mov    %eax,0x10(%esp)
8010699b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010699f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801069a3:	89 54 24 04          	mov    %edx,0x4(%esp)
801069a7:	c7 04 24 08 8b 10 80 	movl   $0x80108b08,(%esp)
801069ae:	e8 ed 99 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801069b3:	c7 04 24 3a 8b 10 80 	movl   $0x80108b3a,(%esp)
801069ba:	e8 7b 9b ff ff       	call   8010053a <panic>
    }

    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801069bf:	e8 15 fb ff ff       	call   801064d9 <rcr2>
801069c4:	89 c2                	mov    %eax,%edx
801069c6:	8b 45 08             	mov    0x8(%ebp),%eax
801069c9:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
...
801069d2:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801069d5:	0f b6 f0             	movzbl %al,%esi
801069d8:	8b 45 08             	mov    0x8(%ebp),%eax
801069db:	8b 58 34             	mov    0x34(%eax),%ebx
801069de:	8b 45 08             	mov    0x8(%ebp),%eax
801069e1:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801069e4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069ea:	83 c0 6c             	add    $0x6c,%eax
801069ed:	89 45 d4             	mov    %eax,-0x2c(%ebp)
801069f0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801069f6:	8b 40 10             	mov    0x10(%eax),%eax
801069f9:	89 54 24 1c          	mov    %edx,0x1c(%esp)
801069fd:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106a01:	89 74 24 14          	mov    %esi,0x14(%esp)
80106a05:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106a09:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106a0d:	8b 7d d4             	mov    -0x2c(%ebp),%edi
80106a10:	89 7c 24 08          	mov    %edi,0x8(%esp)
80106a14:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a18:	c7 04 24 c4 8a 10 80 	movl   $0x80108ac4,(%esp)
80106a1f:	e8 7c 99 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106a24:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a2a:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106a31:	eb 01                	jmp    80106a34 <trap+0x32a>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106a5b:	75 05                	jne    80106a62 <trap+0x358>
    exit();
80106a5d:	e8 15 dd ff ff       	call   80104777 <exit>
...
80106a6a:	74 1e                	je     80106a8a <trap+0x380>
80106a6c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a72:	8b 40 0c             	mov    0xc(%eax),%eax
80106a75:	83 f8 04             	cmp    $0x4,%eax
80106a78:	75 10                	jne    80106a8a <trap+0x380>
80106a7a:	8b 45 08             	mov    0x8(%ebp),%eax
80106a7d:	8b 40 30             	mov    0x30(%eax),%eax
80106a80:	83 f8 20             	cmp    $0x20,%eax
80106a83:	75 05                	jne    80106a8a <trap+0x380>
    yield();
80106a85:	e8 71 e0 ff ff       	call   80104afb <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106a8a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a90:	85 c0                	test   %eax,%eax
80106a92:	74 24                	je     80106ab8 <trap+0x3ae>
80106a94:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a9a:	8b 40 24             	mov    0x24(%eax),%eax
80106a9d:	85 c0                	test   %eax,%eax
80106a9f:	74 17                	je     80106ab8 <trap+0x3ae>
80106aa1:	8b 45 08             	mov    0x8(%ebp),%eax
80106aa4:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106aa8:	0f b7 c0             	movzwl %ax,%eax
80106aab:	83 e0 03             	and    $0x3,%eax
80106aae:	83 f8 03             	cmp    $0x3,%eax
80106ab1:	75 05                	jne    80106ab8 <trap+0x3ae>
    exit();
80106ab3:	e8 bf dc ff ff       	call   80104777 <exit>
}
80106ab8:	83 c4 4c             	add    $0x4c,%esp
80106abb:	5b                   	pop    %ebx
80106abc:	5e                   	pop    %esi
80106abd:	5f                   	pop    %edi
80106abe:	5d                   	pop    %ebp
...
80106ac9:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106acd:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106ad1:	89 c2                	mov    %eax,%edx
80106ad3:	ec                   	in     (%dx),%al
80106ad4:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106ad7:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106adb:	c9                   	leave  
80106adc:	c3                   	ret    
...
80106ae3:	8b 55 08             	mov    0x8(%ebp),%edx
80106ae6:	8b 45 0c             	mov    0xc(%ebp),%eax
80106ae9:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106aed:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106af0:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106af4:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106b08:	00 
80106b09:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106b10:	e8 c8 ff ff ff       	call   80106add <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106b15:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106b1c:	00 
80106b1d:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106b24:	e8 b4 ff ff ff       	call   80106add <outb>
  outb(COM1+0, 115200/9600);
80106b29:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106b30:	00 
80106b31:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b38:	e8 a0 ff ff ff       	call   80106add <outb>
  outb(COM1+1, 0);
80106b3d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b44:	00 
80106b45:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b4c:	e8 8c ff ff ff       	call   80106add <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106b51:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106b58:	00 
80106b59:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106b60:	e8 78 ff ff ff       	call   80106add <outb>
  outb(COM1+4, 0);
80106b65:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b6c:	00 
80106b6d:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106b74:	e8 64 ff ff ff       	call   80106add <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106b79:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106b80:	00 
80106b81:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b88:	e8 50 ff ff ff       	call   80106add <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106b8d:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b94:	e8 27 ff ff ff       	call   80106ac0 <inb>
80106b99:	3c ff                	cmp    $0xff,%al
80106b9b:	75 02                	jne    80106b9f <uartinit+0xa4>
    return;
80106b9d:	eb 6a                	jmp    80106c09 <uartinit+0x10e>
  uart = 1;
80106b9f:	c7 05 50 b6 10 80 01 	movl   $0x1,0x8010b650
80106ba6:	00 00 00 
...
80106bb0:	e8 0b ff ff ff       	call   80106ac0 <inb>
  inb(COM1+0);
80106bb5:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106bbc:	e8 ff fe ff ff       	call   80106ac0 <inb>
  picenable(IRQ_COM1);
80106bc1:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106bc8:	e8 17 d2 ff ff       	call   80103de4 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106bcd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106bd4:	00 
80106bd5:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106bdc:	e8 7c bd ff ff       	call   8010295d <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106be1:	c7 45 f4 08 8c 10 80 	movl   $0x80108c08,-0xc(%ebp)
80106be8:	eb 15                	jmp    80106bff <uartinit+0x104>
    uartputc(*p);
...
80106bf6:	e8 10 00 00 00       	call   80106c0b <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106bfb:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106bff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c02:	0f b6 00             	movzbl (%eax),%eax
80106c05:	84 c0                	test   %al,%al
80106c07:	75 e1                	jne    80106bea <uartinit+0xef>
    uartputc(*p);
}
80106c09:	c9                   	leave  
80106c0a:	c3                   	ret    
...
80106c0e:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106c11:	a1 50 b6 10 80       	mov    0x8010b650,%eax
80106c16:	85 c0                	test   %eax,%eax
80106c18:	75 02                	jne    80106c1c <uartputc+0x11>
    return;
80106c1a:	eb 4b                	jmp    80106c67 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106c1c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106c23:	eb 10                	jmp    80106c35 <uartputc+0x2a>
    microdelay(10);
80106c25:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106c2c:	e8 c4 c2 ff ff       	call   80102ef5 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106c31:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106c35:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106c39:	7f 16                	jg     80106c51 <uartputc+0x46>
80106c3b:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c42:	e8 79 fe ff ff       	call   80106ac0 <inb>
80106c47:	0f b6 c0             	movzbl %al,%eax
80106c4a:	83 e0 20             	and    $0x20,%eax
80106c4d:	85 c0                	test   %eax,%eax
80106c4f:	74 d4                	je     80106c25 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80106c51:	8b 45 08             	mov    0x8(%ebp),%eax
80106c54:	0f b6 c0             	movzbl %al,%eax
80106c57:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c5b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c62:	e8 76 fe ff ff       	call   80106add <outb>
}
80106c67:	c9                   	leave  
80106c68:	c3                   	ret    
...
80106c6c:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106c6f:	a1 50 b6 10 80       	mov    0x8010b650,%eax
80106c74:	85 c0                	test   %eax,%eax
80106c76:	75 07                	jne    80106c7f <uartgetc+0x16>
    return -1;
80106c78:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c7d:	eb 2c                	jmp    80106cab <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106c7f:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c86:	e8 35 fe ff ff       	call   80106ac0 <inb>
80106c8b:	0f b6 c0             	movzbl %al,%eax
80106c8e:	83 e0 01             	and    $0x1,%eax
80106c91:	85 c0                	test   %eax,%eax
80106c93:	75 07                	jne    80106c9c <uartgetc+0x33>
    return -1;
80106c95:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c9a:	eb 0f                	jmp    80106cab <uartgetc+0x42>
  return inb(COM1+0);
80106c9c:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106ca3:	e8 18 fe ff ff       	call   80106ac0 <inb>
...
80106cb0:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106cb3:	c7 04 24 69 6c 10 80 	movl   $0x80106c69,(%esp)
80106cba:	e8 ee 9a ff ff       	call   801007ad <consoleintr>
}
80106cbf:	c9                   	leave  
80106cc0:	c3                   	ret    
...
80106cc3:	6a 00                	push   $0x0
  jmp alltraps
80106cc5:	e9 a1 f7 ff ff       	jmp    8010646b <alltraps>
...
80106cca:	6a 00                	push   $0x0
  pushl $1
80106ccc:	6a 01                	push   $0x1
  jmp alltraps
80106cce:	e9 98 f7 ff ff       	jmp    8010646b <alltraps>
...
80106cd5:	6a 02                	push   $0x2
  jmp alltraps
80106cd7:	e9 8f f7 ff ff       	jmp    8010646b <alltraps>
...
80106cdc:	6a 00                	push   $0x0
  pushl $3
80106cde:	6a 03                	push   $0x3
  jmp alltraps
80106ce0:	e9 86 f7 ff ff       	jmp    8010646b <alltraps>
...
80106ce5:	6a 00                	push   $0x0
  pushl $4
80106ce7:	6a 04                	push   $0x4
  jmp alltraps
80106ce9:	e9 7d f7 ff ff       	jmp    8010646b <alltraps>
...
80106cee:	6a 00                	push   $0x0
  pushl $5
80106cf0:	6a 05                	push   $0x5
  jmp alltraps
80106cf2:	e9 74 f7 ff ff       	jmp    8010646b <alltraps>
...
80106cf7:	6a 00                	push   $0x0
  pushl $6
80106cf9:	6a 06                	push   $0x6
  jmp alltraps
80106cfb:	e9 6b f7 ff ff       	jmp    8010646b <alltraps>
...
80106d00:	6a 00                	push   $0x0
  pushl $7
80106d02:	6a 07                	push   $0x7
  jmp alltraps
80106d04:	e9 62 f7 ff ff       	jmp    8010646b <alltraps>

80106d09 <vector8>:
.globl vector8
vector8:
  pushl $8
80106d09:	6a 08                	push   $0x8
  jmp alltraps
80106d0b:	e9 5b f7 ff ff       	jmp    8010646b <alltraps>
...
80106d10:	6a 00                	push   $0x0
  pushl $9
80106d12:	6a 09                	push   $0x9
  jmp alltraps
80106d14:	e9 52 f7 ff ff       	jmp    8010646b <alltraps>
...
80106d19:	6a 0a                	push   $0xa
  jmp alltraps
80106d1b:	e9 4b f7 ff ff       	jmp    8010646b <alltraps>

80106d20 <vector11>:
.globl vector11
vector11:
  pushl $11
80106d20:	6a 0b                	push   $0xb
  jmp alltraps
80106d22:	e9 44 f7 ff ff       	jmp    8010646b <alltraps>
...
80106d27:	6a 0c                	push   $0xc
  jmp alltraps
80106d29:	e9 3d f7 ff ff       	jmp    8010646b <alltraps>

80106d2e <vector13>:
.globl vector13
vector13:
  pushl $13
80106d2e:	6a 0d                	push   $0xd
  jmp alltraps
80106d30:	e9 36 f7 ff ff       	jmp    8010646b <alltraps>

80106d35 <vector14>:
.globl vector14
vector14:
  pushl $14
80106d35:	6a 0e                	push   $0xe
  jmp alltraps
80106d37:	e9 2f f7 ff ff       	jmp    8010646b <alltraps>
...
80106d3c:	6a 00                	push   $0x0
  pushl $15
80106d3e:	6a 0f                	push   $0xf
  jmp alltraps
80106d40:	e9 26 f7 ff ff       	jmp    8010646b <alltraps>
...
80106d45:	6a 00                	push   $0x0
  pushl $16
80106d47:	6a 10                	push   $0x10
  jmp alltraps
80106d49:	e9 1d f7 ff ff       	jmp    8010646b <alltraps>

80106d4e <vector17>:
.globl vector17
vector17:
  pushl $17
80106d4e:	6a 11                	push   $0x11
  jmp alltraps
80106d50:	e9 16 f7 ff ff       	jmp    8010646b <alltraps>
...
80106d55:	6a 00                	push   $0x0
  pushl $18
80106d57:	6a 12                	push   $0x12
  jmp alltraps
80106d59:	e9 0d f7 ff ff       	jmp    8010646b <alltraps>
...
80106d5e:	6a 00                	push   $0x0
  pushl $19
80106d60:	6a 13                	push   $0x13
  jmp alltraps
80106d62:	e9 04 f7 ff ff       	jmp    8010646b <alltraps>
...
80106d67:	6a 00                	push   $0x0
  pushl $20
80106d69:	6a 14                	push   $0x14
  jmp alltraps
80106d6b:	e9 fb f6 ff ff       	jmp    8010646b <alltraps>
...
80106d70:	6a 00                	push   $0x0
  pushl $21
80106d72:	6a 15                	push   $0x15
  jmp alltraps
80106d74:	e9 f2 f6 ff ff       	jmp    8010646b <alltraps>
...
80106d79:	6a 00                	push   $0x0
  pushl $22
80106d7b:	6a 16                	push   $0x16
  jmp alltraps
80106d7d:	e9 e9 f6 ff ff       	jmp    8010646b <alltraps>
...
80106d82:	6a 00                	push   $0x0
  pushl $23
80106d84:	6a 17                	push   $0x17
  jmp alltraps
80106d86:	e9 e0 f6 ff ff       	jmp    8010646b <alltraps>
...
80106d8b:	6a 00                	push   $0x0
  pushl $24
80106d8d:	6a 18                	push   $0x18
  jmp alltraps
80106d8f:	e9 d7 f6 ff ff       	jmp    8010646b <alltraps>
...
80106d94:	6a 00                	push   $0x0
  pushl $25
80106d96:	6a 19                	push   $0x19
  jmp alltraps
80106d98:	e9 ce f6 ff ff       	jmp    8010646b <alltraps>
...
80106d9d:	6a 00                	push   $0x0
  pushl $26
80106d9f:	6a 1a                	push   $0x1a
  jmp alltraps
80106da1:	e9 c5 f6 ff ff       	jmp    8010646b <alltraps>
...
80106da6:	6a 00                	push   $0x0
  pushl $27
80106da8:	6a 1b                	push   $0x1b
  jmp alltraps
80106daa:	e9 bc f6 ff ff       	jmp    8010646b <alltraps>
...
80106daf:	6a 00                	push   $0x0
  pushl $28
80106db1:	6a 1c                	push   $0x1c
  jmp alltraps
80106db3:	e9 b3 f6 ff ff       	jmp    8010646b <alltraps>
...
80106db8:	6a 00                	push   $0x0
  pushl $29
80106dba:	6a 1d                	push   $0x1d
  jmp alltraps
80106dbc:	e9 aa f6 ff ff       	jmp    8010646b <alltraps>
...
80106dc1:	6a 00                	push   $0x0
  pushl $30
80106dc3:	6a 1e                	push   $0x1e
  jmp alltraps
80106dc5:	e9 a1 f6 ff ff       	jmp    8010646b <alltraps>
...
80106dca:	6a 00                	push   $0x0
  pushl $31
80106dcc:	6a 1f                	push   $0x1f
  jmp alltraps
80106dce:	e9 98 f6 ff ff       	jmp    8010646b <alltraps>
...
80106dd3:	6a 00                	push   $0x0
  pushl $32
80106dd5:	6a 20                	push   $0x20
  jmp alltraps
80106dd7:	e9 8f f6 ff ff       	jmp    8010646b <alltraps>
...
80106ddc:	6a 00                	push   $0x0
  pushl $33
80106dde:	6a 21                	push   $0x21
  jmp alltraps
80106de0:	e9 86 f6 ff ff       	jmp    8010646b <alltraps>
...
80106de5:	6a 00                	push   $0x0
  pushl $34
80106de7:	6a 22                	push   $0x22
  jmp alltraps
80106de9:	e9 7d f6 ff ff       	jmp    8010646b <alltraps>
...
80106dee:	6a 00                	push   $0x0
  pushl $35
80106df0:	6a 23                	push   $0x23
  jmp alltraps
80106df2:	e9 74 f6 ff ff       	jmp    8010646b <alltraps>
...
80106df7:	6a 00                	push   $0x0
  pushl $36
80106df9:	6a 24                	push   $0x24
  jmp alltraps
80106dfb:	e9 6b f6 ff ff       	jmp    8010646b <alltraps>
...
80106e00:	6a 00                	push   $0x0
  pushl $37
80106e02:	6a 25                	push   $0x25
  jmp alltraps
80106e04:	e9 62 f6 ff ff       	jmp    8010646b <alltraps>
...
80106e09:	6a 00                	push   $0x0
  pushl $38
80106e0b:	6a 26                	push   $0x26
  jmp alltraps
80106e0d:	e9 59 f6 ff ff       	jmp    8010646b <alltraps>
...
80106e12:	6a 00                	push   $0x0
  pushl $39
80106e14:	6a 27                	push   $0x27
  jmp alltraps
80106e16:	e9 50 f6 ff ff       	jmp    8010646b <alltraps>
...
80106e1b:	6a 00                	push   $0x0
  pushl $40
80106e1d:	6a 28                	push   $0x28
  jmp alltraps
80106e1f:	e9 47 f6 ff ff       	jmp    8010646b <alltraps>
...
80106e24:	6a 00                	push   $0x0
  pushl $41
80106e26:	6a 29                	push   $0x29
  jmp alltraps
80106e28:	e9 3e f6 ff ff       	jmp    8010646b <alltraps>
...
80106e2d:	6a 00                	push   $0x0
  pushl $42
80106e2f:	6a 2a                	push   $0x2a
  jmp alltraps
80106e31:	e9 35 f6 ff ff       	jmp    8010646b <alltraps>
...
80106e36:	6a 00                	push   $0x0
  pushl $43
80106e38:	6a 2b                	push   $0x2b
  jmp alltraps
80106e3a:	e9 2c f6 ff ff       	jmp    8010646b <alltraps>
...
80106e3f:	6a 00                	push   $0x0
  pushl $44
80106e41:	6a 2c                	push   $0x2c
  jmp alltraps
80106e43:	e9 23 f6 ff ff       	jmp    8010646b <alltraps>
...
80106e48:	6a 00                	push   $0x0
  pushl $45
80106e4a:	6a 2d                	push   $0x2d
  jmp alltraps
80106e4c:	e9 1a f6 ff ff       	jmp    8010646b <alltraps>
...
80106e53:	6a 2e                	push   $0x2e
  jmp alltraps
80106e55:	e9 11 f6 ff ff       	jmp    8010646b <alltraps>
...
80106e5a:	6a 00                	push   $0x0
  pushl $47
80106e5c:	6a 2f                	push   $0x2f
  jmp alltraps
80106e5e:	e9 08 f6 ff ff       	jmp    8010646b <alltraps>
...
80106e63:	6a 00                	push   $0x0
  pushl $48
80106e65:	6a 30                	push   $0x30
  jmp alltraps
80106e67:	e9 ff f5 ff ff       	jmp    8010646b <alltraps>
...
80106e6c:	6a 00                	push   $0x0
  pushl $49
80106e6e:	6a 31                	push   $0x31
  jmp alltraps
80106e70:	e9 f6 f5 ff ff       	jmp    8010646b <alltraps>
...
80106e75:	6a 00                	push   $0x0
  pushl $50
80106e77:	6a 32                	push   $0x32
  jmp alltraps
80106e79:	e9 ed f5 ff ff       	jmp    8010646b <alltraps>
...
80106e7e:	6a 00                	push   $0x0
  pushl $51
80106e80:	6a 33                	push   $0x33
  jmp alltraps
80106e82:	e9 e4 f5 ff ff       	jmp    8010646b <alltraps>
...
80106e87:	6a 00                	push   $0x0
  pushl $52
80106e89:	6a 34                	push   $0x34
  jmp alltraps
80106e8b:	e9 db f5 ff ff       	jmp    8010646b <alltraps>
...
80106e90:	6a 00                	push   $0x0
  pushl $53
80106e92:	6a 35                	push   $0x35
  jmp alltraps
80106e94:	e9 d2 f5 ff ff       	jmp    8010646b <alltraps>
...
80106e99:	6a 00                	push   $0x0
  pushl $54
80106e9b:	6a 36                	push   $0x36
  jmp alltraps
80106e9d:	e9 c9 f5 ff ff       	jmp    8010646b <alltraps>
...
80106ea2:	6a 00                	push   $0x0
  pushl $55
80106ea4:	6a 37                	push   $0x37
  jmp alltraps
80106ea6:	e9 c0 f5 ff ff       	jmp    8010646b <alltraps>
...
80106eab:	6a 00                	push   $0x0
  pushl $56
80106ead:	6a 38                	push   $0x38
  jmp alltraps
80106eaf:	e9 b7 f5 ff ff       	jmp    8010646b <alltraps>
...
80106eb4:	6a 00                	push   $0x0
  pushl $57
80106eb6:	6a 39                	push   $0x39
  jmp alltraps
80106eb8:	e9 ae f5 ff ff       	jmp    8010646b <alltraps>
...
80106ebd:	6a 00                	push   $0x0
  pushl $58
80106ebf:	6a 3a                	push   $0x3a
  jmp alltraps
80106ec1:	e9 a5 f5 ff ff       	jmp    8010646b <alltraps>
...
80106ec6:	6a 00                	push   $0x0
  pushl $59
80106ec8:	6a 3b                	push   $0x3b
  jmp alltraps
80106eca:	e9 9c f5 ff ff       	jmp    8010646b <alltraps>
...
80106ecf:	6a 00                	push   $0x0
  pushl $60
80106ed1:	6a 3c                	push   $0x3c
  jmp alltraps
80106ed3:	e9 93 f5 ff ff       	jmp    8010646b <alltraps>
...
80106ed8:	6a 00                	push   $0x0
  pushl $61
80106eda:	6a 3d                	push   $0x3d
  jmp alltraps
80106edc:	e9 8a f5 ff ff       	jmp    8010646b <alltraps>
...
80106ee1:	6a 00                	push   $0x0
  pushl $62
80106ee3:	6a 3e                	push   $0x3e
  jmp alltraps
80106ee5:	e9 81 f5 ff ff       	jmp    8010646b <alltraps>
...
80106eea:	6a 00                	push   $0x0
  pushl $63
80106eec:	6a 3f                	push   $0x3f
  jmp alltraps
80106eee:	e9 78 f5 ff ff       	jmp    8010646b <alltraps>
...
80106ef5:	6a 40                	push   $0x40
  jmp alltraps
80106ef7:	e9 6f f5 ff ff       	jmp    8010646b <alltraps>
...
80106efc:	6a 00                	push   $0x0
  pushl $65
80106efe:	6a 41                	push   $0x41
  jmp alltraps
80106f00:	e9 66 f5 ff ff       	jmp    8010646b <alltraps>
...
80106f05:	6a 00                	push   $0x0
  pushl $66
80106f07:	6a 42                	push   $0x42
  jmp alltraps
80106f09:	e9 5d f5 ff ff       	jmp    8010646b <alltraps>
...
80106f0e:	6a 00                	push   $0x0
  pushl $67
80106f10:	6a 43                	push   $0x43
  jmp alltraps
80106f12:	e9 54 f5 ff ff       	jmp    8010646b <alltraps>
...
80106f17:	6a 00                	push   $0x0
  pushl $68
80106f19:	6a 44                	push   $0x44
  jmp alltraps
80106f1b:	e9 4b f5 ff ff       	jmp    8010646b <alltraps>
...
80106f20:	6a 00                	push   $0x0
  pushl $69
80106f22:	6a 45                	push   $0x45
  jmp alltraps
80106f24:	e9 42 f5 ff ff       	jmp    8010646b <alltraps>
...
80106f29:	6a 00                	push   $0x0
  pushl $70
80106f2b:	6a 46                	push   $0x46
  jmp alltraps
80106f2d:	e9 39 f5 ff ff       	jmp    8010646b <alltraps>
...
80106f32:	6a 00                	push   $0x0
  pushl $71
80106f34:	6a 47                	push   $0x47
  jmp alltraps
80106f36:	e9 30 f5 ff ff       	jmp    8010646b <alltraps>
...
80106f3b:	6a 00                	push   $0x0
  pushl $72
80106f3d:	6a 48                	push   $0x48
  jmp alltraps
80106f3f:	e9 27 f5 ff ff       	jmp    8010646b <alltraps>
...
80106f44:	6a 00                	push   $0x0
  pushl $73
80106f46:	6a 49                	push   $0x49
  jmp alltraps
80106f48:	e9 1e f5 ff ff       	jmp    8010646b <alltraps>
...
80106f4d:	6a 00                	push   $0x0
  pushl $74
80106f4f:	6a 4a                	push   $0x4a
  jmp alltraps
80106f51:	e9 15 f5 ff ff       	jmp    8010646b <alltraps>
...
80106f56:	6a 00                	push   $0x0
  pushl $75
80106f58:	6a 4b                	push   $0x4b
  jmp alltraps
80106f5a:	e9 0c f5 ff ff       	jmp    8010646b <alltraps>
...
80106f5f:	6a 00                	push   $0x0
  pushl $76
80106f61:	6a 4c                	push   $0x4c
  jmp alltraps
80106f63:	e9 03 f5 ff ff       	jmp    8010646b <alltraps>
...
80106f68:	6a 00                	push   $0x0
  pushl $77
80106f6a:	6a 4d                	push   $0x4d
  jmp alltraps
80106f6c:	e9 fa f4 ff ff       	jmp    8010646b <alltraps>
...
80106f71:	6a 00                	push   $0x0
  pushl $78
80106f73:	6a 4e                	push   $0x4e
  jmp alltraps
80106f75:	e9 f1 f4 ff ff       	jmp    8010646b <alltraps>
...
80106f7a:	6a 00                	push   $0x0
  pushl $79
80106f7c:	6a 4f                	push   $0x4f
  jmp alltraps
80106f7e:	e9 e8 f4 ff ff       	jmp    8010646b <alltraps>
...
80106f83:	6a 00                	push   $0x0
  pushl $80
80106f85:	6a 50                	push   $0x50
  jmp alltraps
80106f87:	e9 df f4 ff ff       	jmp    8010646b <alltraps>
...
80106f8c:	6a 00                	push   $0x0
  pushl $81
80106f8e:	6a 51                	push   $0x51
  jmp alltraps
80106f90:	e9 d6 f4 ff ff       	jmp    8010646b <alltraps>
...
80106f95:	6a 00                	push   $0x0
  pushl $82
80106f97:	6a 52                	push   $0x52
  jmp alltraps
80106f99:	e9 cd f4 ff ff       	jmp    8010646b <alltraps>
...
80106f9e:	6a 00                	push   $0x0
  pushl $83
80106fa0:	6a 53                	push   $0x53
  jmp alltraps
80106fa2:	e9 c4 f4 ff ff       	jmp    8010646b <alltraps>
...
80106fa7:	6a 00                	push   $0x0
  pushl $84
80106fa9:	6a 54                	push   $0x54
  jmp alltraps
80106fab:	e9 bb f4 ff ff       	jmp    8010646b <alltraps>
...
80106fb0:	6a 00                	push   $0x0
  pushl $85
80106fb2:	6a 55                	push   $0x55
  jmp alltraps
80106fb4:	e9 b2 f4 ff ff       	jmp    8010646b <alltraps>
...
80106fb9:	6a 00                	push   $0x0
  pushl $86
80106fbb:	6a 56                	push   $0x56
  jmp alltraps
80106fbd:	e9 a9 f4 ff ff       	jmp    8010646b <alltraps>
...
80106fc2:	6a 00                	push   $0x0
  pushl $87
80106fc4:	6a 57                	push   $0x57
  jmp alltraps
80106fc6:	e9 a0 f4 ff ff       	jmp    8010646b <alltraps>
...
80106fcb:	6a 00                	push   $0x0
  pushl $88
80106fcd:	6a 58                	push   $0x58
  jmp alltraps
80106fcf:	e9 97 f4 ff ff       	jmp    8010646b <alltraps>
...
80106fd4:	6a 00                	push   $0x0
  pushl $89
80106fd6:	6a 59                	push   $0x59
  jmp alltraps
80106fd8:	e9 8e f4 ff ff       	jmp    8010646b <alltraps>
...
80106fdd:	6a 00                	push   $0x0
  pushl $90
80106fdf:	6a 5a                	push   $0x5a
  jmp alltraps
80106fe1:	e9 85 f4 ff ff       	jmp    8010646b <alltraps>
...
80106fe6:	6a 00                	push   $0x0
  pushl $91
80106fe8:	6a 5b                	push   $0x5b
  jmp alltraps
80106fea:	e9 7c f4 ff ff       	jmp    8010646b <alltraps>
...
80106fef:	6a 00                	push   $0x0
  pushl $92
80106ff1:	6a 5c                	push   $0x5c
  jmp alltraps
80106ff3:	e9 73 f4 ff ff       	jmp    8010646b <alltraps>
...
80106ff8:	6a 00                	push   $0x0
  pushl $93
80106ffa:	6a 5d                	push   $0x5d
  jmp alltraps
80106ffc:	e9 6a f4 ff ff       	jmp    8010646b <alltraps>
...
80107001:	6a 00                	push   $0x0
  pushl $94
80107003:	6a 5e                	push   $0x5e
  jmp alltraps
80107005:	e9 61 f4 ff ff       	jmp    8010646b <alltraps>
...
8010700a:	6a 00                	push   $0x0
  pushl $95
8010700c:	6a 5f                	push   $0x5f
  jmp alltraps
8010700e:	e9 58 f4 ff ff       	jmp    8010646b <alltraps>
...
80107013:	6a 00                	push   $0x0
  pushl $96
80107015:	6a 60                	push   $0x60
  jmp alltraps
80107017:	e9 4f f4 ff ff       	jmp    8010646b <alltraps>
...
8010701c:	6a 00                	push   $0x0
  pushl $97
8010701e:	6a 61                	push   $0x61
  jmp alltraps
80107020:	e9 46 f4 ff ff       	jmp    8010646b <alltraps>
...
80107025:	6a 00                	push   $0x0
  pushl $98
80107027:	6a 62                	push   $0x62
  jmp alltraps
80107029:	e9 3d f4 ff ff       	jmp    8010646b <alltraps>
...
8010702e:	6a 00                	push   $0x0
  pushl $99
80107030:	6a 63                	push   $0x63
  jmp alltraps
80107032:	e9 34 f4 ff ff       	jmp    8010646b <alltraps>
...
80107037:	6a 00                	push   $0x0
  pushl $100
80107039:	6a 64                	push   $0x64
  jmp alltraps
8010703b:	e9 2b f4 ff ff       	jmp    8010646b <alltraps>
...
80107040:	6a 00                	push   $0x0
  pushl $101
80107042:	6a 65                	push   $0x65
  jmp alltraps
80107044:	e9 22 f4 ff ff       	jmp    8010646b <alltraps>
...
80107049:	6a 00                	push   $0x0
  pushl $102
8010704b:	6a 66                	push   $0x66
  jmp alltraps
8010704d:	e9 19 f4 ff ff       	jmp    8010646b <alltraps>
...
80107052:	6a 00                	push   $0x0
  pushl $103
80107054:	6a 67                	push   $0x67
  jmp alltraps
80107056:	e9 10 f4 ff ff       	jmp    8010646b <alltraps>
...
8010705b:	6a 00                	push   $0x0
  pushl $104
8010705d:	6a 68                	push   $0x68
  jmp alltraps
8010705f:	e9 07 f4 ff ff       	jmp    8010646b <alltraps>
...
80107064:	6a 00                	push   $0x0
  pushl $105
80107066:	6a 69                	push   $0x69
  jmp alltraps
80107068:	e9 fe f3 ff ff       	jmp    8010646b <alltraps>
...
8010706d:	6a 00                	push   $0x0
  pushl $106
8010706f:	6a 6a                	push   $0x6a
  jmp alltraps
80107071:	e9 f5 f3 ff ff       	jmp    8010646b <alltraps>
...
80107076:	6a 00                	push   $0x0
  pushl $107
80107078:	6a 6b                	push   $0x6b
  jmp alltraps
8010707a:	e9 ec f3 ff ff       	jmp    8010646b <alltraps>
...
8010707f:	6a 00                	push   $0x0
  pushl $108
80107081:	6a 6c                	push   $0x6c
  jmp alltraps
80107083:	e9 e3 f3 ff ff       	jmp    8010646b <alltraps>
...
80107088:	6a 00                	push   $0x0
  pushl $109
8010708a:	6a 6d                	push   $0x6d
  jmp alltraps
8010708c:	e9 da f3 ff ff       	jmp    8010646b <alltraps>
...
80107091:	6a 00                	push   $0x0
  pushl $110
80107093:	6a 6e                	push   $0x6e
  jmp alltraps
80107095:	e9 d1 f3 ff ff       	jmp    8010646b <alltraps>
...
8010709a:	6a 00                	push   $0x0
  pushl $111
8010709c:	6a 6f                	push   $0x6f
  jmp alltraps
8010709e:	e9 c8 f3 ff ff       	jmp    8010646b <alltraps>
...
801070a3:	6a 00                	push   $0x0
  pushl $112
801070a5:	6a 70                	push   $0x70
  jmp alltraps
801070a7:	e9 bf f3 ff ff       	jmp    8010646b <alltraps>
...
801070ac:	6a 00                	push   $0x0
  pushl $113
801070ae:	6a 71                	push   $0x71
  jmp alltraps
801070b0:	e9 b6 f3 ff ff       	jmp    8010646b <alltraps>
...
801070b5:	6a 00                	push   $0x0
  pushl $114
801070b7:	6a 72                	push   $0x72
  jmp alltraps
801070b9:	e9 ad f3 ff ff       	jmp    8010646b <alltraps>
...
801070be:	6a 00                	push   $0x0
  pushl $115
801070c0:	6a 73                	push   $0x73
  jmp alltraps
801070c2:	e9 a4 f3 ff ff       	jmp    8010646b <alltraps>
...
801070c7:	6a 00                	push   $0x0
  pushl $116
801070c9:	6a 74                	push   $0x74
  jmp alltraps
801070cb:	e9 9b f3 ff ff       	jmp    8010646b <alltraps>
...
801070d0:	6a 00                	push   $0x0
  pushl $117
801070d2:	6a 75                	push   $0x75
  jmp alltraps
801070d4:	e9 92 f3 ff ff       	jmp    8010646b <alltraps>
...
801070d9:	6a 00                	push   $0x0
  pushl $118
801070db:	6a 76                	push   $0x76
  jmp alltraps
801070dd:	e9 89 f3 ff ff       	jmp    8010646b <alltraps>
...
801070e2:	6a 00                	push   $0x0
  pushl $119
801070e4:	6a 77                	push   $0x77
  jmp alltraps
801070e6:	e9 80 f3 ff ff       	jmp    8010646b <alltraps>
...
801070eb:	6a 00                	push   $0x0
  pushl $120
801070ed:	6a 78                	push   $0x78
  jmp alltraps
801070ef:	e9 77 f3 ff ff       	jmp    8010646b <alltraps>
...
801070f4:	6a 00                	push   $0x0
  pushl $121
801070f6:	6a 79                	push   $0x79
  jmp alltraps
801070f8:	e9 6e f3 ff ff       	jmp    8010646b <alltraps>
...
801070fd:	6a 00                	push   $0x0
  pushl $122
801070ff:	6a 7a                	push   $0x7a
  jmp alltraps
80107101:	e9 65 f3 ff ff       	jmp    8010646b <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $123
80107108:	6a 7b                	push   $0x7b
  jmp alltraps
8010710a:	e9 5c f3 ff ff       	jmp    8010646b <alltraps>
...
8010710f:	6a 00                	push   $0x0
  pushl $124
80107111:	6a 7c                	push   $0x7c
  jmp alltraps
80107113:	e9 53 f3 ff ff       	jmp    8010646b <alltraps>
...
80107118:	6a 00                	push   $0x0
  pushl $125
8010711a:	6a 7d                	push   $0x7d
  jmp alltraps
8010711c:	e9 4a f3 ff ff       	jmp    8010646b <alltraps>
...
80107121:	6a 00                	push   $0x0
  pushl $126
80107123:	6a 7e                	push   $0x7e
  jmp alltraps
80107125:	e9 41 f3 ff ff       	jmp    8010646b <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $127
8010712c:	6a 7f                	push   $0x7f
  jmp alltraps
8010712e:	e9 38 f3 ff ff       	jmp    8010646b <alltraps>
...
80107133:	6a 00                	push   $0x0
  pushl $128
80107135:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010713a:	e9 2c f3 ff ff       	jmp    8010646b <alltraps>
...
8010713f:	6a 00                	push   $0x0
  pushl $129
80107141:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107146:	e9 20 f3 ff ff       	jmp    8010646b <alltraps>
...
8010714b:	6a 00                	push   $0x0
  pushl $130
8010714d:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107152:	e9 14 f3 ff ff       	jmp    8010646b <alltraps>
...
80107157:	6a 00                	push   $0x0
  pushl $131
80107159:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010715e:	e9 08 f3 ff ff       	jmp    8010646b <alltraps>
...
80107163:	6a 00                	push   $0x0
  pushl $132
80107165:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010716a:	e9 fc f2 ff ff       	jmp    8010646b <alltraps>
...
8010716f:	6a 00                	push   $0x0
  pushl $133
80107171:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107176:	e9 f0 f2 ff ff       	jmp    8010646b <alltraps>
...
8010717b:	6a 00                	push   $0x0
  pushl $134
8010717d:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107182:	e9 e4 f2 ff ff       	jmp    8010646b <alltraps>
...
80107187:	6a 00                	push   $0x0
  pushl $135
80107189:	68 87 00 00 00       	push   $0x87
  jmp alltraps
8010718e:	e9 d8 f2 ff ff       	jmp    8010646b <alltraps>
...
80107193:	6a 00                	push   $0x0
  pushl $136
80107195:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010719a:	e9 cc f2 ff ff       	jmp    8010646b <alltraps>
...
8010719f:	6a 00                	push   $0x0
  pushl $137
801071a1:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801071a6:	e9 c0 f2 ff ff       	jmp    8010646b <alltraps>
...
801071ab:	6a 00                	push   $0x0
  pushl $138
801071ad:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801071b2:	e9 b4 f2 ff ff       	jmp    8010646b <alltraps>
...
801071b7:	6a 00                	push   $0x0
  pushl $139
801071b9:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801071be:	e9 a8 f2 ff ff       	jmp    8010646b <alltraps>
...
801071c3:	6a 00                	push   $0x0
  pushl $140
801071c5:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801071ca:	e9 9c f2 ff ff       	jmp    8010646b <alltraps>
...
801071cf:	6a 00                	push   $0x0
  pushl $141
801071d1:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801071d6:	e9 90 f2 ff ff       	jmp    8010646b <alltraps>
...
801071db:	6a 00                	push   $0x0
  pushl $142
801071dd:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801071e2:	e9 84 f2 ff ff       	jmp    8010646b <alltraps>
...
801071e7:	6a 00                	push   $0x0
  pushl $143
801071e9:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801071ee:	e9 78 f2 ff ff       	jmp    8010646b <alltraps>
...
801071f3:	6a 00                	push   $0x0
  pushl $144
801071f5:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801071fa:	e9 6c f2 ff ff       	jmp    8010646b <alltraps>
...
801071ff:	6a 00                	push   $0x0
  pushl $145
80107201:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107206:	e9 60 f2 ff ff       	jmp    8010646b <alltraps>
...
8010720b:	6a 00                	push   $0x0
  pushl $146
8010720d:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107212:	e9 54 f2 ff ff       	jmp    8010646b <alltraps>
...
80107217:	6a 00                	push   $0x0
  pushl $147
80107219:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010721e:	e9 48 f2 ff ff       	jmp    8010646b <alltraps>
...
80107223:	6a 00                	push   $0x0
  pushl $148
80107225:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010722a:	e9 3c f2 ff ff       	jmp    8010646b <alltraps>
...
8010722f:	6a 00                	push   $0x0
  pushl $149
80107231:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107236:	e9 30 f2 ff ff       	jmp    8010646b <alltraps>
...
8010723b:	6a 00                	push   $0x0
  pushl $150
8010723d:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107242:	e9 24 f2 ff ff       	jmp    8010646b <alltraps>
...
80107247:	6a 00                	push   $0x0
  pushl $151
80107249:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010724e:	e9 18 f2 ff ff       	jmp    8010646b <alltraps>
...
80107253:	6a 00                	push   $0x0
  pushl $152
80107255:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010725a:	e9 0c f2 ff ff       	jmp    8010646b <alltraps>
...
8010725f:	6a 00                	push   $0x0
  pushl $153
80107261:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107266:	e9 00 f2 ff ff       	jmp    8010646b <alltraps>
...
8010726b:	6a 00                	push   $0x0
  pushl $154
8010726d:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107272:	e9 f4 f1 ff ff       	jmp    8010646b <alltraps>
...
80107277:	6a 00                	push   $0x0
  pushl $155
80107279:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010727e:	e9 e8 f1 ff ff       	jmp    8010646b <alltraps>
...
80107283:	6a 00                	push   $0x0
  pushl $156
80107285:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010728a:	e9 dc f1 ff ff       	jmp    8010646b <alltraps>
...
8010728f:	6a 00                	push   $0x0
  pushl $157
80107291:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107296:	e9 d0 f1 ff ff       	jmp    8010646b <alltraps>
...
8010729b:	6a 00                	push   $0x0
  pushl $158
8010729d:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801072a2:	e9 c4 f1 ff ff       	jmp    8010646b <alltraps>
...
801072a7:	6a 00                	push   $0x0
  pushl $159
801072a9:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801072ae:	e9 b8 f1 ff ff       	jmp    8010646b <alltraps>
...
801072b3:	6a 00                	push   $0x0
  pushl $160
801072b5:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801072ba:	e9 ac f1 ff ff       	jmp    8010646b <alltraps>
...
801072bf:	6a 00                	push   $0x0
  pushl $161
801072c1:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801072c6:	e9 a0 f1 ff ff       	jmp    8010646b <alltraps>
...
801072cb:	6a 00                	push   $0x0
  pushl $162
801072cd:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801072d2:	e9 94 f1 ff ff       	jmp    8010646b <alltraps>
...
801072d7:	6a 00                	push   $0x0
  pushl $163
801072d9:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801072de:	e9 88 f1 ff ff       	jmp    8010646b <alltraps>
...
801072e3:	6a 00                	push   $0x0
  pushl $164
801072e5:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801072ea:	e9 7c f1 ff ff       	jmp    8010646b <alltraps>
...
801072ef:	6a 00                	push   $0x0
  pushl $165
801072f1:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801072f6:	e9 70 f1 ff ff       	jmp    8010646b <alltraps>
...
801072fb:	6a 00                	push   $0x0
  pushl $166
801072fd:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107302:	e9 64 f1 ff ff       	jmp    8010646b <alltraps>
...
80107307:	6a 00                	push   $0x0
  pushl $167
80107309:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
8010730e:	e9 58 f1 ff ff       	jmp    8010646b <alltraps>
...
80107313:	6a 00                	push   $0x0
  pushl $168
80107315:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010731a:	e9 4c f1 ff ff       	jmp    8010646b <alltraps>
...
8010731f:	6a 00                	push   $0x0
  pushl $169
80107321:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107326:	e9 40 f1 ff ff       	jmp    8010646b <alltraps>
...
8010732b:	6a 00                	push   $0x0
  pushl $170
8010732d:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107332:	e9 34 f1 ff ff       	jmp    8010646b <alltraps>
...
80107337:	6a 00                	push   $0x0
  pushl $171
80107339:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
8010733e:	e9 28 f1 ff ff       	jmp    8010646b <alltraps>
...
80107343:	6a 00                	push   $0x0
  pushl $172
80107345:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010734a:	e9 1c f1 ff ff       	jmp    8010646b <alltraps>
...
8010734f:	6a 00                	push   $0x0
  pushl $173
80107351:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107356:	e9 10 f1 ff ff       	jmp    8010646b <alltraps>
...
8010735b:	6a 00                	push   $0x0
  pushl $174
8010735d:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107362:	e9 04 f1 ff ff       	jmp    8010646b <alltraps>
...
80107367:	6a 00                	push   $0x0
  pushl $175
80107369:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010736e:	e9 f8 f0 ff ff       	jmp    8010646b <alltraps>
...
80107373:	6a 00                	push   $0x0
  pushl $176
80107375:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010737a:	e9 ec f0 ff ff       	jmp    8010646b <alltraps>
...
8010737f:	6a 00                	push   $0x0
  pushl $177
80107381:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107386:	e9 e0 f0 ff ff       	jmp    8010646b <alltraps>
...
8010738b:	6a 00                	push   $0x0
  pushl $178
8010738d:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107392:	e9 d4 f0 ff ff       	jmp    8010646b <alltraps>
...
80107397:	6a 00                	push   $0x0
  pushl $179
80107399:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010739e:	e9 c8 f0 ff ff       	jmp    8010646b <alltraps>
...
801073a3:	6a 00                	push   $0x0
  pushl $180
801073a5:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801073aa:	e9 bc f0 ff ff       	jmp    8010646b <alltraps>
...
801073af:	6a 00                	push   $0x0
  pushl $181
801073b1:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801073b6:	e9 b0 f0 ff ff       	jmp    8010646b <alltraps>
...
801073bb:	6a 00                	push   $0x0
  pushl $182
801073bd:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801073c2:	e9 a4 f0 ff ff       	jmp    8010646b <alltraps>
...
801073c7:	6a 00                	push   $0x0
  pushl $183
801073c9:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801073ce:	e9 98 f0 ff ff       	jmp    8010646b <alltraps>
...
801073d3:	6a 00                	push   $0x0
  pushl $184
801073d5:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801073da:	e9 8c f0 ff ff       	jmp    8010646b <alltraps>
...
801073df:	6a 00                	push   $0x0
  pushl $185
801073e1:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801073e6:	e9 80 f0 ff ff       	jmp    8010646b <alltraps>
...
801073eb:	6a 00                	push   $0x0
  pushl $186
801073ed:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801073f2:	e9 74 f0 ff ff       	jmp    8010646b <alltraps>
...
801073f7:	6a 00                	push   $0x0
  pushl $187
801073f9:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801073fe:	e9 68 f0 ff ff       	jmp    8010646b <alltraps>
...
80107403:	6a 00                	push   $0x0
  pushl $188
80107405:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010740a:	e9 5c f0 ff ff       	jmp    8010646b <alltraps>
...
8010740f:	6a 00                	push   $0x0
  pushl $189
80107411:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107416:	e9 50 f0 ff ff       	jmp    8010646b <alltraps>
...
8010741b:	6a 00                	push   $0x0
  pushl $190
8010741d:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107422:	e9 44 f0 ff ff       	jmp    8010646b <alltraps>
...
80107427:	6a 00                	push   $0x0
  pushl $191
80107429:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
8010742e:	e9 38 f0 ff ff       	jmp    8010646b <alltraps>
...
80107433:	6a 00                	push   $0x0
  pushl $192
80107435:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010743a:	e9 2c f0 ff ff       	jmp    8010646b <alltraps>
...
8010743f:	6a 00                	push   $0x0
  pushl $193
80107441:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107446:	e9 20 f0 ff ff       	jmp    8010646b <alltraps>
...
8010744b:	6a 00                	push   $0x0
  pushl $194
8010744d:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107452:	e9 14 f0 ff ff       	jmp    8010646b <alltraps>
...
80107457:	6a 00                	push   $0x0
  pushl $195
80107459:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010745e:	e9 08 f0 ff ff       	jmp    8010646b <alltraps>
...
80107463:	6a 00                	push   $0x0
  pushl $196
80107465:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010746a:	e9 fc ef ff ff       	jmp    8010646b <alltraps>
...
8010746f:	6a 00                	push   $0x0
  pushl $197
80107471:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107476:	e9 f0 ef ff ff       	jmp    8010646b <alltraps>
...
8010747b:	6a 00                	push   $0x0
  pushl $198
8010747d:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107482:	e9 e4 ef ff ff       	jmp    8010646b <alltraps>
...
80107487:	6a 00                	push   $0x0
  pushl $199
80107489:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010748e:	e9 d8 ef ff ff       	jmp    8010646b <alltraps>
...
80107493:	6a 00                	push   $0x0
  pushl $200
80107495:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010749a:	e9 cc ef ff ff       	jmp    8010646b <alltraps>
...
8010749f:	6a 00                	push   $0x0
  pushl $201
801074a1:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801074a6:	e9 c0 ef ff ff       	jmp    8010646b <alltraps>
...
801074ab:	6a 00                	push   $0x0
  pushl $202
801074ad:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801074b2:	e9 b4 ef ff ff       	jmp    8010646b <alltraps>
...
801074b7:	6a 00                	push   $0x0
  pushl $203
801074b9:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801074be:	e9 a8 ef ff ff       	jmp    8010646b <alltraps>
...
801074c3:	6a 00                	push   $0x0
  pushl $204
801074c5:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801074ca:	e9 9c ef ff ff       	jmp    8010646b <alltraps>
...
801074cf:	6a 00                	push   $0x0
  pushl $205
801074d1:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801074d6:	e9 90 ef ff ff       	jmp    8010646b <alltraps>
...
801074db:	6a 00                	push   $0x0
  pushl $206
801074dd:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801074e2:	e9 84 ef ff ff       	jmp    8010646b <alltraps>
...
801074e7:	6a 00                	push   $0x0
  pushl $207
801074e9:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801074ee:	e9 78 ef ff ff       	jmp    8010646b <alltraps>
...
801074f3:	6a 00                	push   $0x0
  pushl $208
801074f5:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801074fa:	e9 6c ef ff ff       	jmp    8010646b <alltraps>
...
801074ff:	6a 00                	push   $0x0
  pushl $209
80107501:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107506:	e9 60 ef ff ff       	jmp    8010646b <alltraps>
...
8010750b:	6a 00                	push   $0x0
  pushl $210
8010750d:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107512:	e9 54 ef ff ff       	jmp    8010646b <alltraps>
...
80107517:	6a 00                	push   $0x0
  pushl $211
80107519:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
8010751e:	e9 48 ef ff ff       	jmp    8010646b <alltraps>
...
80107523:	6a 00                	push   $0x0
  pushl $212
80107525:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010752a:	e9 3c ef ff ff       	jmp    8010646b <alltraps>
...
8010752f:	6a 00                	push   $0x0
  pushl $213
80107531:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107536:	e9 30 ef ff ff       	jmp    8010646b <alltraps>
...
8010753b:	6a 00                	push   $0x0
  pushl $214
8010753d:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107542:	e9 24 ef ff ff       	jmp    8010646b <alltraps>
...
80107547:	6a 00                	push   $0x0
  pushl $215
80107549:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
8010754e:	e9 18 ef ff ff       	jmp    8010646b <alltraps>
...
80107553:	6a 00                	push   $0x0
  pushl $216
80107555:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010755a:	e9 0c ef ff ff       	jmp    8010646b <alltraps>
...
8010755f:	6a 00                	push   $0x0
  pushl $217
80107561:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107566:	e9 00 ef ff ff       	jmp    8010646b <alltraps>
...
8010756b:	6a 00                	push   $0x0
  pushl $218
8010756d:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107572:	e9 f4 ee ff ff       	jmp    8010646b <alltraps>
...
80107577:	6a 00                	push   $0x0
  pushl $219
80107579:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010757e:	e9 e8 ee ff ff       	jmp    8010646b <alltraps>
...
80107583:	6a 00                	push   $0x0
  pushl $220
80107585:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010758a:	e9 dc ee ff ff       	jmp    8010646b <alltraps>
...
8010758f:	6a 00                	push   $0x0
  pushl $221
80107591:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107596:	e9 d0 ee ff ff       	jmp    8010646b <alltraps>
...
8010759b:	6a 00                	push   $0x0
  pushl $222
8010759d:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801075a2:	e9 c4 ee ff ff       	jmp    8010646b <alltraps>
...
801075a7:	6a 00                	push   $0x0
  pushl $223
801075a9:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801075ae:	e9 b8 ee ff ff       	jmp    8010646b <alltraps>
...
801075b3:	6a 00                	push   $0x0
  pushl $224
801075b5:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801075ba:	e9 ac ee ff ff       	jmp    8010646b <alltraps>
...
801075bf:	6a 00                	push   $0x0
  pushl $225
801075c1:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801075c6:	e9 a0 ee ff ff       	jmp    8010646b <alltraps>
...
801075cb:	6a 00                	push   $0x0
  pushl $226
801075cd:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801075d2:	e9 94 ee ff ff       	jmp    8010646b <alltraps>
...
801075d7:	6a 00                	push   $0x0
  pushl $227
801075d9:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801075de:	e9 88 ee ff ff       	jmp    8010646b <alltraps>
...
801075e3:	6a 00                	push   $0x0
  pushl $228
801075e5:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801075ea:	e9 7c ee ff ff       	jmp    8010646b <alltraps>
...
801075ef:	6a 00                	push   $0x0
  pushl $229
801075f1:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801075f6:	e9 70 ee ff ff       	jmp    8010646b <alltraps>
...
801075fb:	6a 00                	push   $0x0
  pushl $230
801075fd:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107602:	e9 64 ee ff ff       	jmp    8010646b <alltraps>
...
80107607:	6a 00                	push   $0x0
  pushl $231
80107609:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
8010760e:	e9 58 ee ff ff       	jmp    8010646b <alltraps>
...
80107613:	6a 00                	push   $0x0
  pushl $232
80107615:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010761a:	e9 4c ee ff ff       	jmp    8010646b <alltraps>
...
8010761f:	6a 00                	push   $0x0
  pushl $233
80107621:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107626:	e9 40 ee ff ff       	jmp    8010646b <alltraps>
...
8010762b:	6a 00                	push   $0x0
  pushl $234
8010762d:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107632:	e9 34 ee ff ff       	jmp    8010646b <alltraps>
...
80107637:	6a 00                	push   $0x0
  pushl $235
80107639:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
8010763e:	e9 28 ee ff ff       	jmp    8010646b <alltraps>
...
80107643:	6a 00                	push   $0x0
  pushl $236
80107645:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010764a:	e9 1c ee ff ff       	jmp    8010646b <alltraps>
...
8010764f:	6a 00                	push   $0x0
  pushl $237
80107651:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107656:	e9 10 ee ff ff       	jmp    8010646b <alltraps>
...
8010765b:	6a 00                	push   $0x0
  pushl $238
8010765d:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107662:	e9 04 ee ff ff       	jmp    8010646b <alltraps>
...
80107667:	6a 00                	push   $0x0
  pushl $239
80107669:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
8010766e:	e9 f8 ed ff ff       	jmp    8010646b <alltraps>
...
80107673:	6a 00                	push   $0x0
  pushl $240
80107675:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010767a:	e9 ec ed ff ff       	jmp    8010646b <alltraps>
...
8010767f:	6a 00                	push   $0x0
  pushl $241
80107681:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107686:	e9 e0 ed ff ff       	jmp    8010646b <alltraps>
...
8010768b:	6a 00                	push   $0x0
  pushl $242
8010768d:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107692:	e9 d4 ed ff ff       	jmp    8010646b <alltraps>
...
80107697:	6a 00                	push   $0x0
  pushl $243
80107699:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010769e:	e9 c8 ed ff ff       	jmp    8010646b <alltraps>
...
801076a3:	6a 00                	push   $0x0
  pushl $244
801076a5:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801076aa:	e9 bc ed ff ff       	jmp    8010646b <alltraps>
...
801076af:	6a 00                	push   $0x0
  pushl $245
801076b1:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801076b6:	e9 b0 ed ff ff       	jmp    8010646b <alltraps>
...
801076bb:	6a 00                	push   $0x0
  pushl $246
801076bd:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801076c2:	e9 a4 ed ff ff       	jmp    8010646b <alltraps>
...
801076c7:	6a 00                	push   $0x0
  pushl $247
801076c9:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801076ce:	e9 98 ed ff ff       	jmp    8010646b <alltraps>
...
801076d3:	6a 00                	push   $0x0
  pushl $248
801076d5:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801076da:	e9 8c ed ff ff       	jmp    8010646b <alltraps>
...
801076df:	6a 00                	push   $0x0
  pushl $249
801076e1:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801076e6:	e9 80 ed ff ff       	jmp    8010646b <alltraps>
...
801076eb:	6a 00                	push   $0x0
  pushl $250
801076ed:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801076f2:	e9 74 ed ff ff       	jmp    8010646b <alltraps>
...
801076f7:	6a 00                	push   $0x0
  pushl $251
801076f9:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801076fe:	e9 68 ed ff ff       	jmp    8010646b <alltraps>
...
80107703:	6a 00                	push   $0x0
  pushl $252
80107705:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010770a:	e9 5c ed ff ff       	jmp    8010646b <alltraps>
...
8010770f:	6a 00                	push   $0x0
  pushl $253
80107711:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107716:	e9 50 ed ff ff       	jmp    8010646b <alltraps>
...
8010771b:	6a 00                	push   $0x0
  pushl $254
8010771d:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107722:	e9 44 ed ff ff       	jmp    8010646b <alltraps>
...
80107727:	6a 00                	push   $0x0
  pushl $255
80107729:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
8010772e:	e9 38 ed ff ff       	jmp    8010646b <alltraps>
...
80107736:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107739:	8b 45 0c             	mov    0xc(%ebp),%eax
8010773c:	83 e8 01             	sub    $0x1,%eax
8010773f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107743:	8b 45 08             	mov    0x8(%ebp),%eax
80107746:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010774a:	8b 45 08             	mov    0x8(%ebp),%eax
8010774d:	c1 e8 10             	shr    $0x10,%eax
80107750:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107754:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107757:	0f 01 10             	lgdtl  (%eax)
}
8010775a:	c9                   	leave  
8010775b:	c3                   	ret    
...
80107765:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107769:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010776d:	0f 00 d8             	ltr    %ax
}
80107770:	c9                   	leave  
80107771:	c3                   	ret    
...
801077b0:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];  
801077b3:	e8 c0 b6 ff ff       	call   80102e78 <cpunum>
801077b8:	89 c2                	mov    %eax,%edx
801077ba:	89 d0                	mov    %edx,%eax
801077bc:	01 c0                	add    %eax,%eax
801077be:	01 d0                	add    %edx,%eax
801077c0:	c1 e0 06             	shl    $0x6,%eax
801077c3:	05 60 23 11 80       	add    $0x80112360,%eax
801077c8:	89 45 f4             	mov    %eax,-0xc(%ebp)

  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801077cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ce:	66 c7 40 7c ff ff    	movw   $0xffff,0x7c(%eax)
801077d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077d7:	66 c7 40 7e 00 00    	movw   $0x0,0x7e(%eax)
801077dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077e0:	c6 80 80 00 00 00 00 	movb   $0x0,0x80(%eax)
801077e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ea:	0f b6 90 81 00 00 00 	movzbl 0x81(%eax),%edx
801077f1:	83 e2 f0             	and    $0xfffffff0,%edx
801077f4:	83 ca 0a             	or     $0xa,%edx
801077f7:	88 90 81 00 00 00    	mov    %dl,0x81(%eax)
801077fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107800:	0f b6 90 81 00 00 00 	movzbl 0x81(%eax),%edx
80107807:	83 ca 10             	or     $0x10,%edx
8010780a:	88 90 81 00 00 00    	mov    %dl,0x81(%eax)
80107810:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107813:	0f b6 90 81 00 00 00 	movzbl 0x81(%eax),%edx
8010781a:	83 e2 9f             	and    $0xffffff9f,%edx
8010781d:	88 90 81 00 00 00    	mov    %dl,0x81(%eax)
80107823:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107826:	0f b6 90 81 00 00 00 	movzbl 0x81(%eax),%edx
8010782d:	83 ca 80             	or     $0xffffff80,%edx
80107830:	88 90 81 00 00 00    	mov    %dl,0x81(%eax)
80107836:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107839:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
80107840:	83 ca 0f             	or     $0xf,%edx
80107843:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
80107849:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010784c:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
80107853:	83 e2 ef             	and    $0xffffffef,%edx
80107856:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
8010785c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010785f:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
80107866:	83 e2 df             	and    $0xffffffdf,%edx
80107869:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
8010786f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107872:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
80107879:	83 ca 40             	or     $0x40,%edx
8010787c:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
80107882:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107885:	0f b6 90 82 00 00 00 	movzbl 0x82(%eax),%edx
8010788c:	83 ca 80             	or     $0xffffff80,%edx
8010788f:	88 90 82 00 00 00    	mov    %dl,0x82(%eax)
80107895:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107898:	c6 80 83 00 00 00 00 	movb   $0x0,0x83(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010789f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078a2:	66 c7 80 84 00 00 00 	movw   $0xffff,0x84(%eax)
801078a9:	ff ff 
801078ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078ae:	66 c7 80 86 00 00 00 	movw   $0x0,0x86(%eax)
801078b5:	00 00 
801078b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078ba:	c6 80 88 00 00 00 00 	movb   $0x0,0x88(%eax)
801078c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078c4:	0f b6 90 89 00 00 00 	movzbl 0x89(%eax),%edx
801078cb:	83 e2 f0             	and    $0xfffffff0,%edx
801078ce:	83 ca 02             	or     $0x2,%edx
801078d1:	88 90 89 00 00 00    	mov    %dl,0x89(%eax)
801078d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078da:	0f b6 90 89 00 00 00 	movzbl 0x89(%eax),%edx
801078e1:	83 ca 10             	or     $0x10,%edx
801078e4:	88 90 89 00 00 00    	mov    %dl,0x89(%eax)
801078ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078ed:	0f b6 90 89 00 00 00 	movzbl 0x89(%eax),%edx
801078f4:	83 e2 9f             	and    $0xffffff9f,%edx
801078f7:	88 90 89 00 00 00    	mov    %dl,0x89(%eax)
801078fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107900:	0f b6 90 89 00 00 00 	movzbl 0x89(%eax),%edx
80107907:	83 ca 80             	or     $0xffffff80,%edx
8010790a:	88 90 89 00 00 00    	mov    %dl,0x89(%eax)
80107910:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107913:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
8010791a:	83 ca 0f             	or     $0xf,%edx
8010791d:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
80107923:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107926:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
8010792d:	83 e2 ef             	and    $0xffffffef,%edx
80107930:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
80107936:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107939:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
80107940:	83 e2 df             	and    $0xffffffdf,%edx
80107943:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
80107949:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010794c:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
80107953:	83 ca 40             	or     $0x40,%edx
80107956:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
8010795c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010795f:	0f b6 90 8a 00 00 00 	movzbl 0x8a(%eax),%edx
80107966:	83 ca 80             	or     $0xffffff80,%edx
80107969:	88 90 8a 00 00 00    	mov    %dl,0x8a(%eax)
8010796f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107972:	c6 80 8b 00 00 00 00 	movb   $0x0,0x8b(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107979:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010797c:	66 c7 80 94 00 00 00 	movw   $0xffff,0x94(%eax)
80107983:	ff ff 
80107985:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107988:	66 c7 80 96 00 00 00 	movw   $0x0,0x96(%eax)
8010798f:	00 00 
80107991:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107994:	c6 80 98 00 00 00 00 	movb   $0x0,0x98(%eax)
8010799b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010799e:	0f b6 90 99 00 00 00 	movzbl 0x99(%eax),%edx
801079a5:	83 e2 f0             	and    $0xfffffff0,%edx
801079a8:	83 ca 0a             	or     $0xa,%edx
801079ab:	88 90 99 00 00 00    	mov    %dl,0x99(%eax)
801079b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079b4:	0f b6 90 99 00 00 00 	movzbl 0x99(%eax),%edx
801079bb:	83 ca 10             	or     $0x10,%edx
801079be:	88 90 99 00 00 00    	mov    %dl,0x99(%eax)
801079c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c7:	0f b6 90 99 00 00 00 	movzbl 0x99(%eax),%edx
801079ce:	83 ca 60             	or     $0x60,%edx
801079d1:	88 90 99 00 00 00    	mov    %dl,0x99(%eax)
801079d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079da:	0f b6 90 99 00 00 00 	movzbl 0x99(%eax),%edx
801079e1:	83 ca 80             	or     $0xffffff80,%edx
801079e4:	88 90 99 00 00 00    	mov    %dl,0x99(%eax)
801079ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ed:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
801079f4:	83 ca 0f             	or     $0xf,%edx
801079f7:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
801079fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a00:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
80107a07:	83 e2 ef             	and    $0xffffffef,%edx
80107a0a:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
80107a10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a13:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
80107a1a:	83 e2 df             	and    $0xffffffdf,%edx
80107a1d:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
80107a23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a26:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
80107a2d:	83 ca 40             	or     $0x40,%edx
80107a30:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
80107a36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a39:	0f b6 90 9a 00 00 00 	movzbl 0x9a(%eax),%edx
80107a40:	83 ca 80             	or     $0xffffff80,%edx
80107a43:	88 90 9a 00 00 00    	mov    %dl,0x9a(%eax)
80107a49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a4c:	c6 80 9b 00 00 00 00 	movb   $0x0,0x9b(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107a53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a56:	66 c7 80 9c 00 00 00 	movw   $0xffff,0x9c(%eax)
80107a5d:	ff ff 
80107a5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a62:	66 c7 80 9e 00 00 00 	movw   $0x0,0x9e(%eax)
80107a69:	00 00 
80107a6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a6e:	c6 80 a0 00 00 00 00 	movb   $0x0,0xa0(%eax)
80107a75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a78:	0f b6 90 a1 00 00 00 	movzbl 0xa1(%eax),%edx
80107a7f:	83 e2 f0             	and    $0xfffffff0,%edx
80107a82:	83 ca 02             	or     $0x2,%edx
80107a85:	88 90 a1 00 00 00    	mov    %dl,0xa1(%eax)
80107a8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a8e:	0f b6 90 a1 00 00 00 	movzbl 0xa1(%eax),%edx
80107a95:	83 ca 10             	or     $0x10,%edx
80107a98:	88 90 a1 00 00 00    	mov    %dl,0xa1(%eax)
80107a9e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aa1:	0f b6 90 a1 00 00 00 	movzbl 0xa1(%eax),%edx
80107aa8:	83 ca 60             	or     $0x60,%edx
80107aab:	88 90 a1 00 00 00    	mov    %dl,0xa1(%eax)
80107ab1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ab4:	0f b6 90 a1 00 00 00 	movzbl 0xa1(%eax),%edx
80107abb:	83 ca 80             	or     $0xffffff80,%edx
80107abe:	88 90 a1 00 00 00    	mov    %dl,0xa1(%eax)
80107ac4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ac7:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
80107ace:	83 ca 0f             	or     $0xf,%edx
80107ad1:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
80107ad7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ada:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
80107ae1:	83 e2 ef             	and    $0xffffffef,%edx
80107ae4:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
80107aea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aed:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
80107af4:	83 e2 df             	and    $0xffffffdf,%edx
80107af7:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
80107afd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b00:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
80107b07:	83 ca 40             	or     $0x40,%edx
80107b0a:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
80107b10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b13:	0f b6 90 a2 00 00 00 	movzbl 0xa2(%eax),%edx
80107b1a:	83 ca 80             	or     $0xffffff80,%edx
80107b1d:	88 90 a2 00 00 00    	mov    %dl,0xa2(%eax)
80107b23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b26:	c6 80 a3 00 00 00 00 	movb   $0x0,0xa3(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107b2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b30:	05 b8 00 00 00       	add    $0xb8,%eax
80107b35:	89 c3                	mov    %eax,%ebx
80107b37:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b3a:	05 b8 00 00 00       	add    $0xb8,%eax
80107b3f:	c1 e8 10             	shr    $0x10,%eax
80107b42:	89 c1                	mov    %eax,%ecx
80107b44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b47:	05 b8 00 00 00       	add    $0xb8,%eax
80107b4c:	c1 e8 18             	shr    $0x18,%eax
80107b4f:	89 c2                	mov    %eax,%edx
80107b51:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b54:	66 c7 80 8c 00 00 00 	movw   $0x0,0x8c(%eax)
80107b5b:	00 00 
80107b5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b60:	66 89 98 8e 00 00 00 	mov    %bx,0x8e(%eax)
80107b67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b6a:	88 88 90 00 00 00    	mov    %cl,0x90(%eax)
80107b70:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b73:	0f b6 88 91 00 00 00 	movzbl 0x91(%eax),%ecx
80107b7a:	83 e1 f0             	and    $0xfffffff0,%ecx
80107b7d:	83 c9 02             	or     $0x2,%ecx
80107b80:	88 88 91 00 00 00    	mov    %cl,0x91(%eax)
80107b86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b89:	0f b6 88 91 00 00 00 	movzbl 0x91(%eax),%ecx
80107b90:	83 c9 10             	or     $0x10,%ecx
80107b93:	88 88 91 00 00 00    	mov    %cl,0x91(%eax)
80107b99:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b9c:	0f b6 88 91 00 00 00 	movzbl 0x91(%eax),%ecx
80107ba3:	83 e1 9f             	and    $0xffffff9f,%ecx
80107ba6:	88 88 91 00 00 00    	mov    %cl,0x91(%eax)
80107bac:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107baf:	0f b6 88 91 00 00 00 	movzbl 0x91(%eax),%ecx
80107bb6:	83 c9 80             	or     $0xffffff80,%ecx
80107bb9:	88 88 91 00 00 00    	mov    %cl,0x91(%eax)
80107bbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bc2:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107bc9:	83 e1 f0             	and    $0xfffffff0,%ecx
80107bcc:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107bd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bd5:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107bdc:	83 e1 ef             	and    $0xffffffef,%ecx
80107bdf:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107be5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107be8:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107bef:	83 e1 df             	and    $0xffffffdf,%ecx
80107bf2:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107bf8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bfb:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107c02:	83 c9 40             	or     $0x40,%ecx
80107c05:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107c0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c0e:	0f b6 88 92 00 00 00 	movzbl 0x92(%eax),%ecx
80107c15:	83 c9 80             	or     $0xffffff80,%ecx
80107c18:	88 88 92 00 00 00    	mov    %cl,0x92(%eax)
80107c1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c21:	88 90 93 00 00 00    	mov    %dl,0x93(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107c27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c2a:	83 c0 74             	add    $0x74,%eax
80107c2d:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107c34:	00 
80107c35:	89 04 24             	mov    %eax,(%esp)
80107c38:	e8 f6 fa ff ff       	call   80107733 <lgdt>
  loadgs(SEG_KCPU << 3);
80107c3d:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107c44:	e8 29 fb ff ff       	call   80107772 <loadgs>
...
80107c5d:	83 c4 24             	add    $0x24,%esp
80107c60:	5b                   	pop    %ebx
80107c61:	5d                   	pop    %ebp
80107c62:	c3                   	ret    
...
80107c88:	74 17                	je     80107ca1 <walkpgdir+0x3e>
...
80107c97:	e8 03 fb ff ff       	call   8010779f <p2v>
80107c9c:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c9f:	eb 4b                	jmp    80107cec <walkpgdir+0x89>
  } else {
    
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)      
80107ca1:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107ca5:	74 0e                	je     80107cb5 <walkpgdir+0x52>
80107ca7:	e8 36 ae ff ff       	call   80102ae2 <kalloc>
80107cac:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107caf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107cb3:	75 07                	jne    80107cbc <walkpgdir+0x59>
      return 0;
80107cb5:	b8 00 00 00 00       	mov    $0x0,%eax
80107cba:	eb 47                	jmp    80107d03 <walkpgdir+0xa0>
...
80107cd2:	e8 a0 d3 ff ff       	call   80105077 <memset>
...
80107cdd:	e8 b0 fa ff ff       	call   80107792 <v2p>
80107ce2:	83 c8 07             	or     $0x7,%eax
...
80107cef:	c1 e8 0c             	shr    $0xc,%eax
80107cf2:	25 ff 03 00 00       	and    $0x3ff,%eax
80107cf7:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107d08:	83 ec 18             	sub    $0x18,%esp
...
80107d15:	89 44 24 04          	mov    %eax,0x4(%esp)
80107d19:	8b 45 08             	mov    0x8(%ebp),%eax
80107d1c:	89 04 24             	mov    %eax,(%esp)
80107d1f:	e8 3f ff ff ff       	call   80107c63 <walkpgdir>
}
80107d24:	c9                   	leave  
80107d25:	c3                   	ret    
...
80107d29:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80107d37:	8b 55 0c             	mov    0xc(%ebp),%edx
80107d3a:	8b 45 10             	mov    0x10(%ebp),%eax
80107d3d:	01 d0                	add    %edx,%eax
80107d3f:	83 e8 01             	sub    $0x1,%eax
80107d42:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107d47:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107d4a:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107d51:	00 
80107d52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d55:	89 44 24 04          	mov    %eax,0x4(%esp)
80107d59:	8b 45 08             	mov    0x8(%ebp),%eax
80107d5c:	89 04 24             	mov    %eax,(%esp)
80107d5f:	e8 ff fe ff ff       	call   80107c63 <walkpgdir>
80107d64:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107d67:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107d6b:	75 07                	jne    80107d74 <mappages+0x4e>
      return -1;
80107d6d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107d72:	eb 48                	jmp    80107dbc <mappages+0x96>
    if(*pte & PTE_P)
80107d74:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107d77:	8b 00                	mov    (%eax),%eax
80107d79:	83 e0 01             	and    $0x1,%eax
80107d7c:	85 c0                	test   %eax,%eax
80107d7e:	74 0c                	je     80107d8c <mappages+0x66>
      panic("remap");
80107d80:	c7 04 24 10 8c 10 80 	movl   $0x80108c10,(%esp)
80107d87:	e8 ae 87 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
80107d8c:	8b 45 18             	mov    0x18(%ebp),%eax
80107d8f:	0b 45 14             	or     0x14(%ebp),%eax
80107d92:	83 c8 01             	or     $0x1,%eax
80107d95:	89 c2                	mov    %eax,%edx
80107d97:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107d9a:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107d9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d9f:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107da2:	75 08                	jne    80107dac <mappages+0x86>
      break;
80107da4:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107daa:	eb 10                	jmp    80107dbc <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
...
80107dac:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107db3:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107dba:	eb 8e                	jmp    80107d4a <mappages+0x24>
  return 0;
}
80107dbc:	c9                   	leave  
80107dbd:	c3                   	ret    
...
80107dc2:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107dc5:	e8 18 ad ff ff       	call   80102ae2 <kalloc>
80107dca:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107dcd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107dd1:	75 0a                	jne    80107ddd <setupkvm+0x1f>
    return 0;
80107dd3:	b8 00 00 00 00       	mov    $0x0,%eax
80107dd8:	e9 98 00 00 00       	jmp    80107e75 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107ddd:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107de4:	00 
80107de5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107dec:	00 
80107ded:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107df0:	89 04 24             	mov    %eax,(%esp)
80107df3:	e8 7f d2 ff ff       	call   80105077 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107df8:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107dff:	e8 9b f9 ff ff       	call   8010779f <p2v>
80107e04:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107e09:	76 0c                	jbe    80107e17 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107e0b:	c7 04 24 16 8c 10 80 	movl   $0x80108c16,(%esp)
80107e12:	e8 23 87 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107e17:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107e1e:	eb 49                	jmp    80107e69 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107e20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e23:	8b 48 0c             	mov    0xc(%eax),%ecx
80107e26:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e29:	8b 50 04             	mov    0x4(%eax),%edx
80107e2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e2f:	8b 58 08             	mov    0x8(%eax),%ebx
80107e32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e35:	8b 40 04             	mov    0x4(%eax),%eax
80107e38:	29 c3                	sub    %eax,%ebx
80107e3a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e3d:	8b 00                	mov    (%eax),%eax
80107e3f:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107e43:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107e47:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107e4b:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e4f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e52:	89 04 24             	mov    %eax,(%esp)
80107e55:	e8 cc fe ff ff       	call   80107d26 <mappages>
80107e5a:	85 c0                	test   %eax,%eax
80107e5c:	79 07                	jns    80107e65 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107e5e:	b8 00 00 00 00       	mov    $0x0,%eax
80107e63:	eb 10                	jmp    80107e75 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107e65:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107e69:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107e70:	72 ae                	jb     80107e20 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107e75:	83 c4 34             	add    $0x34,%esp
80107e78:	5b                   	pop    %ebx
80107e79:	5d                   	pop    %ebp
80107e7a:	c3                   	ret    
...
80107e7e:	83 ec 18             	sub    $0x18,%esp
  c->kpgdir = setupkvm();
80107e81:	e8 38 ff ff ff       	call   80107dbe <setupkvm>
80107e86:	8b 55 08             	mov    0x8(%ebp),%edx
80107e89:	89 42 04             	mov    %eax,0x4(%edx)
  switchkvm(c);
80107e8c:	8b 45 08             	mov    0x8(%ebp),%eax
80107e8f:	89 04 24             	mov    %eax,(%esp)
80107e92:	e8 02 00 00 00       	call   80107e99 <switchkvm>
}
80107e97:	c9                   	leave  
80107e98:	c3                   	ret    
...
80107ea8:	e8 e5 f8 ff ff       	call   80107792 <v2p>
80107ead:	89 04 24             	mov    %eax,(%esp)
80107eb0:	e8 d2 f8 ff ff       	call   80107787 <lcr3>
}
80107eb5:	c9                   	leave  
80107eb6:	c3                   	ret    
...
80107eba:	53                   	push   %ebx
80107ebb:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107ebe:	e8 b4 d0 ff ff       	call   80104f77 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107ec3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107ec9:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107ed0:	83 c2 0c             	add    $0xc,%edx
80107ed3:	89 d3                	mov    %edx,%ebx
80107ed5:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107edc:	83 c2 0c             	add    $0xc,%edx
80107edf:	c1 ea 10             	shr    $0x10,%edx
80107ee2:	89 d1                	mov    %edx,%ecx
80107ee4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107eeb:	83 c2 0c             	add    $0xc,%edx
80107eee:	c1 ea 18             	shr    $0x18,%edx
80107ef1:	66 c7 80 a4 00 00 00 	movw   $0x67,0xa4(%eax)
80107ef8:	67 00 
80107efa:	66 89 98 a6 00 00 00 	mov    %bx,0xa6(%eax)
80107f01:	88 88 a8 00 00 00    	mov    %cl,0xa8(%eax)
80107f07:	0f b6 88 a9 00 00 00 	movzbl 0xa9(%eax),%ecx
80107f0e:	83 e1 f0             	and    $0xfffffff0,%ecx
80107f11:	83 c9 09             	or     $0x9,%ecx
80107f14:	88 88 a9 00 00 00    	mov    %cl,0xa9(%eax)
80107f1a:	0f b6 88 a9 00 00 00 	movzbl 0xa9(%eax),%ecx
80107f21:	83 c9 10             	or     $0x10,%ecx
80107f24:	88 88 a9 00 00 00    	mov    %cl,0xa9(%eax)
80107f2a:	0f b6 88 a9 00 00 00 	movzbl 0xa9(%eax),%ecx
80107f31:	83 e1 9f             	and    $0xffffff9f,%ecx
80107f34:	88 88 a9 00 00 00    	mov    %cl,0xa9(%eax)
80107f3a:	0f b6 88 a9 00 00 00 	movzbl 0xa9(%eax),%ecx
80107f41:	83 c9 80             	or     $0xffffff80,%ecx
80107f44:	88 88 a9 00 00 00    	mov    %cl,0xa9(%eax)
80107f4a:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107f51:	83 e1 f0             	and    $0xfffffff0,%ecx
80107f54:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107f5a:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107f61:	83 e1 ef             	and    $0xffffffef,%ecx
80107f64:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107f6a:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107f71:	83 e1 df             	and    $0xffffffdf,%ecx
80107f74:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107f7a:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107f81:	83 c9 40             	or     $0x40,%ecx
80107f84:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107f8a:	0f b6 88 aa 00 00 00 	movzbl 0xaa(%eax),%ecx
80107f91:	83 e1 7f             	and    $0x7f,%ecx
80107f94:	88 88 aa 00 00 00    	mov    %cl,0xaa(%eax)
80107f9a:	88 90 ab 00 00 00    	mov    %dl,0xab(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107fa0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107fa6:	0f b6 90 a9 00 00 00 	movzbl 0xa9(%eax),%edx
80107fad:	83 e2 ef             	and    $0xffffffef,%edx
80107fb0:	88 90 a9 00 00 00    	mov    %dl,0xa9(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107fb6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107fbc:	66 c7 40 14 10 00    	movw   $0x10,0x14(%eax)
...
80107fd8:	89 50 10             	mov    %edx,0x10(%eax)
  ltr(SEG_TSS << 3);
80107fdb:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107fe2:	e8 75 f7 ff ff       	call   8010775c <ltr>
  if(p->pgdir == 0)
80107fe7:	8b 45 08             	mov    0x8(%ebp),%eax
80107fea:	8b 40 04             	mov    0x4(%eax),%eax
80107fed:	85 c0                	test   %eax,%eax
80107fef:	75 0c                	jne    80107ffd <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107ff1:	c7 04 24 27 8c 10 80 	movl   $0x80108c27,(%esp)
80107ff8:	e8 3d 85 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107ffd:	8b 45 08             	mov    0x8(%ebp),%eax
80108000:	8b 40 04             	mov    0x4(%eax),%eax
80108003:	89 04 24             	mov    %eax,(%esp)
80108006:	e8 87 f7 ff ff       	call   80107792 <v2p>
8010800b:	89 04 24             	mov    %eax,(%esp)
8010800e:	e8 74 f7 ff ff       	call   80107787 <lcr3>
  popcli();
80108013:	e8 a3 cf ff ff       	call   80104fbb <popcli>
}
80108018:	83 c4 14             	add    $0x14,%esp
8010801b:	5b                   	pop    %ebx
8010801c:	5d                   	pop    %ebp
8010801d:	c3                   	ret    
...
80108021:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80108024:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
8010802b:	76 0c                	jbe    80108039 <inituvm+0x1b>
    panic("inituvm: more than a page");
8010802d:	c7 04 24 3b 8c 10 80 	movl   $0x80108c3b,(%esp)
80108034:	e8 01 85 ff ff       	call   8010053a <panic>
  mem = kalloc();
80108039:	e8 a4 aa ff ff       	call   80102ae2 <kalloc>
...
80108057:	e8 1b d0 ff ff       	call   80105077 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010805c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010805f:	89 04 24             	mov    %eax,(%esp)
80108062:	e8 2b f7 ff ff       	call   80107792 <v2p>
80108067:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010806e:	00 
8010806f:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108073:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010807a:	00 
8010807b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108082:	00 
80108083:	8b 45 08             	mov    0x8(%ebp),%eax
80108086:	89 04 24             	mov    %eax,(%esp)
80108089:	e8 98 fc ff ff       	call   80107d26 <mappages>
  memmove(mem, init, sz);
8010808e:	8b 45 10             	mov    0x10(%ebp),%eax
...
801080a2:	e8 9f d0 ff ff       	call   80105146 <memmove>
}
801080a7:	c9                   	leave  
801080a8:	c3                   	ret    
...
801080ad:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
801080b0:	8b 45 0c             	mov    0xc(%ebp),%eax
801080b3:	25 ff 0f 00 00       	and    $0xfff,%eax
801080b8:	85 c0                	test   %eax,%eax
801080ba:	74 0c                	je     801080c8 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801080bc:	c7 04 24 58 8c 10 80 	movl   $0x80108c58,(%esp)
801080c3:	e8 72 84 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
801080c8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801080cf:	e9 a9 00 00 00       	jmp    8010817d <loaduvm+0xd4>
...
801080ee:	e8 70 fb ff ff       	call   80107c63 <walkpgdir>
801080f3:	89 45 ec             	mov    %eax,-0x14(%ebp)
801080f6:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801080fa:	75 0c                	jne    80108108 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
801080fc:	c7 04 24 7b 8c 10 80 	movl   $0x80108c7b,(%esp)
80108103:	e8 32 84 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
...
80108118:	8b 55 18             	mov    0x18(%ebp),%edx
8010811b:	29 c2                	sub    %eax,%edx
8010811d:	89 d0                	mov    %edx,%eax
8010811f:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108124:	77 0f                	ja     80108135 <loaduvm+0x8c>
      n = sz - i;
80108126:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108129:	8b 55 18             	mov    0x18(%ebp),%edx
8010812c:	29 c2                	sub    %eax,%edx
8010812e:	89 d0                	mov    %edx,%eax
80108130:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108133:	eb 07                	jmp    8010813c <loaduvm+0x93>
    else
      n = PGSIZE;
80108135:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010813c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010813f:	8b 55 14             	mov    0x14(%ebp),%edx
80108142:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108145:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108148:	89 04 24             	mov    %eax,(%esp)
8010814b:	e8 4f f6 ff ff       	call   8010779f <p2v>
80108150:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108153:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108157:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010815b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010815f:	8b 45 10             	mov    0x10(%ebp),%eax
80108162:	89 04 24             	mov    %eax,(%esp)
80108165:	e8 fe 9b ff ff       	call   80101d68 <readi>
8010816a:	3b 45 f0             	cmp    -0x10(%ebp),%eax
8010816d:	74 07                	je     80108176 <loaduvm+0xcd>
      return -1;
8010816f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108174:	eb 18                	jmp    8010818e <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
...
80108180:	3b 45 18             	cmp    0x18(%ebp),%eax
80108183:	0f 82 4b ff ff ff    	jb     801080d4 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
8010818e:	83 c4 24             	add    $0x24,%esp
80108191:	5b                   	pop    %ebx
80108192:	5d                   	pop    %ebp
80108193:	c3                   	ret    
...
80108197:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
8010819f:	79 0a                	jns    801081ab <allocuvm+0x17>
    return 0;
801081a1:	b8 00 00 00 00       	mov    $0x0,%eax
801081a6:	e9 c1 00 00 00       	jmp    8010826c <allocuvm+0xd8>
  if(newsz < oldsz)
801081ab:	8b 45 10             	mov    0x10(%ebp),%eax
801081ae:	3b 45 0c             	cmp    0xc(%ebp),%eax
801081b1:	73 08                	jae    801081bb <allocuvm+0x27>
    return oldsz;
801081b3:	8b 45 0c             	mov    0xc(%ebp),%eax
801081b6:	e9 b1 00 00 00       	jmp    8010826c <allocuvm+0xd8>
...
801081cb:	e9 8d 00 00 00       	jmp    8010825d <allocuvm+0xc9>
    mem = kalloc();
801081d0:	e8 0d a9 ff ff       	call   80102ae2 <kalloc>
801081d5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
801081d8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801081dc:	75 2c                	jne    8010820a <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
801081de:	c7 04 24 99 8c 10 80 	movl   $0x80108c99,(%esp)
801081e5:	e8 b6 81 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801081ea:	8b 45 0c             	mov    0xc(%ebp),%eax
801081ed:	89 44 24 08          	mov    %eax,0x8(%esp)
801081f1:	8b 45 10             	mov    0x10(%ebp),%eax
801081f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801081f8:	8b 45 08             	mov    0x8(%ebp),%eax
801081fb:	89 04 24             	mov    %eax,(%esp)
801081fe:	e8 6b 00 00 00       	call   8010826e <deallocuvm>
      return 0;
80108203:	b8 00 00 00 00       	mov    $0x0,%eax
80108208:	eb 62                	jmp    8010826c <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
8010820a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108211:	00 
80108212:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108219:	00 
8010821a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010821d:	89 04 24             	mov    %eax,(%esp)
80108220:	e8 52 ce ff ff       	call   80105077 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108225:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108228:	89 04 24             	mov    %eax,(%esp)
8010822b:	e8 62 f5 ff ff       	call   80107792 <v2p>
80108230:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108233:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010823a:	00 
8010823b:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010823f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108246:	00 
80108247:	89 54 24 04          	mov    %edx,0x4(%esp)
8010824b:	8b 45 08             	mov    0x8(%ebp),%eax
8010824e:	89 04 24             	mov    %eax,(%esp)
80108251:	e8 d0 fa ff ff       	call   80107d26 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80108256:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010825d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108260:	3b 45 10             	cmp    0x10(%ebp),%eax
80108263:	0f 82 67 ff ff ff    	jb     801081d0 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80108271:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
8010827a:	72 08                	jb     80108284 <deallocuvm+0x16>
    return oldsz;
8010827c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010827f:	e9 a4 00 00 00       	jmp    80108328 <deallocuvm+0xba>
...
80108294:	e9 80 00 00 00       	jmp    80108319 <deallocuvm+0xab>
...
801082ae:	e8 b0 f9 ff ff       	call   80107c63 <walkpgdir>
801082b3:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801082b6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801082ba:	75 09                	jne    801082c5 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801082bc:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801082c3:	eb 4d                	jmp    80108312 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
801082c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801082c8:	8b 00                	mov    (%eax),%eax
801082ca:	83 e0 01             	and    $0x1,%eax
801082cd:	85 c0                	test   %eax,%eax
801082cf:	74 41                	je     80108312 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
801082db:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
801082de:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801082e2:	75 0c                	jne    801082f0 <deallocuvm+0x82>
        panic("kfree");
801082e4:	c7 04 24 b1 8c 10 80 	movl   $0x80108cb1,(%esp)
801082eb:	e8 4a 82 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
801082f0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082f3:	89 04 24             	mov    %eax,(%esp)
801082f6:	e8 a4 f4 ff ff       	call   8010779f <p2v>
801082fb:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
801082fe:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108301:	89 04 24             	mov    %eax,(%esp)
80108304:	e8 40 a7 ff ff       	call   80102a49 <kfree>
      *pte = 0;
80108309:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010830c:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80108312:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108319:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010831c:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010831f:	0f 82 74 ff ff ff    	jb     80108299 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
8010832d:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80108330:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108334:	75 0c                	jne    80108342 <freevm+0x18>
    panic("freevm: no pgdir");
80108336:	c7 04 24 b7 8c 10 80 	movl   $0x80108cb7,(%esp)
8010833d:	e8 f8 81 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108342:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108349:	00 
8010834a:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108351:	80 
80108352:	8b 45 08             	mov    0x8(%ebp),%eax
80108355:	89 04 24             	mov    %eax,(%esp)
80108358:	e8 11 ff ff ff       	call   8010826e <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010835d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108364:	eb 48                	jmp    801083ae <freevm+0x84>
    if(pgdir[i] & PTE_P){
...
80108377:	83 e0 01             	and    $0x1,%eax
8010837a:	85 c0                	test   %eax,%eax
8010837c:	74 2c                	je     801083aa <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
8010837e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108381:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108388:	8b 45 08             	mov    0x8(%ebp),%eax
8010838b:	01 d0                	add    %edx,%eax
8010838d:	8b 00                	mov    (%eax),%eax
8010838f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108394:	89 04 24             	mov    %eax,(%esp)
80108397:	e8 03 f4 ff ff       	call   8010779f <p2v>
8010839c:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
8010839f:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083a2:	89 04 24             	mov    %eax,(%esp)
801083a5:	e8 9f a6 ff ff       	call   80102a49 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801083aa:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801083ae:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801083b5:	76 af                	jbe    80108366 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801083bd:	e8 87 a6 ff ff       	call   80102a49 <kfree>
}
801083c2:	c9                   	leave  
801083c3:	c3                   	ret    
...
801083ca:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801083d1:	00 
...
801083df:	e8 7f f8 ff ff       	call   80107c63 <walkpgdir>
801083e4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
801083e7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801083eb:	75 0c                	jne    801083f9 <clearpteu+0x35>
    panic("clearpteu");
801083ed:	c7 04 24 c8 8c 10 80 	movl   $0x80108cc8,(%esp)
801083f4:	e8 41 81 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
801083f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083fc:	8b 00                	mov    (%eax),%eax
801083fe:	83 e0 fb             	and    $0xfffffffb,%eax
80108401:	89 c2                	mov    %eax,%edx
80108403:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108406:	89 10                	mov    %edx,(%eax)
}
80108408:	c9                   	leave  
80108409:	c3                   	ret    
...
8010840e:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108411:	e8 a8 f9 ff ff       	call   80107dbe <setupkvm>
80108416:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108419:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010841d:	75 0a                	jne    80108429 <copyuvm+0x1f>
    return 0;
8010841f:	b8 00 00 00 00       	mov    $0x0,%eax
80108424:	e9 ef 00 00 00       	jmp    80108518 <copyuvm+0x10e>
  for(i = 0; i < sz; i += PGSIZE){
80108429:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108430:	e9 c2 00 00 00       	jmp    801084f7 <copyuvm+0xed>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108435:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108438:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010843f:	00 
80108440:	89 44 24 04          	mov    %eax,0x4(%esp)
80108444:	8b 45 08             	mov    0x8(%ebp),%eax
80108447:	89 04 24             	mov    %eax,(%esp)
8010844a:	e8 14 f8 ff ff       	call   80107c63 <walkpgdir>
8010844f:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108452:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108456:	75 05                	jne    8010845d <copyuvm+0x53>
      //panic("copyuvm: pte should exist");				//if not allc itws ok
    	continue;
80108458:	e9 93 00 00 00       	jmp    801084f0 <copyuvm+0xe6>
    if(!(*pte & PTE_P))
8010845d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108460:	8b 00                	mov    (%eax),%eax
80108462:	83 e0 01             	and    $0x1,%eax
80108465:	85 c0                	test   %eax,%eax
80108467:	75 05                	jne    8010846e <copyuvm+0x64>
     // panic("copyuvm: page not present");				//if not allc itws ok
    	continue;
80108469:	e9 82 00 00 00       	jmp    801084f0 <copyuvm+0xe6>
    pa = PTE_ADDR(*pte);
...
80108485:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108488:	e8 55 a6 ff ff       	call   80102ae2 <kalloc>
8010848d:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108490:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108494:	75 02                	jne    80108498 <copyuvm+0x8e>
      goto bad;
80108496:	eb 70                	jmp    80108508 <copyuvm+0xfe>
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108498:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010849b:	89 04 24             	mov    %eax,(%esp)
8010849e:	e8 fc f2 ff ff       	call   8010779f <p2v>
...
801084e5:	e8 3c f8 ff ff       	call   80107d26 <mappages>
801084ea:	85 c0                	test   %eax,%eax
801084ec:	79 02                	jns    801084f0 <copyuvm+0xe6>
      goto bad;
801084ee:	eb 18                	jmp    80108508 <copyuvm+0xfe>
  uint pa, i, flags;
  char *mem;
...
801084fd:	0f 82 32 ff ff ff    	jb     80108435 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108506:	eb 10                	jmp    80108518 <copyuvm+0x10e>

bad:
  freevm(d);
80108508:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010850b:	89 04 24             	mov    %eax,(%esp)
8010850e:	e8 17 fe ff ff       	call   8010832a <freevm>
  return 0;
...
80108539:	e8 25 f7 ff ff       	call   80107c63 <walkpgdir>
...
80108574:	e8 26 f2 ff ff       	call   8010779f <p2v>
}
80108579:	c9                   	leave  
8010857a:	c3                   	ret    
...
801085f7:	e8 4a cb ff ff       	call   80105146 <memmove>
    len -= n;
